...
Summary:        Meta package for ros2-humble-actionlib_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-actionlib_msgs
Requires:       ros2-humble-actionlib_msgs-devel

Obsoletes: ros-humble-actionlib-msgs < 4.2.4-1
