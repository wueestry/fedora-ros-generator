...
Summary:        Meta package for ros2-humble-ament_cmake_copyright and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_copyright
Requires:       ros2-humble-ament_cmake_copyright-devel

Obsoletes: ros-humble-ament-cmake-copyright < 0.12.11-1
