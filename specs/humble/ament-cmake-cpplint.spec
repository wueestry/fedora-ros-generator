...
Summary:        Meta package for ros2-humble-ament_cmake_cpplint and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_cpplint
Requires:       ros2-humble-ament_cmake_cpplint-devel

Obsoletes: ros-humble-ament-cmake-cpplint < 0.12.11-1
