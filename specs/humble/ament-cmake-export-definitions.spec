...
Summary:        Meta package for ros2-humble-ament_cmake_export_definitions and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_definitions
Requires:       ros2-humble-ament_cmake_export_definitions-devel

Obsoletes: ros-humble-ament-cmake-export-definitions < 1.3.10-1
