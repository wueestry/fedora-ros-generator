...
Summary:        Meta package for ros2-humble-ament_cmake_export_dependencies and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_dependencies
Requires:       ros2-humble-ament_cmake_export_dependencies-devel

Obsoletes: ros-humble-ament-cmake-export-dependencies < 1.3.10-1
