...
Summary:        Meta package for ros2-humble-ament_cmake_export_include_directories and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_include_directories
Requires:       ros2-humble-ament_cmake_export_include_directories-devel

Obsoletes: ros-humble-ament-cmake-export-include-directories < 1.3.10-1
