...
Summary:        Meta package for ros2-humble-ament_cmake_export_interfaces and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_interfaces
Requires:       ros2-humble-ament_cmake_export_interfaces-devel

Obsoletes: ros-humble-ament-cmake-export-interfaces < 1.3.10-1
