...
Summary:        Meta package for ros2-humble-ament_cmake_export_link_flags and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_link_flags
Requires:       ros2-humble-ament_cmake_export_link_flags-devel

Obsoletes: ros-humble-ament-cmake-export-link-flags < 1.3.10-1
