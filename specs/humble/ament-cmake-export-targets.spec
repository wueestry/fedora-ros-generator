...
Summary:        Meta package for ros2-humble-ament_cmake_export_targets and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_export_targets
Requires:       ros2-humble-ament_cmake_export_targets-devel

Obsoletes: ros-humble-ament-cmake-export-targets < 1.3.10-1
