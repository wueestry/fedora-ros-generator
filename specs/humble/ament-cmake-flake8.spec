...
Summary:        Meta package for ros2-humble-ament_cmake_flake8 and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_flake8
Requires:       ros2-humble-ament_cmake_flake8-devel

Obsoletes: ros-humble-ament-cmake-flake8 < 0.12.11-1
