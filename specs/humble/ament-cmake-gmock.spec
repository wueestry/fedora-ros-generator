...
Summary:        Meta package for ros2-humble-ament_cmake_gmock and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_gmock
Requires:       ros2-humble-ament_cmake_gmock-devel

Obsoletes: ros-humble-ament-cmake-gmock < 1.3.10-1
