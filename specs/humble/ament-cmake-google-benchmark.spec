...
Summary:        Meta package for ros2-humble-ament_cmake_google_benchmark and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_google_benchmark
Requires:       ros2-humble-ament_cmake_google_benchmark-devel

Obsoletes: ros-humble-ament-cmake-google-benchmark < 1.3.9-1
