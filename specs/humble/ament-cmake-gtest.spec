...
Summary:        Meta package for ros2-humble-ament_cmake_gtest and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_gtest
Requires:       ros2-humble-ament_cmake_gtest-devel

Obsoletes: ros-humble-ament-cmake-gtest < 1.3.10-1
