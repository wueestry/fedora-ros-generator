...
Summary:        Meta package for ros2-humble-ament_cmake_libraries and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_libraries
Requires:       ros2-humble-ament_cmake_libraries-devel

Obsoletes: ros-humble-ament-cmake-libraries < 1.3.10-1
