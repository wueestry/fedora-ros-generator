...
Summary:        Meta package for ros2-humble-ament_cmake_pytest and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_pytest
Requires:       ros2-humble-ament_cmake_pytest-devel

Obsoletes: ros-humble-ament-cmake-pytest < 1.3.10-1
