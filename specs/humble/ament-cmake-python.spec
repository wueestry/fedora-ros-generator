...
Summary:        Meta package for ros2-humble-ament_cmake_python and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_python
Requires:       ros2-humble-ament_cmake_python-devel

Obsoletes: ros-humble-ament-cmake-python < 1.3.10-1
