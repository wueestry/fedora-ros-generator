...
Summary:        Meta package for ros2-humble-ament_cmake_target_dependencies and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_target_dependencies
Requires:       ros2-humble-ament_cmake_target_dependencies-devel

Obsoletes: ros-humble-ament-cmake-target-dependencies < 1.3.10-1
