...
Summary:        Meta package for ros2-humble-ament_cmake_test and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_test
Requires:       ros2-humble-ament_cmake_test-devel

Obsoletes: ros-humble-ament-cmake-test < 1.3.10-1
