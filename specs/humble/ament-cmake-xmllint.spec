...
Summary:        Meta package for ros2-humble-ament_cmake_xmllint and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cmake_xmllint
Requires:       ros2-humble-ament_cmake_xmllint-devel

Obsoletes: ros-humble-ament-cmake-xmllint < 0.12.10-1
