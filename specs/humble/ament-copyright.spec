...
Summary:        Meta package for ros2-humble-ament_copyright and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_copyright
Requires:       ros2-humble-ament_copyright-devel

Obsoletes: ros-humble-ament-copyright < 0.12.11-1
