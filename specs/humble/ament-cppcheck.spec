...
Summary:        Meta package for ros2-humble-ament_cppcheck and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_cppcheck
Requires:       ros2-humble-ament_cppcheck-devel

Obsoletes: ros-humble-ament-cppcheck < 0.12.11-1
