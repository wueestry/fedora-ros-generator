...
Summary:        Meta package for ros2-humble-ament_lint_cmake and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_lint_cmake
Requires:       ros2-humble-ament_lint_cmake-devel

Obsoletes: ros-humble-ament-lint-cmake < 0.12.10-1
