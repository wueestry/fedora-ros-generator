...
Summary:        Meta package for ros2-humble-ament_lint_common and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_lint_common
Requires:       ros2-humble-ament_lint_common-devel

Obsoletes: ros-humble-ament-lint-common < 0.12.11-1
