...
Summary:        Meta package for ros2-humble-ament_pycodestyle and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_pycodestyle
Requires:       ros2-humble-ament_pycodestyle-devel

Obsoletes: ros-humble-ament-pycodestyle < 0.12.11-1
