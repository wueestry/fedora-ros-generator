...
Summary:        Meta package for ros2-humble-ament_uncrustify and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ament_uncrustify
Requires:       ros2-humble-ament_uncrustify-devel

Obsoletes: ros-humble-ament-uncrustify < 0.12.11-1
