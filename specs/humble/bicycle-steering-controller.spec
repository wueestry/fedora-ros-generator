...
Summary:        Meta package for ros2-humble-bicycle_steering_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-bicycle_steering_controller
Requires:       ros2-humble-bicycle_steering_controller-devel

Obsoletes: ros-humble-bicycle-steering-controller < 2.34.0-1
