...
Summary:        Meta package for ros2-humble-demo_nodes_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-demo_nodes_cpp
Requires:       ros2-humble-demo_nodes_cpp-devel

Obsoletes: ros-humble-demo-nodes-cpp < 0.20.5-1
