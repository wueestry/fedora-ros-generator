...
Summary:        Meta package for ros2-humble-diagnostic_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-diagnostic_msgs
Requires:       ros2-humble-diagnostic_msgs-devel

Obsoletes: ros-humble-diagnostic-msgs < 4.2.3-1
