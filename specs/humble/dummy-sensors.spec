...
Summary:        Meta package for ros2-humble-dummy_sensors and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-dummy_sensors
Requires:       ros2-humble-dummy_sensors-devel

Obsoletes: ros-humble-dummy-sensors < 0.20.4-1
