...
Summary:        Meta package for ros2-humble-examples_rclcpp_minimal_action_server and its development package to adhere to ubuntu pkg names
BuildArch: noarch
...
Obsoletes: ros-humble-examples-rclcpp-minimal-action-server < 0.15.1-1
