...
Summary:        Meta package for ros2-humble-examples_rclcpp_minimal_subscriber and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-examples_rclcpp_minimal_subscriber
Requires:       ros2-humble-examples_rclcpp_minimal_subscriber-devel

Obsoletes: ros-humble-examples-rclcpp-minimal-subscriber < 0.15.1-1
