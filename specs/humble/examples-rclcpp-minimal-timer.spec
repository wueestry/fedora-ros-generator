...
Summary:        Meta package for ros2-humble-examples_rclcpp_minimal_timer and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-examples_rclcpp_minimal_timer
Requires:       ros2-humble-examples_rclcpp_minimal_timer-devel

Obsoletes: ros-humble-examples-rclcpp-minimal-timer < 0.15.2-1
