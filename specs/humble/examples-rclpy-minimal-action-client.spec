...
Summary:        Meta package for ros2-humble-examples_rclpy_minimal_action_client and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-examples_rclpy_minimal_action_client
Requires:       ros2-humble-examples_rclpy_minimal_action_client-devel

Obsoletes: ros-humble-examples-rclpy-minimal-action-client < 0.15.2-1
