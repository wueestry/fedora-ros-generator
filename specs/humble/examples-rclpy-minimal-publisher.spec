...
Summary:        Meta package for ros2-humble-examples_rclpy_minimal_publisher and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-examples_rclpy_minimal_publisher
Requires:       ros2-humble-examples_rclpy_minimal_publisher-devel

Obsoletes: ros-humble-examples-rclpy-minimal-publisher < 0.15.2-1
