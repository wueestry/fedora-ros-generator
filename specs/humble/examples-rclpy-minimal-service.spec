...
Summary:        Meta package for ros2-humble-examples_rclpy_minimal_service and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-examples_rclpy_minimal_service
Requires:       ros2-humble-examples_rclpy_minimal_service-devel

Obsoletes: ros-humble-examples-rclpy-minimal-service < 0.15.2-1
