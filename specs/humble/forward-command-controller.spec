...
Summary:        Meta package for ros2-humble-forward_command_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-forward_command_controller
Requires:       ros2-humble-forward_command_controller-devel

Obsoletes: ros-humble-forward-command-controller < 2.34.0-1
