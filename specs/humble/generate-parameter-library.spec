...
Summary:        Meta package for ros2-humble-generate_parameter_library and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-generate_parameter_library
Requires:       ros2-humble-generate_parameter_library-devel

Obsoletes: ros-humble-generate-parameter-library < 0.3.8-1
