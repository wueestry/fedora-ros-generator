...
Summary:        Meta package for ros2-humble-geometry_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-geometry_msgs
Requires:       ros2-humble-geometry_msgs-devel

Obsoletes: ros-humble-geometry-msgs < 4.2.3-1
