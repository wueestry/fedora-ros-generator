...
Summary:        Meta package for ros2-humble-gmock_vendor and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-gmock_vendor
Requires:       ros2-humble-gmock_vendor-devel

Obsoletes: ros-humble-gmock-vendor < 1.10.9004-1
