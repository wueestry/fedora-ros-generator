...
Summary:        Meta package for ros2-humble-hardware_interface and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-hardware_interface
Requires:       ros2-humble-hardware_interface-devel

Obsoletes: ros-humble-hardware-interface < 2.42.0-1
