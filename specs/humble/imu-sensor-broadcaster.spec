...
Summary:        Meta package for ros2-humble-imu_sensor_broadcaster and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-imu_sensor_broadcaster
Requires:       ros2-humble-imu_sensor_broadcaster-devel

Obsoletes: ros-humble-imu-sensor-broadcaster < 2.37.0-1
