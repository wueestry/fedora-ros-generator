...
Summary:        Meta package for ros2-humble-intra_process_demo and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-intra_process_demo
Requires:       ros2-humble-intra_process_demo-devel

Obsoletes: ros-humble-intra-process-demo < 0.20.4-1
