...
Summary:        Meta package for ros2-humble-joint_state_publisher_gui and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-joint_state_publisher_gui
Requires:       ros2-humble-joint_state_publisher_gui-devel

Obsoletes: ros-humble-joint-state-publisher-gui < 2.4.0-1
