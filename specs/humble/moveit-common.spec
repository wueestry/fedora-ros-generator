...
Summary:        Meta package for ros2-humble-moveit_common and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-moveit_common
Requires:       ros2-humble-moveit_common-devel

Obsoletes: ros-humble-moveit-common < 2.5.5-1
