# Meta Package
Name:           ros-humble-moveit-resources-panda-description
Version:        2.0.7
Release:        1%{?dist}
License:        BSD
URL:            http://moveit.ros.org
Summary:        Meta package for ros2-humble-moveit_resources_panda_description and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-moveit_resources_panda_description
Requires:       ros2-humble-moveit_resources_panda_description-devel

Obsoletes: ros-humble-moveit-resources-panda-description < 2.0.7-1
