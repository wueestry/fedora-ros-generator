# Meta Package
Name:           ros-humble-moveit-resources-pr2-description
Version:        2.0.7
Release:        1%{?dist}
License:        BSD
URL:            http://moveit.ros.org
Summary:        Meta package for ros2-humble-moveit_resources_pr2_description and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-moveit_resources_pr2_description
Requires:       ros2-humble-moveit_resources_pr2_description-devel

Obsoletes: ros-humble-moveit-resources-pr2-description < 2.0.7-1
