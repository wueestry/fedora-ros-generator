...
Summary:        Meta package for ros2-humble-nav2_behaviors and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_behaviors
Requires:       ros2-humble-nav2_behaviors-devel

Obsoletes: ros-humble-nav2-behaviors < 1.1.14-1
