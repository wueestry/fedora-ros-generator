...
Summary:        Meta package for ros2-humble-nav2_bt_navigator and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_bt_navigator
Requires:       ros2-humble-nav2_bt_navigator-devel

Obsoletes: ros-humble-nav2-bt-navigator < 1.1.14-1
