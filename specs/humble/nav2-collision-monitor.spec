...
Summary:        Meta package for ros2-humble-nav2_collision_monitor and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_collision_monitor
Requires:       ros2-humble-nav2_collision_monitor-devel

Obsoletes: ros-humble-nav2-collision-monitor < 1.1.14-1
