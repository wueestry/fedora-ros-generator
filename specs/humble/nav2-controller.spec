...
Summary:        Meta package for ros2-humble-nav2_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_controller
Requires:       ros2-humble-nav2_controller-devel

Obsoletes: ros-humble-nav2-controller < 1.1.15-1
