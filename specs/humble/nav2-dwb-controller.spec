...
Summary:        Meta package for ros2-humble-nav2_dwb_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_dwb_controller
Requires:       ros2-humble-nav2_dwb_controller-devel

Obsoletes: ros-humble-nav2-dwb-controller < 1.1.14-1
