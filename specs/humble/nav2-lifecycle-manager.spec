...
Summary:        Meta package for ros2-humble-nav2_lifecycle_manager and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_lifecycle_manager
Requires:       ros2-humble-nav2_lifecycle_manager-devel

Obsoletes: ros-humble-nav2-lifecycle-manager < 1.1.14-1
