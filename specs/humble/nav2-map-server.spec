...
Summary:        Meta package for ros2-humble-nav2_map_server and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_map_server
Requires:       ros2-humble-nav2_map_server-devel

Obsoletes: ros-humble-nav2-map-server < 1.1.14-1
