...
Summary:        Meta package for ros2-humble-nav2_navfn_planner and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_navfn_planner
Requires:       ros2-humble-nav2_navfn_planner-devel

Obsoletes: ros-humble-nav2-navfn-planner < 1.1.15-1
