...
Summary:        Meta package for ros2-humble-nav2_regulated_pure_pursuit_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch
...
Obsoletes: ros-humble-nav2-regulated-pure-pursuit-controller < 1.1.15-1
