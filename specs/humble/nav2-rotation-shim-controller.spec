...
Summary:        Meta package for ros2-humble-nav2_rotation_shim_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_rotation_shim_controller
Requires:       ros2-humble-nav2_rotation_shim_controller-devel

Obsoletes: ros-humble-nav2-rotation-shim-controller < 1.1.15-1
