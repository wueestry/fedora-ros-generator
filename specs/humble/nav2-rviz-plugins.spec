...
Summary:        Meta package for ros2-humble-nav2_rviz_plugins and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_rviz_plugins
Requires:       ros2-humble-nav2_rviz_plugins-devel

Obsoletes: ros-humble-nav2-rviz-plugins < 1.1.15-1
