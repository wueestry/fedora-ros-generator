...
Summary:        Meta package for ros2-humble-nav2_smac_planner and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_smac_planner
Requires:       ros2-humble-nav2_smac_planner-devel

Obsoletes: ros-humble-nav2-smac-planner < 1.1.14-1
