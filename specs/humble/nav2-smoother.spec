...
Summary:        Meta package for ros2-humble-nav2_smoother and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_smoother
Requires:       ros2-humble-nav2_smoother-devel

Obsoletes: ros-humble-nav2-smoother < 1.1.14-1
