...
Summary:        Meta package for ros2-humble-nav2_theta_star_planner and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_theta_star_planner
Requires:       ros2-humble-nav2_theta_star_planner-devel

Obsoletes: ros-humble-nav2-theta-star-planner < 1.1.14-1
