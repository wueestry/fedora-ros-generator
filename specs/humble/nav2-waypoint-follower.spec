...
Summary:        Meta package for ros2-humble-nav2_waypoint_follower and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-nav2_waypoint_follower
Requires:       ros2-humble-nav2_waypoint_follower-devel

Obsoletes: ros-humble-nav2-waypoint-follower < 1.1.14-1
