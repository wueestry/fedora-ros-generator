...
Summary:        Meta package for ros2-humble-rmw_connextdds and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rmw_connextdds
Requires:       ros2-humble-rmw_connextdds-devel

Obsoletes: ros-humble-rmw-connextdds < 0.11.2-1
