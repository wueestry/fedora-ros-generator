...
Summary:        Meta package for ros2-humble-rmw_fastrtps_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rmw_fastrtps_cpp
Requires:       ros2-humble-rmw_fastrtps_cpp-devel

Obsoletes: ros-humble-rmw-fastrtps-cpp < 6.2.7-1
