...
Summary:        Meta package for ros2-humble-rmw_fastrtps_dynamic_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rmw_fastrtps_dynamic_cpp
Requires:       ros2-humble-rmw_fastrtps_dynamic_cpp-devel

Obsoletes: ros-humble-rmw-fastrtps-dynamic-cpp < 6.2.7-1
