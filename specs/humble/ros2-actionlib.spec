...
Source0:        https://github.com/ros-gbp/actionlib-release/archive/release/noetic/actionlib/1.14.0-1.tar.gz#/ros2-noetic-actionlib-1.14.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-rosnode-devel
...
Provides:  ros2-noetic-actionlib = 1.14.0-1
Obsoletes: ros2-noetic-actionlib < 1.14.0-1
...
Provides: ros2-noetic-actionlib-devel = 1.14.0-1
Obsoletes: ros2-noetic-actionlib-devel < 1.14.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,actionlib/include/,share/actionlib/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.14.0-1
