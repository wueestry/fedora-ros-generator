...
Source0:        https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_core/1.3.10-1.tar.gz#/ros2-humble-ament_cmake_core-1.3.10-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_core = 1.3.10-1
Obsoletes: ros2-humble-ament_cmake_core < 1.3.10-1
...
Provides: ros2-humble-ament_cmake_core-devel = 1.3.10-1
Obsoletes: ros2-humble-ament_cmake_core-devel < 1.3.10-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ament_cmake_core ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ament_cmake_core
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ament_cmake_core/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ament_cmake_core ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ament_cmake_core
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ament_cmake_core/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_cmake_core/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_cmake_core \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ament_cmake_core/include/,share/ament_cmake_core/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ament_cmake_core/{lib*/pkgconfig,include/,cmake/,ament_cmake_core/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_cmake_core/{lib*/pkgconfig,include/,cmake/,ament_cmake_core/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_cmake_core/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
