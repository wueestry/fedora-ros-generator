...
Source0:        https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_target_dependencies/1.3.9-1.tar.gz#/ros2-humble-ament_cmake_target_dependencies-1.3.9-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_target_dependencies = 1.3.9-1
Obsoletes: ros2-humble-ament_cmake_target_dependencies < 1.3.9-1
...
Provides: ros2-humble-ament_cmake_target_dependencies-devel = 1.3.9-1
Obsoletes: ros2-humble-ament_cmake_target_dependencies-devel < 1.3.9-1
