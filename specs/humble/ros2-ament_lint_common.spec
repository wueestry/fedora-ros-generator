Name:           ros2-humble-ament_lint_common
Version:        0.12.11
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_lint_common/0.12.11-1.tar.gz#/ros2-humble-ament_lint_common-0.12.11-source0.tar.gz
...
Provides:  ros2-humble-ament_lint_common = 0.12.11-1
Obsoletes: ros2-humble-ament_lint_common < 0.12.11-1
...
Provides: ros2-humble-ament_lint_common-devel = 0.12.11-1
Obsoletes: ros2-humble-ament_lint_common-devel < 0.12.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ament_lint_common ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ament_lint_common
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ament_lint_common/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ament_lint_common ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ament_lint_common
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ament_lint_common/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_lint_common/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_lint_common \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ament_lint_common/include/,share/ament_lint_common/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ament_lint_common/{lib*/pkgconfig,include/,cmake/,ament_lint_common/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ament_lint_common/{lib*/pkgconfig,include/,cmake/,ament_lint_common/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ament_lint_common/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
