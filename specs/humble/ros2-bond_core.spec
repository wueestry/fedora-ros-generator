...
Source0:        https://github.com/ros-gbp/bond_core-release/archive/release/noetic/bond_core/1.8.6-1.tar.gz#/ros2-noetic-bond_core-1.8.6-source0.tar.gz
...
Provides:  ros2-noetic-bond_core = 1.8.6-1
Obsoletes: ros2-noetic-bond_core < 1.8.6-1
...
Provides: ros2-noetic-bond_core-devel = 1.8.6-1
Obsoletes: ros2-noetic-bond_core-devel < 1.8.6-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,bond_core/include/,share/bond_core/cmake} \
