...
Source0:        https://github.com/ros-gbp/cmake_modules-release/archive/release/noetic/cmake_modules/0.5.0-1.tar.gz#/ros2-noetic-cmake_modules-0.5.0-source0.tar.gz
...
Provides:  ros2-noetic-cmake_modules = 0.5.0-1
Obsoletes: ros2-noetic-cmake_modules < 0.5.0-1
...
Provides: ros2-noetic-cmake_modules-devel = 0.5.0-1
Obsoletes: ros2-noetic-cmake_modules-devel < 0.5.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,cmake_modules/include/,share/cmake_modules/cmake} \
