Name:           ros2-humble-common_interfaces
Version:        4.2.4
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/release/humble/common_interfaces/4.2.4-1.tar.gz#/ros2-humble-common_interfaces-4.2.4-source0.tar.gz
...
Provides:  ros2-humble-common_interfaces = 4.2.4-1
Obsoletes: ros2-humble-common_interfaces < 4.2.4-1
...
Provides: ros2-humble-common_interfaces-devel = 4.2.4-1
Obsoletes: ros2-humble-common_interfaces-devel < 4.2.4-1
...
colcon \
  ...
  --packages-select common_interfaces
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/common_interfaces ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/common_interfaces
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/include/* %{buildroot}/%{_libdir}/ros2-humble/include/common_interfaces/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/common_interfaces ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/common_interfaces
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/share/* %{buildroot}/%{_libdir}/ros2-humble/share/common_interfaces/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/common_interfaces/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/common_interfaces \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,common_interfaces/include/,share/common_interfaces/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/common_interfaces/{lib*/pkgconfig,include/,cmake/,common_interfaces/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/common_interfaces/{lib*/pkgconfig,include/,cmake/,common_interfaces/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/common_interfaces/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
