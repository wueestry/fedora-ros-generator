...
Source0:        https://github.com/ros2-gbp/control_msgs-release/archive/release/humble/control_msgs/4.6.0-1.tar.gz#/ros2-humble-control_msgs-4.6.0-source0.tar.gz
...
Provides:  ros2-humble-control_msgs = 4.6.0-1
Obsoletes: ros2-humble-control_msgs < 4.6.0-1
...
Provides: ros2-humble-control_msgs-devel = 4.6.0-1
Obsoletes: ros2-humble-control_msgs-devel < 4.6.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/control_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/control_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/include/* %{buildroot}/%{_libdir}/ros2-humble/include/control_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/control_msgs/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/control_msgs/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/control_msgs/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/control_msgs/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/control_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/control_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/control_msgs/share/* %{buildroot}/%{_libdir}/ros2-humble/share/control_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/control_msgs/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/control_msgs/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/control_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/control_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/control_msgs \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,control_msgs/include/,share/control_msgs/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/control_msgs/{lib*/pkgconfig,include/,cmake/,control_msgs/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/control_msgs/{lib*/pkgconfig,include/,cmake/,control_msgs/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/control_msgs/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
%changelog
* Mon Aug 12 2024 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - humble.4.6.0-1
