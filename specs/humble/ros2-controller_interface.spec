...
Source0:        https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/controller_interface/2.42.0-1.tar.gz#/ros2-humble-controller_interface-2.42.0-source0.tar.gz
...
Provides:  ros2-humble-controller_interface = 2.42.0-1
Obsoletes: ros2-humble-controller_interface < 2.42.0-1
...
Provides: ros2-humble-controller_interface-devel = 2.42.0-1
Obsoletes: ros2-humble-controller_interface-devel < 2.42.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/controller_interface ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/controller_interface
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/include/* %{buildroot}/%{_libdir}/ros2-humble/include/controller_interface/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/controller_interface/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/controller_interface/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/controller_interface/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/controller_interface/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/controller_interface ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/controller_interface
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/controller_interface/share/* %{buildroot}/%{_libdir}/ros2-humble/share/controller_interface/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/controller_interface/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_interface/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/controller_interface/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/controller_interface/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_interface \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,controller_interface/include/,share/controller_interface/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/controller_interface/{lib*/pkgconfig,include/,cmake/,controller_interface/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_interface/{lib*/pkgconfig,include/,cmake/,controller_interface/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_interface/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
