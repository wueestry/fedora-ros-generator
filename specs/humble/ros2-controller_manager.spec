Name:           ros2-humble-controller_manager
Version:        2.42.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/controller_manager/2.42.0-1.tar.gz#/ros2-humble-controller_manager-2.42.0-source0.tar.gz

Patch0: ros2.controller_manager.executors_include.patch
...
Provides:  ros2-humble-controller_manager = 2.42.0-1
Obsoletes: ros2-humble-controller_manager < 2.42.0-1
...
Provides: ros2-humble-controller_manager-devel = 2.42.0-1
Obsoletes: ros2-humble-controller_manager-devel < 2.42.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/controller_manager ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/controller_manager
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/include/* %{buildroot}/%{_libdir}/ros2-humble/include/controller_manager/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/controller_manager/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/controller_manager/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/controller_manager/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/controller_manager/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/controller_manager ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/controller_manager
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/controller_manager/share/* %{buildroot}/%{_libdir}/ros2-humble/share/controller_manager/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/controller_manager/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_manager/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/controller_manager/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/controller_manager/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_manager \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,controller_manager/include/,share/controller_manager/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/controller_manager/{lib*/pkgconfig,include/,cmake/,controller_manager/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/controller_manager/{lib*/pkgconfig,include/,cmake/,controller_manager/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/controller_manager/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
