...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/cv_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/cv_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/include/* %{buildroot}/%{_libdir}/ros2-humble/include/cv_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/cv_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/cv_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/share/* %{buildroot}/%{_libdir}/ros2-humble/share/cv_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/cv_bridge/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/cv_bridge \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,cv_bridge/include/,share/cv_bridge/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/cv_bridge/{lib*/pkgconfig,include/,cmake/,cv_bridge/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cv_bridge/{lib*/pkgconfig,include/,cmake/,cv_bridge/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/cv_bridge/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
