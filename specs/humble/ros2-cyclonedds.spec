...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/cyclonedds ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/cyclonedds
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/include/* %{buildroot}/%{_libdir}/ros2-humble/include/cyclonedds/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/cyclonedds ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/cyclonedds
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/share/* %{buildroot}/%{_libdir}/ros2-humble/share/cyclonedds/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/cyclonedds/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/cyclonedds \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,cyclonedds/include/,share/cyclonedds/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/cyclonedds/{lib*/pkgconfig,include/,cmake/,cyclonedds/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/cyclonedds/{lib*/pkgconfig,include/,cmake/,cyclonedds/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/cyclonedds/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
