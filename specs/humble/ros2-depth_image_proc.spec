Name:           ros2-humble-depth_image_proc
Version:        3.0.5
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/depth_image_proc/3.0.5-1.tar.gz#/ros2-humble-depth_image_proc-3.0.5-source0.tar.gz
...
Provides:  ros2-humble-depth_image_proc = 3.0.5-1
Obsoletes: ros2-humble-depth_image_proc < 3.0.5-1
...
Provides: ros2-humble-depth_image_proc-devel = 3.0.5-1
Obsoletes: ros2-humble-depth_image_proc-devel < 3.0.5-1
...
colcon \
  ...
  --packages-select depth_image_proc
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/depth_image_proc ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/depth_image_proc
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/include/* %{buildroot}/%{_libdir}/ros2-humble/include/depth_image_proc/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/depth_image_proc ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/depth_image_proc
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/share/* %{buildroot}/%{_libdir}/ros2-humble/share/depth_image_proc/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/depth_image_proc/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/depth_image_proc \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,depth_image_proc/include/,share/depth_image_proc/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/depth_image_proc/{lib*/pkgconfig,include/,cmake/,depth_image_proc/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depth_image_proc/{lib*/pkgconfig,include/,cmake/,depth_image_proc/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/depth_image_proc/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
