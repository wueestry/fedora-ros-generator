Name:           ros2-humble-depthimage_to_laserscan
Version:        2.5.1
Release:        1%{?dist}
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/depthimage_to_laserscan ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/depthimage_to_laserscan
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/include/* %{buildroot}/%{_libdir}/ros2-humble/include/depthimage_to_laserscan/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/depthimage_to_laserscan ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/depthimage_to_laserscan
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/share/* %{buildroot}/%{_libdir}/ros2-humble/share/depthimage_to_laserscan/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/depthimage_to_laserscan/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/depthimage_to_laserscan \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,depthimage_to_laserscan/include/,share/depthimage_to_laserscan/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/depthimage_to_laserscan/{lib*/pkgconfig,include/,cmake/,depthimage_to_laserscan/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/depthimage_to_laserscan/{lib*/pkgconfig,include/,cmake/,depthimage_to_laserscan/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/depthimage_to_laserscan/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
