...
Source0:        https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/diagnostic_analysis/1.11.0-1.tar.gz#/ros2-noetic-diagnostic_analysis-1.11.0-source0.tar.gz
...
Provides:  ros2-noetic-diagnostic_analysis = 1.11.0-1
Obsoletes: ros2-noetic-diagnostic_analysis < 1.11.0-1
...
Provides: ros2-noetic-diagnostic_analysis-devel = 1.11.0-1
Obsoletes: ros2-noetic-diagnostic_analysis-devel < 1.11.0-1
...
colcon \
  ...
  --packages-select diagnostic_analysis
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,diagnostic_analysis/include/,share/diagnostic_analysis/cmake} \
