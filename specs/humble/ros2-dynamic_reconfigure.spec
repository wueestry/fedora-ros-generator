...
Source0:        https://github.com/ros-gbp/dynamic_reconfigure-release/archive/release/noetic/dynamic_reconfigure/1.7.3-1.tar.gz#/ros2-noetic-dynamic_reconfigure-1.7.3-source0.tar.gz
...
Provides:  ros2-noetic-dynamic_reconfigure = 1.7.3-1
Obsoletes: ros2-noetic-dynamic_reconfigure < 1.7.3-1
...
Provides: ros2-noetic-dynamic_reconfigure-devel = 1.7.3-1
Obsoletes: ros2-noetic-dynamic_reconfigure-devel < 1.7.3-1
...
colcon \
  ...
  --packages-select dynamic_reconfigure
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,dynamic_reconfigure/include/,share/dynamic_reconfigure/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.7.3-1
