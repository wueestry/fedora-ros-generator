...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/noetic/eigen_conversions/1.13.2-1.tar.gz#/ros2-noetic-eigen_conversions-1.13.2-source0.tar.gz
...
Provides:  ros2-noetic-eigen_conversions = 1.13.2-1
Obsoletes: ros2-noetic-eigen_conversions < 1.13.2-1
...
Provides: ros2-noetic-eigen_conversions-devel = 1.13.2-1
Obsoletes: ros2-noetic-eigen_conversions-devel < 1.13.2-1
...
colcon \
  ...
  --packages-select eigen_conversions
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,eigen_conversions/include/,share/eigen_conversions/cmake} \
