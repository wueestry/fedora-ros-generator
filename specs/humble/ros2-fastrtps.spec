...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/fastrtps ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/fastrtps
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/include/* %{buildroot}/%{_libdir}/ros2-humble/include/fastrtps/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/fastrtps/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/fastrtps/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/fastrtps/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/fastrtps/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/fastrtps ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/fastrtps
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/fastrtps/share/* %{buildroot}/%{_libdir}/ros2-humble/share/fastrtps/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/fastrtps/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/fastrtps/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/fastrtps/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/fastrtps/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/fastrtps \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/fastrtps/{lib*/pkgconfig,include/,cmake/,fastrtps/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/fastrtps/{lib*/pkgconfig,include/,cmake/,fastrtps/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/fastrtps/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
