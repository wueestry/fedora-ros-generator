...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.34.0-1.tar.gz#/ros2-humble-force_torque_sensor_broadcaster-2.34.0-source0.tar.gz
...
Provides:  ros2-humble-force_torque_sensor_broadcaster = 2.34.0-1
Obsoletes: ros2-humble-force_torque_sensor_broadcaster < 2.34.0-1
...
Provides: ros2-humble-force_torque_sensor_broadcaster-devel = 2.34.0-1
Obsoletes: ros2-humble-force_torque_sensor_broadcaster-devel < 2.34.0-1
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/include/* %{buildroot}/%{_libdir}/ros2-humble/include/force_torque_sensor_broadcaster
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/share %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/share -type f -exec sed -i "s:opt/force_torque_sensor_broadcaster/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/bin %{buildroot}/%{_libdir}/ros2-humble/
# fi
# 
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/extra_cmake %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/extra_cmake -type f -exec sed -i "s:opt/force_torque_sensor_broadcaster/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/lib %{buildroot}/%{_libdir}/ros2-humble/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/force_torque_sensor_broadcaster/lib64 %{buildroot}/%{_libdir}/ros2-humble/lib64
# fi
