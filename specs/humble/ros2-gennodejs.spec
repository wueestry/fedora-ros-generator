...
Source0:        https://github.com/sloretz/gennodejs-release/archive/release/noetic/gennodejs/2.0.2-1.tar.gz#/ros2-noetic-gennodejs-2.0.2-source0.tar.gz
...
BuildRequires:  ros2-noetic-genmsg-devel

Requires:       ros2-noetic-genmsg

Provides:  ros2-noetic-gennodejs = 2.0.2-1
Obsoletes: ros2-noetic-gennodejs < 2.0.2-1
...
Provides: ros2-noetic-gennodejs-devel = 2.0.2-1
Obsoletes: ros2-noetic-gennodejs-devel < 2.0.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,gennodejs/include/,share/gennodejs/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.2.0.2-1
