...
Source0:        https://github.com/ros-gbp/genpy-release/archive/release/noetic/genpy/0.6.15-1.tar.gz#/ros2-noetic-genpy-0.6.15-source0.tar.gz
...
Provides:  ros2-noetic-genpy = 0.6.15-1
Obsoletes: ros2-noetic-genpy < 0.6.15-1
...
Provides: ros2-noetic-genpy-devel = 0.6.15-1
Obsoletes: ros2-noetic-genpy-devel < 0.6.15-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,genpy/include/,share/genpy/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.6.15-1
