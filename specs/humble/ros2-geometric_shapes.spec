Name:           ros2-humble-geometric_shapes
Version:        2.1.3
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/geometric_shapes-release/archive/release/humble/geometric_shapes/2.1.3-2.tar.gz#/ros2-humble-geometric_shapes-2.1.3-source0.tar.gz
...
Provides:  ros2-humble-geometric_shapes = 2.1.3-1
Obsoletes: ros2-humble-geometric_shapes < 2.1.3-1
...
Provides: ros2-humble-geometric_shapes-devel = 2.1.3-1
Obsoletes: ros2-humble-geometric_shapes-devel < 2.1.3-1
...
colcon \
  ...
  --packages-select geometric_shapes
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/geometric_shapes ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/geometric_shapes
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/include/* %{buildroot}/%{_libdir}/ros2-humble/include/geometric_shapes/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/geometric_shapes ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/geometric_shapes
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/share/* %{buildroot}/%{_libdir}/ros2-humble/share/geometric_shapes/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/geometric_shapes/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/geometric_shapes \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,geometric_shapes/include/,share/geometric_shapes/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/geometric_shapes/{lib*/pkgconfig,include/,cmake/,geometric_shapes/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/geometric_shapes/{lib*/pkgconfig,include/,cmake/,geometric_shapes/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/geometric_shapes/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
