...
Source0:        https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/image_rotate/3.0.5-1.tar.gz#/ros2-humble-image_rotate-3.0.5-source0.tar.gz
...
Provides:  ros2-humble-image_rotate = 3.0.5-1
Obsoletes: ros2-humble-image_rotate < 3.0.5-1
...
Provides: ros2-humble-image_rotate-devel = 3.0.5-1
Obsoletes: ros2-humble-image_rotate-devel < 3.0.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/image_rotate ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/image_rotate
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/include/* %{buildroot}/%{_libdir}/ros2-humble/include/image_rotate/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/image_rotate/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/image_rotate/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/image_rotate/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/image_rotate/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/image_rotate ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/image_rotate
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/image_rotate/share/* %{buildroot}/%{_libdir}/ros2-humble/share/image_rotate/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/image_rotate/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_rotate/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/image_rotate/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/image_rotate/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_rotate \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,image_rotate/include/,share/image_rotate/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/image_rotate/{lib*/pkgconfig,include/,cmake/,image_rotate/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_rotate/{lib*/pkgconfig,include/,cmake/,image_rotate/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_rotate/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
