...
Source0:        https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/image_view/3.0.5-1.tar.gz#/ros2-humble-image_view-3.0.5-source0.tar.gz
...
Provides:  ros2-humble-image_view = 3.0.5-1
Obsoletes: ros2-humble-image_view < 3.0.5-1
...
Provides: ros2-humble-image_view-devel = 3.0.5-1
Obsoletes: ros2-humble-image_view-devel < 3.0.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/image_view ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/image_view
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/include/* %{buildroot}/%{_libdir}/ros2-humble/include/image_view/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/image_view/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/image_view/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/image_view/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/image_view/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/image_view ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/image_view
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/image_view/share/* %{buildroot}/%{_libdir}/ros2-humble/share/image_view/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/image_view/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/image_view]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/image_view
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_view/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/image_view/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/image_view/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_view \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,image_view/include/,share/image_view/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/image_view/{lib*/pkgconfig,include/,cmake/,image_view/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/image_view/{lib*/pkgconfig,include/,cmake/,image_view/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/image_view/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
