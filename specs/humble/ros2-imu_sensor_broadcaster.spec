Name:           ros2-humble-imu_sensor_broadcaster
Version:        2.37.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.37.0-1.tar.gz#/ros2-humble-imu_sensor_broadcaster-2.37.0-source0.tar.gz
...
Provides:  ros2-humble-imu_sensor_broadcaster = 2.37.0-1
Obsoletes: ros2-humble-imu_sensor_broadcaster < 2.37.0-1
...
Provides: ros2-humble-imu_sensor_broadcaster-devel = 2.37.0-1
Obsoletes: ros2-humble-imu_sensor_broadcaster-devel < 2.37.0-1
...
colcon \
  ...
  --packages-select imu_sensor_broadcaster
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/imu_sensor_broadcaster ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/imu_sensor_broadcaster
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/include/* %{buildroot}/%{_libdir}/ros2-humble/include/imu_sensor_broadcaster/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/imu_sensor_broadcaster ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/imu_sensor_broadcaster
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/share/* %{buildroot}/%{_libdir}/ros2-humble/share/imu_sensor_broadcaster/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/imu_sensor_broadcaster/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/imu_sensor_broadcaster \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,imu_sensor_broadcaster/include/,share/imu_sensor_broadcaster/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/imu_sensor_broadcaster/{lib*/pkgconfig,include/,cmake/,imu_sensor_broadcaster/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/imu_sensor_broadcaster/{lib*/pkgconfig,include/,cmake/,imu_sensor_broadcaster/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/imu_sensor_broadcaster/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
