...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/noetic/kdl_conversions/1.13.2-1.tar.gz#/ros2-noetic-kdl_conversions-1.13.2-source0.tar.gz
...
Provides:  ros2-noetic-kdl_conversions = 1.13.2-1
Obsoletes: ros2-noetic-kdl_conversions < 1.13.2-1
...
Provides: ros2-noetic-kdl_conversions-devel = 1.13.2-1
Obsoletes: ros2-noetic-kdl_conversions-devel < 1.13.2-1
...
colcon \
  ...
  --packages-select kdl_conversions
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,kdl_conversions/include/,share/kdl_conversions/cmake} \
