Name:           ros2-humble-kinematics_interface_kdl
Version:        0.3.0
Release:        1%{?dist}
Summary:        ROS package kinematics_interface_kdl

License:        Apache License 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/kinematics_interface-release/archive/release/humble/kinematics_interface_kdl/0.3.0-1.tar.gz#/ros2-humble-kinematics_interface_kdl-0.3.0-source0.tar.gz
...
Provides:  ros2-humble-kinematics_interface_kdl = 0.3.0-1
Obsoletes: ros2-humble-kinematics_interface_kdl < 0.3.0-1
...
Provides: ros2-humble-kinematics_interface_kdl-devel = 0.3.0-1
Obsoletes: ros2-humble-kinematics_interface_kdl-devel < 0.3.0-1
...
colcon \
  ...
  --packages-select kinematics_interface_kdl
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/kinematics_interface_kdl ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/kinematics_interface_kdl
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/include/* %{buildroot}/%{_libdir}/ros2-humble/include/kinematics_interface_kdl
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/share %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/share -type f -exec sed -i "s:opt/kinematics_interface_kdl/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/bin %{buildroot}/%{_libdir}/ros2-humble/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/extra_cmake %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/extra_cmake -type f -exec sed -i "s:opt/kinematics_interface_kdl/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/lib %{buildroot}/%{_libdir}/ros2-humble/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/kinematics_interface_kdl/lib64 %{buildroot}/%{_libdir}/ros2-humble/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,kinematics_interface_kdl/include/,share/kinematics_interface_kdl/cmake} \
