Name:           ros2-humble-laser_geometry
Version:        2.4.0
Release:        1%{?dist}
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/laser_geometry ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/laser_geometry
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/include/* %{buildroot}/%{_libdir}/ros2-humble/include/laser_geometry/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/laser_geometry ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/laser_geometry
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/share/* %{buildroot}/%{_libdir}/ros2-humble/share/laser_geometry/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/laser_geometry/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/laser_geometry \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,laser_geometry/include/,share/laser_geometry/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/laser_geometry/{lib*/pkgconfig,include/,cmake/,laser_geometry/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/laser_geometry/{lib*/pkgconfig,include/,cmake/,laser_geometry/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/laser_geometry/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
