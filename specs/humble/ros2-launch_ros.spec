...
Source0:        https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/launch_ros/0.19.7-2.tar.gz#/ros2-humble-launch_ros-0.19.7-source0.tar.gz
...
Provides:  ros2-humble-launch_ros = 0.19.7-1
Obsoletes: ros2-humble-launch_ros < 0.19.7-1
...
Provides: ros2-humble-launch_ros-devel = 0.19.7-1
Obsoletes: ros2-humble-launch_ros-devel < 0.19.7-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/launch_ros ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/launch_ros
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/include/* %{buildroot}/%{_libdir}/ros2-humble/include/launch_ros/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/launch_ros/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/launch_ros/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/launch_ros/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/launch_ros/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/launch_ros ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/launch_ros
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/launch_ros/share/* %{buildroot}/%{_libdir}/ros2-humble/share/launch_ros/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/launch_ros/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_ros/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/launch_ros/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/launch_ros/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_ros \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,launch_ros/include/,share/launch_ros/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/launch_ros/{lib*/pkgconfig,include/,cmake/,launch_ros/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_ros/{lib*/pkgconfig,include/,cmake/,launch_ros/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_ros/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
