...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/launch_testing_ros ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/launch_testing_ros
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/include/* %{buildroot}/%{_libdir}/ros2-humble/include/launch_testing_ros/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/launch_testing_ros ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/launch_testing_ros
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/share/* %{buildroot}/%{_libdir}/ros2-humble/share/launch_testing_ros/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_testing_ros/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_testing_ros \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,launch_testing_ros/include/,share/launch_testing_ros/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/launch_testing_ros/{lib*/pkgconfig,include/,cmake/,launch_testing_ros/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/launch_testing_ros/{lib*/pkgconfig,include/,cmake/,launch_testing_ros/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/launch_testing_ros/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
