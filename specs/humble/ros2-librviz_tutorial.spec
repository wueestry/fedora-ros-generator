...
Source0:        https://github.com/ros-gbp/visualization_tutorials-release/archive/release/noetic/librviz_tutorial/0.11.0-1.tar.gz#/ros2-noetic-librviz_tutorial-0.11.0-source0.tar.gz
...
Provides:  ros2-noetic-librviz_tutorial = 0.11.0-1
Obsoletes: ros2-noetic-librviz_tutorial < 0.11.0-1
...
Provides: ros2-noetic-librviz_tutorial-devel = 0.11.0-1
Obsoletes: ros2-noetic-librviz_tutorial-devel < 0.11.0-1
...
colcon \
  ...
  --packages-select librviz_tutorial
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,librviz_tutorial/include/,share/librviz_tutorial/cmake} \
