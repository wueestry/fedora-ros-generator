...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/moveit_kinematics ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/moveit_kinematics
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/include/* %{buildroot}/%{_libdir}/ros2-humble/include/moveit_kinematics/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/moveit_kinematics ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/moveit_kinematics
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/share/* %{buildroot}/%{_libdir}/ros2-humble/share/moveit_kinematics/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_kinematics/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_kinematics \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/moveit_kinematics/{lib*/pkgconfig,include/,cmake/,moveit_kinematics/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_kinematics/{lib*/pkgconfig,include/,cmake/,moveit_kinematics/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_kinematics/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
