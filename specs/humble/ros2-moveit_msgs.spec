...
Source0:        https://github.com/ros2-gbp/moveit_msgs-release/archive/release/humble/moveit_msgs/2.2.1-1.tar.gz#/ros2-humble-moveit_msgs-2.2.1-source0.tar.gz
...
Provides:  ros2-humble-moveit_msgs = 2.2.1-1
Obsoletes: ros2-humble-moveit_msgs < 2.2.1-1
...
Provides: ros2-humble-moveit_msgs-devel = 2.2.1-1
Obsoletes: ros2-humble-moveit_msgs-devel < 2.2.1-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/moveit_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/moveit_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/include/* %{buildroot}/%{_libdir}/ros2-humble/include/moveit_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/moveit_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/moveit_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/share/* %{buildroot}/%{_libdir}/ros2-humble/share/moveit_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_msgs/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_msgs \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,moveit_msgs/include/,share/moveit_msgs/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/moveit_msgs/{lib*/pkgconfig,include/,cmake/,moveit_msgs/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_msgs/{lib*/pkgconfig,include/,cmake/,moveit_msgs/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_msgs/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
