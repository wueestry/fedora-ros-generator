Name:           ros2-humble-moveit_planners_chomp
Version:        2.5.5
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_planners_chomp/2.5.5-1.tar.gz#/ros2-humble-moveit_planners_chomp-2.5.5-source0.tar.gz
...
BuildRequires:  ros2-humble-chomp_motion_planner-devel
...
Requires:       ros2-humble-chomp_motion_planner
Requires:       ros2-humble-moveit_common
Requires:       ros2-humble-moveit_core
Requires:       ros2-humble-pluginlib
Requires:       ros2-humble-rclcpp

Provides:  ros2-humble-moveit_planners_chomp = 2.5.5-1
Obsoletes: ros2-humble-moveit_planners_chomp < 2.5.5-1
...
Requires:       ros2-humble-chomp_motion_planner-devel
Requires:       ros2-humble-moveit_common-devel
Requires:       ros2-humble-moveit_core-devel
Requires:       ros2-humble-pluginlib-devel
Requires:       ros2-humble-rclcpp-devel

Provides: ros2-humble-moveit_planners_chomp-devel = 2.5.5-1
Obsoletes: ros2-humble-moveit_planners_chomp-devel < 2.5.5-1
...
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,moveit_planners_chomp/include/,share/moveit_planners_chomp/cmake} \
...
%changelog
* Fri Sep 29 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - humble.2.5.5-1
