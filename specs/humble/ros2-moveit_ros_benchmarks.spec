Name:           ros2-humble-moveit_ros_benchmarks
Version:        2.5.5
Release:        1%{?dist}
...
Provides:  ros2-humble-moveit_ros_benchmarks = 2.5.5-1
Obsoletes: ros2-humble-moveit_ros_benchmarks < 2.5.5-1
...
Provides: ros2-humble-moveit_ros_benchmarks-devel = 2.5.5-1
Obsoletes: ros2-humble-moveit_ros_benchmarks-devel < 2.5.5-1
...
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/moveit_ros_benchmarks ]; then
