Name:           ros2-humble-moveit_ros_planning
Version:        2.5.5
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_planning/2.5.5-1.tar.gz#/ros2-humble-moveit_ros_planning-2.5.5-source0.tar.gz
...
Provides:  ros2-humble-moveit_ros_planning = 2.5.5-1
Obsoletes: ros2-humble-moveit_ros_planning < 2.5.5-1
...
Provides: ros2-humble-moveit_ros_planning-devel = 2.5.5-1
Obsoletes: ros2-humble-moveit_ros_planning-devel < 2.5.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/moveit_ros_planning ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/moveit_ros_planning
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/include/* %{buildroot}/%{_libdir}/ros2-humble/include/moveit_ros_planning/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/moveit_ros_planning ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/moveit_ros_planning
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/share/* %{buildroot}/%{_libdir}/ros2-humble/share/moveit_ros_planning/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_ros_planning/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_ros_planning \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning/include/,share/moveit_ros_planning/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/moveit_ros_planning/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/moveit_ros_planning/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/moveit_ros_planning/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
