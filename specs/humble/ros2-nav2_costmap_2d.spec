Name:           ros2-humble-nav2_costmap_2d
Version:        1.1.15
Release:        1%{?dist}
...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_costmap_2d/1.1.15-1.tar.gz#/ros2-humble-nav2_costmap_2d-1.1.15-source0.tar.gz
...
BuildRequires:  ros2-humble-nav2_voxel_grid-devel
...
Provides:  ros2-humble-nav2_costmap_2d = 1.1.15-1
Obsoletes: ros2-humble-nav2_costmap_2d < 1.1.15-1
...
Provides: ros2-humble-nav2_costmap_2d-devel = 1.1.15-1
Obsoletes: ros2-humble-nav2_costmap_2d-devel < 1.1.15-1
...
colcon \
  ...
  --packages-select nav2_costmap_2d
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/nav2_costmap_2d ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/nav2_costmap_2d
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/include/* %{buildroot}/%{_libdir}/ros2-humble/include/nav2_costmap_2d/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/nav2_costmap_2d ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/nav2_costmap_2d
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/share/* %{buildroot}/%{_libdir}/ros2-humble/share/nav2_costmap_2d/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_costmap_2d/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_costmap_2d \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,nav2_costmap_2d/include/,share/nav2_costmap_2d/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/nav2_costmap_2d/{lib*/pkgconfig,include/,cmake/,nav2_costmap_2d/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_costmap_2d/{lib*/pkgconfig,include/,cmake/,nav2_costmap_2d/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_costmap_2d/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
