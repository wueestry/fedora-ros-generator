Name:           ros2-humble-nav2_smoother
Version:        1.1.15
Release:        1%{?dist}
Summary:        ROS package nav2_smoother

License:        Apache-2.0
URL:            http://www.ros.org/

Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_smoother/1.1.15-1.tar.gz#/ros2-humble-nav2_smoother-1.1.15-source0.tar.gz

Patch0: ros-nav2_smoother.init_variables.patch
...
Provides:  ros2-humble-nav2_smoother = 1.1.15-1
Obsoletes: ros2-humble-nav2_smoother < 1.1.15-1
...
Provides: ros2-humble-nav2_smoother-devel = 1.1.15-1
Obsoletes: ros2-humble-nav2_smoother-devel < 1.1.15-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/nav2_smoother ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/nav2_smoother
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/include/* %{buildroot}/%{_libdir}/ros2-humble/include/nav2_smoother/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/nav2_smoother ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/nav2_smoother
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/share/* %{buildroot}/%{_libdir}/ros2-humble/share/nav2_smoother/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_smoother/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_smoother \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,nav2_smoother/include/,share/nav2_smoother/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/nav2_smoother/{lib*/pkgconfig,include/,cmake/,nav2_smoother/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_smoother/{lib*/pkgconfig,include/,cmake/,nav2_smoother/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_smoother/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
