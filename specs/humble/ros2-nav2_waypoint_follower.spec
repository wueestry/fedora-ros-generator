...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_waypoint_follower/1.1.15-1.tar.gz#/ros2-humble-nav2_waypoint_follower-1.1.15-source0.tar.gz
...
Provides:  ros2-humble-nav2_waypoint_follower = 1.1.15-1
Obsoletes: ros2-humble-nav2_waypoint_follower < 1.1.15-1
...
Provides: ros2-humble-nav2_waypoint_follower-devel = 1.1.15-1
Obsoletes: ros2-humble-nav2_waypoint_follower-devel < 1.1.15-1
...
colcon \
  ...
  --packages-select nav2_waypoint_follower
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/nav2_waypoint_follower ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/nav2_waypoint_follower
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/include/* %{buildroot}/%{_libdir}/ros2-humble/include/nav2_waypoint_follower/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/nav2_waypoint_follower ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/nav2_waypoint_follower
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/share/* %{buildroot}/%{_libdir}/ros2-humble/share/nav2_waypoint_follower/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_waypoint_follower/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_waypoint_follower \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,nav2_waypoint_follower/include/,share/nav2_waypoint_follower/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/nav2_waypoint_follower/{lib*/pkgconfig,include/,cmake/,nav2_waypoint_follower/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/nav2_waypoint_follower/{lib*/pkgconfig,include/,cmake/,nav2_waypoint_follower/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/nav2_waypoint_follower/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
