...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/navigation2/1.1.15-1.tar.gz#/ros2-humble-navigation2-1.1.15-source0.tar.gz
...
Provides:  ros2-humble-navigation2 = 1.1.15-1
Obsoletes: ros2-humble-navigation2 < 1.1.15-1
...
Provides: ros2-humble-navigation2-devel = 1.1.15-1
Obsoletes: ros2-humble-navigation2-devel < 1.1.15-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/navigation2 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/navigation2
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/include/* %{buildroot}/%{_libdir}/ros2-humble/include/navigation2/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/navigation2/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/navigation2/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/navigation2/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/navigation2/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/navigation2 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/navigation2
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/navigation2/share/* %{buildroot}/%{_libdir}/ros2-humble/share/navigation2/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/navigation2/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/navigation2/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/navigation2/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/navigation2/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/navigation2 \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,navigation2/include/,share/navigation2/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/navigation2/{lib*/pkgconfig,include/,cmake/,navigation2/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/navigation2/{lib*/pkgconfig,include/,cmake/,navigation2/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/navigation2/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
