...
Source0:        https://github.com/ros-gbp/nodelet_core-release/archive/release/noetic/nodelet/1.10.2-1.tar.gz#/ros2-noetic-nodelet-1.10.2-source0.tar.gz
...
Provides:  ros2-noetic-nodelet = 1.10.2-1
Obsoletes: ros2-noetic-nodelet < 1.10.2-1
...
Provides: ros2-noetic-nodelet-devel = 1.10.2-1
Obsoletes: ros2-noetic-nodelet-devel < 1.10.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nodelet/include/,share/nodelet/cmake} \
