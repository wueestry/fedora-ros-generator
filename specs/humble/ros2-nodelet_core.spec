...
Source0:        https://github.com/ros-gbp/nodelet_core-release/archive/release/noetic/nodelet_core/1.10.2-1.tar.gz#/ros2-noetic-nodelet_core-1.10.2-source0.tar.gz
...
Requires:       ros2-noetic-nodelet_topic_tools

Provides:  ros2-noetic-nodelet_core = 1.10.2-1
Obsoletes: ros2-noetic-nodelet_core < 1.10.2-1
...
Requires:       ros2-noetic-nodelet_topic_tools-devel

Provides: ros2-noetic-nodelet_core-devel = 1.10.2-1
Obsoletes: ros2-noetic-nodelet_core-devel < 1.10.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nodelet_core/include/,share/nodelet_core/cmake} \
