...
Source0:        https://github.com/ros-gbp/nodelet_core-release/archive/release/noetic/nodelet_topic_tools/1.10.2-1.tar.gz#/ros2-noetic-nodelet_topic_tools-1.10.2-source0.tar.gz
...
BuildRequires:  ros2-noetic-dynamic_reconfigure-devel
BuildRequires:  ros2-noetic-message_filters-devel
BuildRequires:  ros2-noetic-nodelet-devel
BuildRequires:  ros2-noetic-pluginlib-devel
BuildRequires:  ros2-noetic-roscpp-devel

Requires:       ros2-noetic-dynamic_reconfigure

Provides:  ros2-noetic-nodelet_topic_tools = 1.10.2-1
Obsoletes: ros2-noetic-nodelet_topic_tools < 1.10.2-1
...
Requires:       ros2-noetic-nodelet-devel
Requires:       ros2-noetic-pluginlib-devel
Requires:       ros2-noetic-roscpp-devel
Requires:       boost-devel
Requires:       ros2-noetic-ament_package-devel
Requires:       ros2-noetic-dynamic_reconfigure-devel

Provides: ros2-noetic-nodelet_topic_tools-devel = 1.10.2-1
Obsoletes: ros2-noetic-nodelet_topic_tools-devel < 1.10.2-1
...
colcon \
  ...
  --packages-select nodelet_topic_tools
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nodelet_topic_tools/include/,share/nodelet_topic_tools/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.10.2-1
