Name:           ros2-humble-orocos-kdl-devel
Version:        0.2.5
Release:        1%{?dist}
Summary:        ROS package orocos-kdl-devel

License:        Apache License 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/orocos-kdl-devel-release/archive/release/humble/orocos-kdl-devel/0.2.5-1.tar.gz#/ros2-humble-orocos-kdl-devel-0.2.5-source0.tar.gz
...
Provides:  ros2-humble-orocos-kdl-devel = 0.2.5-1
Obsoletes: ros2-humble-orocos-kdl-devel < 0.2.5-1
...
Provides: ros2-humble-orocos-kdl-devel-devel = 0.2.5-1
Obsoletes: ros2-humble-orocos-kdl-devel-devel < 0.2.5-1
...
CXXFLAGS="${CXXFLAGS:-%optflags} -Wno-all" ; export CXXFLAGS ; \
FFLAGS="${FFLAGS:-%optflags%{?_fmoddir: -I%_fmoddir}}i -Wno-all" ; export FFLAGS ; \
...
colcon \
  ...
  --packages-select orocos-kdl-devel
...
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,orocos-kdl-devel/include/,share/orocos-kdl-devel/cmake} \
...
%changelog
* Thu Apr 25 2024 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - humble.0.2.5-1
