Name:           ros2-humble-pcl_conversions
Version:        2.4.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/perception_pcl-release/archive/release/humble/pcl_conversions/2.4.0-6.tar.gz#/ros2-humble-pcl_conversions-2.4.0-source0.tar.gz
...
colcon \
  ...
  --packages-select pcl_conversions
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/pcl_conversions ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/pcl_conversions
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/include/* %{buildroot}/%{_libdir}/ros2-humble/include/pcl_conversions/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/pcl_conversions ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/pcl_conversions
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/share/* %{buildroot}/%{_libdir}/ros2-humble/share/pcl_conversions/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/pcl_conversions/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/pcl_conversions \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,pcl_conversions/include/,share/pcl_conversions/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/pcl_conversions/{lib*/pkgconfig,include/,cmake/,pcl_conversions/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pcl_conversions/{lib*/pkgconfig,include/,cmake/,pcl_conversions/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/pcl_conversions/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
