Name:           ros2-humble-pilz_industrial_motion_planner
Version:        2.5.5
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/humble/pilz_industrial_motion_planner/2.5.5-1.tar.gz#/ros2-humble-pilz_industrial_motion_planner-2.5.5-source0.tar.gz
...
BuildRequires:  ros2-humble-tf2_eigen_kdl-devel
...
Provides:  ros2-humble-pilz_industrial_motion_planner = 2.5.5-1
Obsoletes: ros2-humble-pilz_industrial_motion_planner < 2.5.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/pilz_industrial_motion_planner ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/pilz_industrial_motion_planner
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/include/* %{buildroot}/%{_libdir}/ros2-humble/include/pilz_industrial_motion_planner/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/pilz_industrial_motion_planner ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/pilz_industrial_motion_planner
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/share/* %{buildroot}/%{_libdir}/ros2-humble/share/pilz_industrial_motion_planner/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/pilz_industrial_motion_planner/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/pilz_industrial_motion_planner \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,share/pilz_industrial_motion_planner/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/pilz_industrial_motion_planner/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/pilz_industrial_motion_planner/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/pilz_industrial_motion_planner/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
