...
Source0:        https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui/2.2.3-2.tar.gz#/ros2-humble-qt_gui-2.2.3-source0.tar.gz
...
Provides:  ros2-humble-qt_gui = 2.2.3-1
Obsoletes: ros2-humble-qt_gui < 2.2.3-1
...
Provides: ros2-humble-qt_gui-devel = 2.2.3-1
Obsoletes: ros2-humble-qt_gui-devel < 2.2.3-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/qt_gui ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/qt_gui
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/include/* %{buildroot}/%{_libdir}/ros2-humble/include/qt_gui/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/qt_gui/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/qt_gui/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/qt_gui/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/qt_gui/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/qt_gui ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/qt_gui
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/qt_gui/share/* %{buildroot}/%{_libdir}/ros2-humble/share/qt_gui/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/qt_gui/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/qt_gui/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/qt_gui/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/qt_gui/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/qt_gui \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,qt_gui/include/,share/qt_gui/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/qt_gui/{lib*/pkgconfig,include/,cmake/,qt_gui/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/qt_gui/{lib*/pkgconfig,include/,cmake/,qt_gui/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/qt_gui/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
