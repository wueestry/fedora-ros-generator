...
Source0:        https://github.com/ros-gbp/qwt_dependency-release/archive/release/noetic/qwt_dependency/1.1.1-2.tar.gz#/ros2-noetic-qwt_dependency-1.1.1-source0.tar.gz
...
Provides:  ros2-noetic-qwt_dependency = 1.1.1-1
Obsoletes: ros2-noetic-qwt_dependency < 1.1.1-1
...
Provides: ros2-noetic-qwt_dependency-devel = 1.1.1-1
Obsoletes: ros2-noetic-qwt_dependency-devel < 1.1.1-1
...
colcon \
  ...
  --packages-select qwt_dependency
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,qwt_dependency/include/,share/qwt_dependency/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.1.1-1
