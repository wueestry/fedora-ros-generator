...
Source0:        https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl/5.3.9-1.tar.gz#/ros2-humble-rcl-5.3.9-source0.tar.gz
...
Provides:  ros2-humble-rcl = 5.3.9-1
Obsoletes: ros2-humble-rcl < 5.3.9-1
...
Provides: ros2-humble-rcl-devel = 5.3.9-1
Obsoletes: ros2-humble-rcl-devel < 5.3.9-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rcl ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rcl
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rcl/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rcl/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rcl/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rcl/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rcl/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rcl ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rcl
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rcl/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rcl/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rcl/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rcl/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rcl/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rcl/include/,share/rcl/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rcl/{lib*/pkgconfig,include/,cmake/,rcl/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl/{lib*/pkgconfig,include/,cmake/,rcl/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
