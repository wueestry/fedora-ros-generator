Name:           ros2-humble-rcl_interfaces
Version:        1.2.1
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/humble/rcl_interfaces/1.2.1-1.tar.gz#/ros2-humble-rcl_interfaces-1.2.1-source0.tar.gz
...
Provides:  ros2-humble-rcl_interfaces = 1.2.1-1
Obsoletes: ros2-humble-rcl_interfaces < 1.2.1-1
...
Provides: ros2-humble-rcl_interfaces-devel = 1.2.1-1
Obsoletes: ros2-humble-rcl_interfaces-devel < 1.2.1-1
...
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rcl_interfaces/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rcl_interfaces ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rcl_interfaces
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rcl_interfaces/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_interfaces/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_interfaces \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rcl_interfaces/{lib*/pkgconfig,include/,cmake/,rcl_interfaces/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_interfaces/{lib*/pkgconfig,include/,cmake/,rcl_interfaces/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_interfaces/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
