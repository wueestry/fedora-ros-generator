...
Source0:        https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl_lifecycle/5.3.9-1.tar.gz#/ros2-humble-rcl_lifecycle-5.3.9-source0.tar.gz
...
Provides:  ros2-humble-rcl_lifecycle = 5.3.9-1
Obsoletes: ros2-humble-rcl_lifecycle < 5.3.9-1
...
Provides: ros2-humble-rcl_lifecycle-devel = 5.3.9-1
Obsoletes: ros2-humble-rcl_lifecycle-devel < 5.3.9-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rcl_lifecycle ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rcl_lifecycle
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rcl_lifecycle/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rcl_lifecycle ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rcl_lifecycle
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rcl_lifecycle/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_lifecycle/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_lifecycle \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rcl_lifecycle/include/,share/rcl_lifecycle/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rcl_lifecycle/{lib*/pkgconfig,include/,cmake/,rcl_lifecycle/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rcl_lifecycle/{lib*/pkgconfig,include/,cmake/,rcl_lifecycle/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rcl_lifecycle/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
