...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.10-1.tar.gz#/ros2-humble-rclcpp-16.0.10-source0.tar.gz
...
BuildRequires:  ros2-humble-libstatistics_collector-devel
...
Provides:  ros2-humble-rclcpp = 16.0.10-1
Obsoletes: ros2-humble-rclcpp < 16.0.10-1
...
Provides: ros2-humble-rclcpp-devel = 16.0.10-1
Obsoletes: ros2-humble-rclcpp-devel < 16.0.10-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rclcpp/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rclcpp/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rclcpp/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rclcpp/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rclcpp/include/,share/rclcpp/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp/{lib*/pkgconfig,include/,cmake/,rclcpp/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp/{lib*/pkgconfig,include/,cmake/,rclcpp/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
