...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.10-1.tar.gz#/ros2-humble-rclcpp_action-16.0.10-source0.tar.gz
...
Provides:  ros2-humble-rclcpp_action = 16.0.10-1
Obsoletes: ros2-humble-rclcpp_action < 16.0.10-1
...
Provides: ros2-humble-rclcpp_action-devel = 16.0.10-1
Obsoletes: ros2-humble-rclcpp_action-devel < 16.0.10-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_action ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_action
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_action/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_action ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_action
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_action/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_action/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_action \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rclcpp_action/include/,share/rclcpp_action/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_action/{lib*/pkgconfig,include/,cmake/,rclcpp_action/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_action/{lib*/pkgconfig,include/,cmake/,rclcpp_action/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_action/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
