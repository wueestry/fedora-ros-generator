...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_components/16.0.10-1.tar.gz#/ros2-humble-rclcpp_components-16.0.10-source0.tar.gz
...
Provides:  ros2-humble-rclcpp_components = 16.0.10-1
Obsoletes: ros2-humble-rclcpp_components < 16.0.10-1
...
Provides: ros2-humble-rclcpp_components-devel = 16.0.10-1
Obsoletes: ros2-humble-rclcpp_components-devel < 16.0.10-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_components ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_components
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rclcpp_components/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_components ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_components
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rclcpp_components/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_components/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_components \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rclcpp_components/include/,share/rclcpp_components/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rclcpp_components/{lib*/pkgconfig,include/,cmake/,rclcpp_components/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclcpp_components/{lib*/pkgconfig,include/,cmake/,rclcpp_components/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclcpp_components/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
