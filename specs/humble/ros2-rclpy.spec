...
Source0:        https://github.com/ros2-gbp/rclpy-release/archive/release/humble/rclpy/3.3.14-1.tar.gz#/ros2-humble-rclpy-3.3.14-source0.tar.gz
...
Provides:  ros2-humble-rclpy = 3.3.14-1
Obsoletes: ros2-humble-rclpy < 3.3.14-1
...
Provides: ros2-humble-rclpy-devel = 3.3.14-1
Obsoletes: ros2-humble-rclpy-devel < 3.3.14-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rclpy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rclpy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rclpy/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rclpy/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rclpy/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rclpy/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rclpy/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rclpy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rclpy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rclpy/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rclpy/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rclpy/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclpy/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rclpy/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rclpy/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclpy \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rclpy/include/,share/rclpy/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rclpy/{lib*/pkgconfig,include/,cmake/,rclpy/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rclpy/{lib*/pkgconfig,include/,cmake/,rclpy/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rclpy/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
