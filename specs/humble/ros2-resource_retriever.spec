Name:           ros2-humble-resource_retriever
Version:        3.1.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/resource_retriever-release/archive/release/humble/resource_retriever/3.1.2-1.tar.gz#/ros2-humble-resource_retriever-3.1.2-source0.tar.gz
...
Provides:  ros2-humble-resource_retriever = 3.1.2-1
Obsoletes: ros2-humble-resource_retriever < 3.1.2-1
...
Provides: ros2-humble-resource_retriever-devel = 3.1.2-1
Obsoletes: ros2-humble-resource_retriever-devel < 3.1.2-1
...
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/include/* %{buildroot}/%{_libdir}/ros2-humble/include/resource_retriever/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/resource_retriever ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/resource_retriever
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/share/* %{buildroot}/%{_libdir}/ros2-humble/share/resource_retriever/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/resource_retriever/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/resource_retriever \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/resource_retriever/{lib*/pkgconfig,include/,cmake/,resource_retriever/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/resource_retriever/{lib*/pkgconfig,include/,cmake/,resource_retriever/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/resource_retriever/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
