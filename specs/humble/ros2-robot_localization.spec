Name:           ros2-humble-robot_localization
Version:        3.5.3
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/robot_localization-release/archive/release/humble/robot_localization/3.5.3-1.tar.gz#/ros2-humble-robot_localization-3.5.3-source0.tar.gz
...
BuildRequires:  ros2-humble-geographic_msgs-devel
...
Provides:  ros2-humble-robot_localization = 3.5.3-1
Obsoletes: ros2-humble-robot_localization < 3.5.3-1
...
Provides: ros2-humble-robot_localization-devel = 3.5.3-1
Obsoletes: ros2-humble-robot_localization-devel < 3.5.3-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/robot_localization ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/robot_localization
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/include/* %{buildroot}/%{_libdir}/ros2-humble/include/robot_localization/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/robot_localization/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/robot_localization/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/robot_localization/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/robot_localization/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/robot_localization ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/robot_localization
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/robot_localization/share/* %{buildroot}/%{_libdir}/ros2-humble/share/robot_localization/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/robot_localization/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/robot_localization/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/robot_localization/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/robot_localization/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/robot_localization \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,robot_localization/include/,share/robot_localization/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/robot_localization/{lib*/pkgconfig,include/,cmake/,robot_localization/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/robot_localization/{lib*/pkgconfig,include/,cmake/,robot_localization/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/robot_localization/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
