...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/ros2_controllers/2.37.0-1.tar.gz#/ros2-humble-ros2_controllers-2.37.0-source0.tar.gz
...
Requires:       ros2-humble-ackermann_steering_controller
...
Requires:       ros2-humble-effort_controllers
...
Requires:       ros2-humble-tricycle_controller
Requires:       ros2-humble-tricycle_steering_controller
Requires:       ros2-humble-velocity_controllers

Provides:  ros2-humble-ros2_controllers = 2.37.0-1
Obsoletes: ros2-humble-ros2_controllers < 2.37.0-1
...
Requires:       ros2-humble-ackermann_steering_controller-devel
...
Requires:       ros2-humble-effort_controllers-devel
...
Requires:       ros2-humble-tricycle_controller-devel
Requires:       ros2-humble-tricycle_steering_controller-devel
Requires:       ros2-humble-velocity_controllers-devel

Provides: ros2-humble-ros2_controllers-devel = 2.37.0-1
Obsoletes: ros2-humble-ros2_controllers-devel < 2.37.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros2_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros2_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros2_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2_controllers/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2_controllers \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2_controllers/include/,share/ros2_controllers/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros2_controllers/{lib*/pkgconfig,include/,cmake/,ros2_controllers/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2_controllers/{lib*/pkgconfig,include/,cmake/,ros2_controllers/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2_controllers/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
