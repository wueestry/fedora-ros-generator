...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/ros2bag/0.15.12-1.tar.gz#/ros2-humble-ros2bag-0.15.12-source0.tar.gz
...
Provides:  ros2-humble-ros2bag = 0.15.12-1
Obsoletes: ros2-humble-ros2bag < 0.15.12-1
...
Provides: ros2-humble-ros2bag-devel = 0.15.12-1
Obsoletes: ros2-humble-ros2bag-devel < 0.15.12-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2bag ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2bag
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2bag/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros2bag/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros2bag/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros2bag/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros2bag/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros2bag ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros2bag
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros2bag/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros2bag/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros2bag/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2bag/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros2bag/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros2bag/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2bag \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2bag/include/,share/ros2bag/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros2bag/{lib*/pkgconfig,include/,cmake/,ros2bag/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2bag/{lib*/pkgconfig,include/,cmake/,ros2bag/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2bag/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
