Name:           ros2-humble-ros2component
Version:        0.18.11
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2component/0.18.11-1.tar.gz#/ros2-humble-ros2component-0.18.11-source0.tar.gz
...
Provides:  ros2-humble-ros2component = 0.18.11-1
Obsoletes: ros2-humble-ros2component < 0.18.11-1
...
Provides: ros2-humble-ros2component-devel = 0.18.11-1
Obsoletes: ros2-humble-ros2component-devel < 0.18.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2component ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2component
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2component/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros2component/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros2component/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros2component/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros2component/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros2component ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros2component
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros2component/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros2component/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros2component/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2component/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros2component/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros2component/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2component \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2component/include/,share/ros2component/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros2component/{lib*/pkgconfig,include/,cmake/,ros2component/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2component/{lib*/pkgconfig,include/,cmake/,ros2component/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2component/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
