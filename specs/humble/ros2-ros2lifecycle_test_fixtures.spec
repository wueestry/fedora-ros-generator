Name:           ros2-humble-ros2lifecycle_test_fixtures
Version:        0.18.10
Release:        1%{?dist}
Summary:        ROS package ros2lifecycle_test_fixtures

License:        Apache License 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle_test_fixtures/0.18.10-1.tar.gz#/ros2-humble-ros2lifecycle_test_fixtures-0.18.10-source0.tar.gz
...
Provides:  ros2-humble-ros2lifecycle_test_fixtures = 0.18.10-1
Obsoletes: ros2-humble-ros2lifecycle_test_fixtures < 0.18.10-1
...
Provides: ros2-humble-ros2lifecycle_test_fixtures-devel = 0.18.10-1
Obsoletes: ros2-humble-ros2lifecycle_test_fixtures-devel < 0.18.10-1
...
colcon \
  ...
  --packages-select ros2lifecycle_test_fixtures
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2lifecycle_test_fixtures ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2lifecycle_test_fixtures
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2lifecycle_test_fixtures
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/share %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/share -type f -exec sed -i "s:opt/ros2lifecycle_test_fixtures/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/bin %{buildroot}/%{_libdir}/ros2-humble/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/extra_cmake %{buildroot}/%{_libdir}/ros2-humble/
#     find %{buildroot}/%{_libdir}/ros2-humble/extra_cmake -type f -exec sed -i "s:opt/ros2lifecycle_test_fixtures/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/lib %{buildroot}/%{_libdir}/ros2-humble/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-humble/opt/ros2lifecycle_test_fixtures/lib64 %{buildroot}/%{_libdir}/ros2-humble/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2lifecycle_test_fixtures/include/,share/ros2lifecycle_test_fixtures/cmake} \
