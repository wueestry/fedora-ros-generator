...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.11-1.tar.gz#/ros2-humble-ros2param-0.18.11-source0.tar.gz
...
Provides:  ros2-humble-ros2param = 0.18.11-1
Obsoletes: ros2-humble-ros2param < 0.18.11-1
...
Provides: ros2-humble-ros2param-devel = 0.18.11-1
Obsoletes: ros2-humble-ros2param-devel < 0.18.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2param ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2param
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2param/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros2param/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros2param/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros2param/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros2param/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros2param ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros2param
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros2param/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros2param/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros2param/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2param/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros2param/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros2param/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2param \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2param/include/,share/ros2param/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros2param/{lib*/pkgconfig,include/,cmake/,ros2param/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2param/{lib*/pkgconfig,include/,cmake/,ros2param/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2param/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
