Name:           ros2-humble-ros2pkg
Version:        0.18.11
Release:        1%{?dist}
Summary:        ROS package ros2pkg

License:        Apache License 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2pkg/0.18.11-1.tar.gz#/ros2-humble-ros2pkg-0.18.11-source0.tar.gz
...
Requires:       ros2-humble-ament_copyright
Requires:       ros2-humble-ament_index_python
Requires:       ros2-humble-ros2cli

Provides:  ros2-humble-ros2pkg = 0.18.11-1
Obsoletes: ros2-humble-ros2pkg < 0.18.11-1
...
Provides: ros2-humble-ros2pkg-devel = 0.18.11-1
Obsoletes: ros2-humble-ros2pkg-devel < 0.18.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros2pkg ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros2pkg
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros2pkg/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros2pkg ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros2pkg
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros2pkg/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2pkg/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2pkg \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros2pkg/include/,share/ros2pkg/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros2pkg/{lib*/pkgconfig,include/,cmake/,ros2pkg/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros2pkg/{lib*/pkgconfig,include/,cmake/,ros2pkg/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros2pkg/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
