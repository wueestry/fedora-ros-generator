...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2run/0.18.9-1.tar.gz#/ros2-humble-ros2run-0.18.9-source0.tar.gz
...
Provides:  ros2-humble-ros2run = 0.18.9-1
Obsoletes: ros2-humble-ros2run < 0.18.9-1
...
Provides: ros2-humble-ros2run-devel = 0.18.9-1
Obsoletes: ros2-humble-ros2run-devel < 0.18.9-1
