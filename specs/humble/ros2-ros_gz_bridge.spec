Name:           ros2-humble-ros_gz_bridge
Version:        0.244.15
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_bridge/0.244.15-1.tar.gz#/ros2-humble-ros_gz_bridge-0.244.15-source0.tar.gz
...
BuildRequires:  ros2-humble-actuator_msgs-devel
BuildRequires:  ros2-humble-ament_cmake-devel
BuildRequires:  ros2-humble-ament_package-devel
BuildRequires:  ros2-humble-geometry_msgs-devel
BuildRequires:  ros2-humble-gps_msgs-devel
...
Provides:  ros2-humble-ros_gz_bridge = 0.244.15-1
Obsoletes: ros2-humble-ros_gz_bridge < 0.244.15-1
...
Provides: ros2-humble-ros_gz_bridge-devel = 0.244.15-1
Obsoletes: ros2-humble-ros_gz_bridge-devel < 0.244.15-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/ros_gz_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/ros_gz_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/include/* %{buildroot}/%{_libdir}/ros2-humble/include/ros_gz_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/ros_gz_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/ros_gz_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/share/* %{buildroot}/%{_libdir}/ros2-humble/share/ros_gz_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros_gz_bridge/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros_gz_bridge \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,ros_gz_bridge/include/,share/ros_gz_bridge/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/ros_gz_bridge/{lib*/pkgconfig,include/,cmake/,ros_gz_bridge/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/ros_gz_bridge/{lib*/pkgconfig,include/,cmake/,ros_gz_bridge/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/ros_gz_bridge/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
