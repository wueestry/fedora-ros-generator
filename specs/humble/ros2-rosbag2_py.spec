...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_py/0.15.12-1.tar.gz#/ros2-humble-rosbag2_py-0.15.12-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_py = 0.15.12-1
Obsoletes: ros2-humble-rosbag2_py < 0.15.12-1
...
Provides: ros2-humble-rosbag2_py-devel = 0.15.12-1
Obsoletes: ros2-humble-rosbag2_py-devel < 0.15.12-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_py ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_py
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_py/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_py ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_py
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_py/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_py/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_py \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rosbag2_py/include/,share/rosbag2_py/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_py/{lib*/pkgconfig,include/,cmake/,rosbag2_py/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_py/{lib*/pkgconfig,include/,cmake/,rosbag2_py/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_py/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
