Name:           ros2-humble-rosbag2_transport
Version:        0.15.12
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_transport/0.15.12-1.tar.gz#/ros2-humble-rosbag2_transport-0.15.12-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_transport = 0.15.12-1
Obsoletes: ros2-humble-rosbag2_transport < 0.15.12-1
...
Provides: ros2-humble-rosbag2_transport-devel = 0.15.12-1
Obsoletes: ros2-humble-rosbag2_transport-devel < 0.15.12-1
...
colcon \
  ...
  --packages-select rosbag2_transport
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_transport ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_transport
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rosbag2_transport/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_transport ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_transport
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rosbag2_transport/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_transport/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_transport \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rosbag2_transport/include/,share/rosbag2_transport/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rosbag2_transport/{lib*/pkgconfig,include/,cmake/,rosbag2_transport/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosbag2_transport/{lib*/pkgconfig,include/,cmake/,rosbag2_transport/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosbag2_transport/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
