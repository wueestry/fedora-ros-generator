...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag_storage/1.16.0-1.tar.gz#/ros2-noetic-rosbag_storage-1.16.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-roscpp_traits-devel
BuildRequires:  ros2-noetic-roslz4-devel
BuildRequires:  ros2-noetic-rostest-devel
BuildRequires:  ros2-noetic-rostime-devel
BuildRequires:  ros2-noetic-std_msgs-devel

Requires:       ros2-noetic-cpp_common
Requires:       ros2-noetic-pluginlib
Requires:       ros2-noetic-roscpp_serialization
Requires:       ros2-noetic-roscpp_traits
Requires:       ros2-noetic-roslz4
Requires:       ros2-noetic-rostime

Provides:  ros2-noetic-rosbag_storage = 1.16.0-1
Obsoletes: ros2-noetic-rosbag_storage < 1.16.0-1
...
Requires:       ros2-noetic-roscpp_traits-devel
Requires:       ros2-noetic-roslz4-devel
Requires:       ros2-noetic-rostest-devel
Requires:       ros2-noetic-rostime-devel
Requires:       ros2-noetic-std_msgs-devel

Provides: ros2-noetic-rosbag_storage-devel = 1.16.0-1
Obsoletes: ros2-noetic-rosbag_storage-devel < 1.16.0-1
...
colcon \
  ...
  --packages-select rosbag_storage
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag_storage/include/,share/rosbag_storage/cmake} \
