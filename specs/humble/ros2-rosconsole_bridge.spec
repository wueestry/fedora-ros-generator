...
Source0:        https://github.com/ros-gbp/rosconsole_bridge-release/archive/release/noetic/rosconsole_bridge/0.5.4-1.tar.gz#/ros2-noetic-rosconsole_bridge-0.5.4-source0.tar.gz
...
Provides:  ros2-noetic-rosconsole_bridge = 0.5.4-1
Obsoletes: ros2-noetic-rosconsole_bridge < 0.5.4-1
...
Provides: ros2-noetic-rosconsole_bridge-devel = 0.5.4-1
Obsoletes: ros2-noetic-rosconsole_bridge-devel < 0.5.4-1
...
colcon \
  ...
  --packages-select rosconsole_bridge
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosconsole_bridge/include/,share/rosconsole_bridge/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.5.4-1
