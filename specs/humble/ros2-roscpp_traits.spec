...
Source0:        https://github.com/ros-gbp/roscpp_core-release/archive/release/noetic/roscpp_traits/0.7.2-1.tar.gz#/ros2-noetic-roscpp_traits-0.7.2-source0.tar.gz
...
Provides:  ros2-noetic-roscpp_traits = 0.7.2-1
Obsoletes: ros2-noetic-roscpp_traits < 0.7.2-1
...
Provides: ros2-noetic-roscpp_traits-devel = 0.7.2-1
Obsoletes: ros2-noetic-roscpp_traits-devel < 0.7.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roscpp_traits/include/,share/roscpp_traits/cmake} \
