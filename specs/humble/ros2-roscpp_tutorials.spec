...
Source0:        https://github.com/ros-gbp/ros_tutorials-release/archive/release/noetic/roscpp_tutorials/0.10.2-1.tar.gz#/ros2-noetic-roscpp_tutorials-0.10.2-source0.tar.gz
...
Provides:  ros2-noetic-roscpp_tutorials = 0.10.2-1
Obsoletes: ros2-noetic-roscpp_tutorials < 0.10.2-1
...
Provides: ros2-noetic-roscpp_tutorials-devel = 0.10.2-1
Obsoletes: ros2-noetic-roscpp_tutorials-devel < 0.10.2-1
...
colcon \
  ...
  --packages-select roscpp_tutorials
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roscpp_tutorials/include/,share/roscpp_tutorials/cmake} \
