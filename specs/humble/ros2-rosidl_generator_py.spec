Name:           ros2-humble-rosidl_generator_py
Version:        0.14.4
Release:        1%{?dist}
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rosidl_generator_py ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rosidl_generator_py
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rosidl_generator_py/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rosidl_generator_py ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rosidl_generator_py
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rosidl_generator_py/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosidl_generator_py/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosidl_generator_py \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rosidl_generator_py/include/,share/rosidl_generator_py/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rosidl_generator_py/{lib*/pkgconfig,include/,cmake/,rosidl_generator_py/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rosidl_generator_py/{lib*/pkgconfig,include/,cmake/,rosidl_generator_py/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rosidl_generator_py/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
