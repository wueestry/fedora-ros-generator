...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/roslib/1.15.8-1.tar.gz#/ros2-noetic-roslib-1.15.8-source0.tar.gz
...
BuildRequires:  ros2-noetic-rosmake-devel
BuildRequires:  ros2-noetic-rospack-devel
...
Provides:  ros2-noetic-roslib = 1.15.8-1
Obsoletes: ros2-noetic-roslib < 1.15.8-1
...
Provides: ros2-noetic-roslib-devel = 1.15.8-1
Obsoletes: ros2-noetic-roslib-devel < 1.15.8-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roslib/include/,share/roslib/cmake} \
