...
Source0:        https://github.com/ros-gbp/roslint-release/archive/release/noetic/roslint/0.12.0-1.tar.gz#/ros2-noetic-roslint-0.12.0-source0.tar.gz
...
Provides:  ros2-noetic-roslint = 0.12.0-1
Obsoletes: ros2-noetic-roslint < 0.12.0-1
...
Provides: ros2-noetic-roslint-devel = 0.12.0-1
Obsoletes: ros2-noetic-roslint-devel < 0.12.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roslint/include/,share/roslint/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.12.0-1
