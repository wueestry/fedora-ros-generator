...
Source0:        https://github.com/ros-gbp/roslisp-release/archive/release/noetic/roslisp/1.9.25-1.tar.gz#/ros2-noetic-roslisp-1.9.25-source0.tar.gz
...
Requires:       sbcl
Requires:       ros2-noetic-ros_environment
Requires:       ros2-noetic-rosgraph_msgs
Requires:       ros2-noetic-roslang
Requires:       ros2-noetic-rospack
Requires:       ros2-noetic-std_srvs

Provides:  ros2-noetic-roslisp = 1.9.25-1
Obsoletes: ros2-noetic-roslisp < 1.9.25-1
...
Requires:       ros2-noetic-ros_environment-devel
Requires:       ros2-noetic-rosgraph_msgs-devel
Requires:       ros2-noetic-roslang-devel
Requires:       ros2-noetic-rospack-devel
Requires:       ros2-noetic-std_srvs-devel

Provides: ros2-noetic-roslisp-devel = 1.9.25-1
Obsoletes: ros2-noetic-roslisp-devel < 1.9.25-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roslisp/include/,share/roslisp/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.9.25-1
