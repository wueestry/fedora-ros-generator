...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosmaster/1.16.0-1.tar.gz#/ros2-noetic-rosmaster-1.16.0-source0.tar.gz
...
Provides:  ros2-noetic-rosmaster = 1.16.0-1
Obsoletes: ros2-noetic-rosmaster < 1.16.0-1
...
Provides: ros2-noetic-rosmaster-devel = 1.16.0-1
Obsoletes: ros2-noetic-rosmaster-devel < 1.16.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosmaster/include/,share/rosmaster/cmake} \
