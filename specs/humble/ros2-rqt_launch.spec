...
Source0:        https://github.com/ros-gbp/rqt_launch-release/archive/release/noetic/rqt_launch/0.4.9-1.tar.gz#/ros2-noetic-rqt_launch-0.4.9-source0.tar.gz
...
BuildRequires:  ros2-noetic-rqt_py_common-devel
...
Provides:  ros2-noetic-rqt_launch = 0.4.9-1
Obsoletes: ros2-noetic-rqt_launch < 0.4.9-1
...
Provides: ros2-noetic-rqt_launch-devel = 0.4.9-1
Obsoletes: ros2-noetic-rqt_launch-devel < 0.4.9-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_launch/include/,share/rqt_launch/cmake} \
