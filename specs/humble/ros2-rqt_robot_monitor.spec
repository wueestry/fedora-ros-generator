...
Source0:        https://github.com/ros-gbp/rqt_robot_monitor-release/archive/release/noetic/rqt_robot_monitor/0.5.14-1.tar.gz#/ros2-noetic-rqt_robot_monitor-0.5.14-source0.tar.gz
...
Requires:       ros2-noetic-qt_gui_py_common
Requires:       ros2-noetic-rospy
Requires:       ros2-noetic-rqt_bag
Requires:       ros2-noetic-rqt_gui
Requires:       ros2-noetic-rqt_gui_py
Requires:       ros2-noetic-rqt_py_common

Provides:  ros2-noetic-rqt_robot_monitor = 0.5.14-1
Obsoletes: ros2-noetic-rqt_robot_monitor < 0.5.14-1
...
Requires:       ros2-noetic-qt_gui_py_common-devel
Requires:       ros2-noetic-rospy-devel
Requires:       ros2-noetic-rqt_bag-devel
Requires:       ros2-noetic-rqt_gui-devel
Requires:       ros2-noetic-rqt_gui_py-devel
Requires:       ros2-noetic-rqt_py_common-devel

Provides: ros2-noetic-rqt_robot_monitor-devel = 0.5.14-1
Obsoletes: ros2-noetic-rqt_robot_monitor-devel < 0.5.14-1
...
colcon \
  ...
  --packages-select rqt_robot_monitor
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_robot_monitor/include/,share/rqt_robot_monitor/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.5.14-1
