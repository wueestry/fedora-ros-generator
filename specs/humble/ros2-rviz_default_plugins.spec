...
Source0:        https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_default_plugins/11.2.13-1.tar.gz#/ros2-humble-rviz_default_plugins-11.2.13-source0.tar.gz
...
BuildRequires:  ros2-humble-ignition_math6_vendor-devel
BuildRequires:  ros2-humble-image_transport-devel
BuildRequires:  ros2-humble-interactive_markers-devel
BuildRequires:  ros2-humble-laser_geometry-devel
BuildRequires:  ros2-humble-map_msgs-devel
...
Provides:  ros2-humble-rviz_default_plugins = 11.2.13-1
Obsoletes: ros2-humble-rviz_default_plugins < 11.2.13-1
...
Provides: ros2-humble-rviz_default_plugins-devel = 11.2.13-1
Obsoletes: ros2-humble-rviz_default_plugins-devel < 11.2.13-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/rviz_default_plugins ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/rviz_default_plugins
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/include/* %{buildroot}/%{_libdir}/ros2-humble/include/rviz_default_plugins/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/rviz_default_plugins ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/rviz_default_plugins
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/share/* %{buildroot}/%{_libdir}/ros2-humble/share/rviz_default_plugins/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/rviz_default_plugins/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rviz_default_plugins \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,rviz_default_plugins/include/,share/rviz_default_plugins/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/rviz_default_plugins/{lib*/pkgconfig,include/,cmake/,rviz_default_plugins/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/rviz_default_plugins/{lib*/pkgconfig,include/,cmake/,rviz_default_plugins/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/rviz_default_plugins/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
