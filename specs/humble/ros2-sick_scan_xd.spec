...
Source0:        https://github.com/ros2-gbp/sick_scan_xd-release/archive/release/humble/sick_scan_xd/3.5.0-1.tar.gz#/ros2-humble-sick_scan_xd-3.5.0-source0.tar.gz
...
Provides:  ros2-humble-sick_scan_xd = 3.5.0-1
Obsoletes: ros2-humble-sick_scan_xd < 3.5.0-1
...
Provides: ros2-humble-sick_scan_xd-devel = 3.5.0-1
Obsoletes: ros2-humble-sick_scan_xd-devel < 3.5.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/sick_scan_xd ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/sick_scan_xd
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/include/* %{buildroot}/%{_libdir}/ros2-humble/include/sick_scan_xd/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/sick_scan_xd ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/sick_scan_xd
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/share/* %{buildroot}/%{_libdir}/ros2-humble/share/sick_scan_xd/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/sick_scan_xd/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/sick_scan_xd \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,sick_scan_xd/include/,share/sick_scan_xd/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/sick_scan_xd/{lib*/pkgconfig,include/,cmake/,sick_scan_xd/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/sick_scan_xd/{lib*/pkgconfig,include/,cmake/,sick_scan_xd/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/sick_scan_xd/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
