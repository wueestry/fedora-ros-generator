...
Source0:        https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/smach/2.5.1-1.tar.gz#/ros2-noetic-smach-2.5.1-source0.tar.gz
...
Provides:  ros2-noetic-smach = 2.5.1-1
Obsoletes: ros2-noetic-smach < 2.5.1-1
...
Provides: ros2-noetic-smach-devel = 2.5.1-1
Obsoletes: ros2-noetic-smach-devel < 2.5.1-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,smach/include/,share/smach/cmake} \
