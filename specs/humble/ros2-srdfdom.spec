...
Source0:        https://github.com/ros2-gbp/srdfdom-release/archive/release/humble/srdfdom/2.0.4-1.tar.gz#/ros2-humble-srdfdom-2.0.4-source0.tar.gz
...
Provides:  ros2-humble-srdfdom = 2.0.4-1
Obsoletes: ros2-humble-srdfdom < 2.0.4-1
...
Provides: ros2-humble-srdfdom-devel = 2.0.4-1
Obsoletes: ros2-humble-srdfdom-devel < 2.0.4-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/srdfdom ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/srdfdom
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/include/* %{buildroot}/%{_libdir}/ros2-humble/include/srdfdom/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/srdfdom/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/srdfdom/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/srdfdom/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/srdfdom/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/srdfdom ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/srdfdom
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/srdfdom/share/* %{buildroot}/%{_libdir}/ros2-humble/share/srdfdom/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/srdfdom/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/srdfdom/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/srdfdom/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/srdfdom/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/srdfdom \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,srdfdom/include/,share/srdfdom/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/srdfdom/{lib*/pkgconfig,include/,cmake/,srdfdom/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/srdfdom/{lib*/pkgconfig,include/,cmake/,srdfdom/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/srdfdom/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
