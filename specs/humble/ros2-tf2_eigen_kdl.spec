...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_eigen_kdl/0.25.7-1.tar.gz#/ros2-humble-tf2_eigen_kdl-0.25.7-source0.tar.gz
...
Provides:  ros2-humble-tf2_eigen_kdl = 0.25.7-1
Obsoletes: ros2-humble-tf2_eigen_kdl < 0.25.7-1
...
Provides: ros2-humble-tf2_eigen_kdl-devel = 0.25.7-1
Obsoletes: ros2-humble-tf2_eigen_kdl-devel < 0.25.7-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/tf2_eigen_kdl ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/tf2_eigen_kdl
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/include/* %{buildroot}/%{_libdir}/ros2-humble/include/tf2_eigen_kdl/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/tf2_eigen_kdl ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/tf2_eigen_kdl
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/share/* %{buildroot}/%{_libdir}/ros2-humble/share/tf2_eigen_kdl/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_eigen_kdl/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_eigen_kdl \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/tf2_eigen_kdl/{lib*/pkgconfig,include/,cmake/,tf2_eigen_kdl/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_eigen_kdl/{lib*/pkgconfig,include/,cmake/,tf2_eigen_kdl/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_eigen_kdl/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
