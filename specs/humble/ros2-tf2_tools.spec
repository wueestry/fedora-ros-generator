...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_tools/0.25.7-1.tar.gz#/ros2-humble-tf2_tools-0.25.7-source0.tar.gz
...
Provides:  ros2-humble-tf2_tools = 0.25.7-1
Obsoletes: ros2-humble-tf2_tools < 0.25.7-1
...
Provides: ros2-humble-tf2_tools-devel = 0.25.7-1
Obsoletes: ros2-humble-tf2_tools-devel < 0.25.7-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/tf2_tools ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/tf2_tools
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/include/* %{buildroot}/%{_libdir}/ros2-humble/include/tf2_tools/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/tf2_tools ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/tf2_tools
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/share/* %{buildroot}/%{_libdir}/ros2-humble/share/tf2_tools/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_tools/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_tools \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,tf2_tools/include/,share/tf2_tools/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/tf2_tools/{lib*/pkgconfig,include/,cmake/,tf2_tools/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/tf2_tools/{lib*/pkgconfig,include/,cmake/,tf2_tools/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/tf2_tools/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
