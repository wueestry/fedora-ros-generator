...
Source0:        https://github.com/ros-gbp/common_tutorials-release/archive/release/noetic/turtle_actionlib/0.2.0-1.tar.gz#/ros2-noetic-turtle_actionlib-0.2.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-actionlib-devel
BuildRequires:  ros2-noetic-actionlib_msgs-devel
BuildRequires:  ros2-noetic-ament_package-devel
BuildRequires:  ros2-noetic-angles-devel
...
BuildRequires:  ros2-noetic-turtlesim-devel

Requires:       ros2-noetic-actionlib
Requires:       ros2-noetic-actionlib_msgs
Requires:       ros2-noetic-angles
...
Requires:       ros2-noetic-turtlesim

Provides:  ros2-noetic-turtle_actionlib = 0.2.0-1
Obsoletes: ros2-noetic-turtle_actionlib < 0.2.0-1
...
Requires:       ros2-noetic-actionlib-devel
Requires:       ros2-noetic-actionlib_msgs-devel
Requires:       ros2-noetic-ament_package-devel
Requires:       ros2-noetic-angles-devel
...
Requires:       ros2-noetic-turtlesim-devel
Requires:       ros2-noetic-message_runtime-devel

Provides: ros2-noetic-turtle_actionlib-devel = 0.2.0-1
Obsoletes: ros2-noetic-turtle_actionlib-devel < 0.2.0-1
...
colcon \
  ...
  --packages-select turtle_actionlib
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,turtle_actionlib/include/,share/turtle_actionlib/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.2.0-1
