Name:           ros2-humble-urdf_parser_plugin
Version:        2.6.0
Release:        1%{?dist}
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/urdf_parser_plugin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/urdf_parser_plugin
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/include/* %{buildroot}/%{_libdir}/ros2-humble/include/urdf_parser_plugin/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/urdf_parser_plugin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/urdf_parser_plugin
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/share/* %{buildroot}/%{_libdir}/ros2-humble/share/urdf_parser_plugin/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/urdf_parser_plugin/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/urdf_parser_plugin \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,urdf_parser_plugin/include/,share/urdf_parser_plugin/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/urdf_parser_plugin/{lib*/pkgconfig,include/,cmake/,urdf_parser_plugin/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/urdf_parser_plugin/{lib*/pkgconfig,include/,cmake/,urdf_parser_plugin/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/urdf_parser_plugin/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
