...
Source0:        https://github.com/ros-gbp/urdf_tutorial-release/archive/release/noetic/urdf_tutorial/0.5.0-1.tar.gz#/ros2-noetic-urdf_tutorial-0.5.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-roslaunch-devel

Requires:       ros2-noetic-joint_state_publisher
Requires:       ros2-noetic-joint_state_publisher_gui
Requires:       ros2-noetic-robot_state_publisher
Requires:       ros2-noetic-rviz
Requires:       ros2-noetic-xacro

Provides:  ros2-noetic-urdf_tutorial = 0.5.0-1
Obsoletes: ros2-noetic-urdf_tutorial < 0.5.0-1
...
Requires:       ros2-noetic-joint_state_publisher_gui-devel
Requires:       ros2-noetic-robot_state_publisher-devel
Requires:       ros2-noetic-rviz-devel
Requires:       ros2-noetic-xacro-devel

Provides: ros2-noetic-urdf_tutorial-devel = 0.5.0-1
Obsoletes: ros2-noetic-urdf_tutorial-devel < 0.5.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,urdf_tutorial/include/,share/urdf_tutorial/cmake} \
