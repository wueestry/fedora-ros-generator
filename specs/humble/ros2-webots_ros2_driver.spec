Name:           ros2-humble-webots_ros2_driver
Version:        2023.1.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_driver/2023.1.2-1.tar.gz#/ros2-humble-webots_ros2_driver-2023.1.2-source0.tar.gz
...
Provides:  ros2-humble-webots_ros2_driver = 2023.1.2-1
Obsoletes: ros2-humble-webots_ros2_driver < 2023.1.2-1
...
Provides: ros2-humble-webots_ros2_driver-devel = 2023.1.2-1
Obsoletes: ros2-humble-webots_ros2_driver-devel < 2023.1.2-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_driver ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_driver
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/include/* %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_driver/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_driver ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_driver
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/share/* %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_driver/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_driver/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_driver \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,webots_ros2_driver/include/,share/webots_ros2_driver/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_driver/{lib*/pkgconfig,include/,cmake/,webots_ros2_driver/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_driver/{lib*/pkgconfig,include/,cmake/,webots_ros2_driver/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_driver/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
