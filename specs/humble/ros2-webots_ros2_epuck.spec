Name:           ros2-humble-webots_ros2_epuck
Version:        2023.1.2
Release:        1%{?dist}
Summary:        ROS package webots_ros2_epuck

License:        Apache License 2.0
URL:            http://wiki.ros.org/webots_ros2

Source0:        https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_epuck/2023.1.2-1.tar.gz#/ros2-humble-webots_ros2_epuck-2023.1.2-source0.tar.gz
...
Provides:  ros2-humble-webots_ros2_epuck = 2023.1.2-1
Obsoletes: ros2-humble-webots_ros2_epuck < 2023.1.2-1
...
Provides: ros2-humble-webots_ros2_epuck-devel = 2023.1.2-1
Obsoletes: ros2-humble-webots_ros2_epuck-devel < 2023.1.2-1
...
colcon \
  ...
  --packages-select webots_ros2_epuck
...
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_epuck ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_epuck
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/include/* %{buildroot}/%{_libdir}/ros2-humble/include/webots_ros2_epuck/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/extra_cmake/* %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_epuck ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_epuck
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/share/* %{buildroot}/%{_libdir}/ros2-humble/share/webots_ros2_epuck/
#     rm -rd %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-humble ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-humble
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/* %{buildroot}/%{_libdir}/ros2-humble/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_epuck/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_epuck \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/{lib*/pkgconfig,include/,cmake/,webots_ros2_epuck/include/,share/webots_ros2_epuck/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-humble/webots_ros2_epuck/{lib*/pkgconfig,include/,cmake/,webots_ros2_epuck/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/webots_ros2_epuck/{lib*/pkgconfig,include/,cmake/,webots_ros2_epuck/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-humble/opt/share/webots_ros2_epuck/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
