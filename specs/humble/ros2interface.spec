...
Summary:        Meta package for ros2-humble-ros2interface and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ros2interface
Requires:       ros2-humble-ros2interface-devel

Obsoletes: ros-humble-ros2interface < 0.18.11-1
