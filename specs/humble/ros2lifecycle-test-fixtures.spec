# Meta Package
Name:           ros-humble-ros2lifecycle-test-fixtures
Version:        0.18.10
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-humble-ros2lifecycle_test_fixtures and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ros2lifecycle_test_fixtures
Requires:       ros2-humble-ros2lifecycle_test_fixtures-devel

Obsoletes: ros-humble-ros2lifecycle-test-fixtures < 0.18.10-1
