...
Summary:        Meta package for ros2-humble-ros2lifecycle and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-ros2lifecycle
Requires:       ros2-humble-ros2lifecycle-devel

Obsoletes: ros-humble-ros2lifecycle < 0.18.10-1
