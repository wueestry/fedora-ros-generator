...
Summary:        Meta package for ros2-humble-rosbag2_compression and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosbag2_compression
Requires:       ros2-humble-rosbag2_compression-devel

Obsoletes: ros-humble-rosbag2-compression < 0.15.11-1
