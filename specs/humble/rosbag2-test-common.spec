# Meta Package
Name:           ros-humble-rosbag2-test-common
Version:        0.15.11
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-humble-rosbag2_test_common and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosbag2_test_common
Requires:       ros2-humble-rosbag2_test_common-devel

Obsoletes: ros-humble-rosbag2-test-common < 0.15.11-1
