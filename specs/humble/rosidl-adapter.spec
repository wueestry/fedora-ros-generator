...
Summary:        Meta package for ros2-humble-rosidl_adapter and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_adapter
Requires:       ros2-humble-rosidl_adapter-devel

Obsoletes: ros-humble-rosidl-adapter < 3.1.5-1
