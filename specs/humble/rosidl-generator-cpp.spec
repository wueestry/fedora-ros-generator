...
Summary:        Meta package for ros2-humble-rosidl_generator_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_generator_cpp
Requires:       ros2-humble-rosidl_generator_cpp-devel

Obsoletes: ros-humble-rosidl-generator-cpp < 3.1.5-1
