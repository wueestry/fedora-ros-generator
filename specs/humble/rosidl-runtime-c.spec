...
Summary:        Meta package for ros2-humble-rosidl_runtime_c and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_runtime_c
Requires:       ros2-humble-rosidl_runtime_c-devel

Obsoletes: ros-humble-rosidl-runtime-c < 3.1.5-1
