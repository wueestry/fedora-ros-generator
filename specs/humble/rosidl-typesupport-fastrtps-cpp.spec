...
Summary:        Meta package for ros2-humble-rosidl_typesupport_fastrtps_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_typesupport_fastrtps_cpp
Requires:       ros2-humble-rosidl_typesupport_fastrtps_cpp-devel

Obsoletes: ros-humble-rosidl-typesupport-fastrtps-cpp < 2.2.2-1
