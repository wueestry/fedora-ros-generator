...
Summary:        Meta package for ros2-humble-rosidl_typesupport_introspection_c and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_typesupport_introspection_c
Requires:       ros2-humble-rosidl_typesupport_introspection_c-devel

Obsoletes: ros-humble-rosidl-typesupport-introspection-c < 3.1.5-1
