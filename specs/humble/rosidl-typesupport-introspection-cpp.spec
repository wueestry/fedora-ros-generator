...
Summary:        Meta package for ros2-humble-rosidl_typesupport_introspection_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-rosidl_typesupport_introspection_cpp
Requires:       ros2-humble-rosidl_typesupport_introspection_cpp-devel

Obsoletes: ros-humble-rosidl-typesupport-introspection-cpp < 3.1.5-1
