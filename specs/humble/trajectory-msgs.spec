...
Summary:        Meta package for ros2-humble-trajectory_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-trajectory_msgs
Requires:       ros2-humble-trajectory_msgs-devel

Obsoletes: ros-humble-trajectory-msgs < 4.2.4-1
