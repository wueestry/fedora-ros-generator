...
Summary:        Meta package for ros2-humble-tricycle_steering_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-tricycle_steering_controller
Requires:       ros2-humble-tricycle_steering_controller-devel

Obsoletes: ros-humble-tricycle-steering-controller < 2.34.0-1
