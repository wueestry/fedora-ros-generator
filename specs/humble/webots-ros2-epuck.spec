# Meta Package
Name:           ros-humble-webots-ros2-epuck
Version:        2023.1.2
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://wiki.ros.org/webots_ros2
Summary:        Meta package for ros2-humble-webots_ros2_epuck and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-humble-webots_ros2_epuck
Requires:       ros2-humble-webots_ros2_epuck-devel

Obsoletes: ros-humble-webots-ros2-epuck < 2023.1.2-1
