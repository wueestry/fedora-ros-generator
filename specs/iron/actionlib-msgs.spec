# Meta Package
Name:           ros-iron-actionlib-msgs
Version:        5.0.0
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-actionlib_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-actionlib_msgs
Requires:       ros2-iron-actionlib_msgs-devel

Obsoletes: ros-iron-actionlib-msgs < 5.0.0-1
