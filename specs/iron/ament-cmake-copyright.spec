# Meta Package
Name:           ros-iron-ament-cmake-copyright
Version:        0.14.3
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-ament_cmake_copyright and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_cmake_copyright
Requires:       ros2-iron-ament_cmake_copyright-devel

Obsoletes: ros-iron-ament-cmake-copyright < 0.14.3-1
