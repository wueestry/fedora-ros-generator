# Meta Package
Name:           ros-iron-ament-cmake-cpplint
Version:        0.14.3
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-ament_cmake_cpplint and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_cmake_cpplint
Requires:       ros2-iron-ament_cmake_cpplint-devel

Obsoletes: ros-iron-ament-cmake-cpplint < 0.14.3-1
