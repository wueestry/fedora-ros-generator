...
Summary:        Meta package for ros2-iron-ament_cmake_gmock and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_cmake_gmock
Requires:       ros2-iron-ament_cmake_gmock-devel

Obsoletes: ros-iron-ament-cmake-gmock < 2.0.5-1
