...
Summary:        Meta package for ros2-iron-ament_cmake_gtest and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_cmake_gtest
Requires:       ros2-iron-ament_cmake_gtest-devel

Obsoletes: ros-iron-ament-cmake-gtest < 2.0.5-1
