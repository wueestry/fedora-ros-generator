# Meta Package
Name:           ros-iron-ament-lint
Version:        0.14.3
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-ament_lint and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_lint
Requires:       ros2-iron-ament_lint-devel

Obsoletes: ros-iron-ament-lint < 0.14.3-1
