# Meta Package
Name:           ros-iron-ament-pep257
Version:        0.14.3
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-ament_pep257 and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ament_pep257
Requires:       ros2-iron-ament_pep257-devel

Obsoletes: ros-iron-ament-pep257 < 0.14.3-1
