# Meta Package
Name:           ros-iron-diagnostic-msgs
Version:        5.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-diagnostic_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-diagnostic_msgs
Requires:       ros2-iron-diagnostic_msgs-devel

Obsoletes: ros-iron-diagnostic-msgs < 5.0.1-1
