...
Summary:        Meta package for ros2-iron-examples_rclpy_minimal_action_client and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-examples_rclpy_minimal_action_client
Requires:       ros2-iron-examples_rclpy_minimal_action_client-devel

Obsoletes: ros-iron-examples-rclpy-minimal-action-client < 0.18.0-1
