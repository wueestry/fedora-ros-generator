...
Summary:        Meta package for ros2-iron-forward_command_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-forward_command_controller
Requires:       ros2-iron-forward_command_controller-devel

Obsoletes: ros-iron-forward-command-controller < 3.24.0-1
