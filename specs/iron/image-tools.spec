# Meta Package
Name:           ros-iron-image-tools
Version:        0.27.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-image_tools and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-image_tools
Requires:       ros2-iron-image_tools-devel

Obsoletes: ros-iron-image-tools < 0.27.1-1
