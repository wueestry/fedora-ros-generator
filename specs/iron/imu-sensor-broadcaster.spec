...
Summary:        Meta package for ros2-iron-imu_sensor_broadcaster and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-imu_sensor_broadcaster
Requires:       ros2-iron-imu_sensor_broadcaster-devel

Obsoletes: ros-iron-imu-sensor-broadcaster < 3.24.0-1
