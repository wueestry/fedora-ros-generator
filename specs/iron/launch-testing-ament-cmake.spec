...
Summary:        Meta package for ros2-iron-launch_testing_ament_cmake and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-launch_testing_ament_cmake
Requires:       ros2-iron-launch_testing_ament_cmake-devel

Obsoletes: ros-iron-launch-testing-ament-cmake < 2.0.3-1
