...
Summary:        Meta package for ros2-iron-moveit_configs_utils and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-moveit_configs_utils
Requires:       ros2-iron-moveit_configs_utils-devel

Obsoletes: ros-iron-moveit-configs-utils < 2.8.0-1
