...
Summary:        Meta package for ros2-iron-nav2_bringup and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-nav2_bringup
Requires:       ros2-iron-nav2_bringup-devel

Obsoletes: ros-iron-nav2-bringup < 1.2.9-1
