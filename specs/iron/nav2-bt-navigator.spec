...
Summary:        Meta package for ros2-iron-nav2_bt_navigator and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-nav2_bt_navigator
Requires:       ros2-iron-nav2_bt_navigator-devel

Obsoletes: ros-iron-nav2-bt-navigator < 1.2.9-1
