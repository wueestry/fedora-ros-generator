# Meta Package
Name:           ros-iron-nav2-dwb-controller
Version:        1.2.9
Release:        1%{?dist}
License:        Apache-2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-nav2_dwb_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-nav2_dwb_controller
Requires:       ros2-iron-nav2_dwb_controller-devel

Obsoletes: ros-iron-nav2-dwb-controller < 1.2.9-1
