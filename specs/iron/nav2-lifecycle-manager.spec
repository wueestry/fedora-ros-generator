# Meta Package
Name:           ros-iron-nav2-lifecycle-manager
Version:        1.2.9
Release:        1%{?dist}
License:        Apache-2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-nav2_lifecycle_manager and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-nav2_lifecycle_manager
Requires:       ros2-iron-nav2_lifecycle_manager-devel

Obsoletes: ros-iron-nav2-lifecycle-manager < 1.2.9-1
