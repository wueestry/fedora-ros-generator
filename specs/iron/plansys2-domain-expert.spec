# Meta Package
Name:           ros-iron-plansys2-domain-expert
Version:        2.0.11
Release:        1%{?dist}
License:        Apache License, Version 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-plansys2_domain_expert and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-plansys2_domain_expert
Requires:       ros2-iron-plansys2_domain_expert-devel

Obsoletes: ros-iron-plansys2-domain-expert < 2.0.11-1
