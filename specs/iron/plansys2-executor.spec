# Meta Package
Name:           ros-iron-plansys2-executor
Version:        2.0.11
Release:        1%{?dist}
License:        Apache License, Version 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-plansys2_executor and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-plansys2_executor
Requires:       ros2-iron-plansys2_executor-devel

Obsoletes: ros-iron-plansys2-executor < 2.0.11-1
