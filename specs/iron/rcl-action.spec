# Meta Package
Name:           ros-iron-rcl-action
Version:        6.0.5
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rcl_action and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rcl_action
Requires:       ros2-iron-rcl_action-devel

Obsoletes: ros-iron-rcl-action < 6.0.5-1
