# Meta Package
Name:           ros-iron-rmw-fastrtps-cpp
Version:        7.1.3
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rmw_fastrtps_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rmw_fastrtps_cpp
Requires:       ros2-iron-rmw_fastrtps_cpp-devel

Obsoletes: ros-iron-rmw-fastrtps-cpp < 7.1.3-1
