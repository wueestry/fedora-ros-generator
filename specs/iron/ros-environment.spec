...
Summary:        Meta package for ros2-iron-ros_environment and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ros_environment
Requires:       ros2-iron-ros_environment-devel

Obsoletes: ros-iron-ros-environment < 4.1.1-1
