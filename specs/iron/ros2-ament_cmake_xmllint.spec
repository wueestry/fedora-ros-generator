Name:           ros2-iron-ament_cmake_xmllint
Version:        0.14.3
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/iron/ament_cmake_xmllint/0.14.3-1.tar.gz#/ros2-iron-ament_cmake_xmllint-0.14.3-source0.tar.gz
...
Provides:  ros2-iron-ament_cmake_xmllint = 0.14.3-1
Obsoletes: ros2-iron-ament_cmake_xmllint < 0.14.3-1
...
Provides: ros2-iron-ament_cmake_xmllint-devel = 0.14.3-1
Obsoletes: ros2-iron-ament_cmake_xmllint-devel < 0.14.3-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/ament_cmake_xmllint ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/ament_cmake_xmllint
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/include/* %{buildroot}/%{_libdir}/ros2-iron/include/ament_cmake_xmllint
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/ament_cmake_xmllint/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/ament_cmake_xmllint/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/ament_cmake_xmllint/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,ament_cmake_xmllint/include/,share/ament_cmake_xmllint/cmake} \
