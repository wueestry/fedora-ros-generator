Name:           ros2-iron-gazebo_ros_pkgs
Version:        3.7.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/iron/gazebo_ros_pkgs/3.7.0-3.tar.gz#/ros2-iron-gazebo_ros_pkgs-3.7.0-source0.tar.gz
...
Provides:  ros2-iron-gazebo_ros_pkgs = 3.7.0-1
Obsoletes: ros2-iron-gazebo_ros_pkgs < 3.7.0-1
...
Provides: ros2-iron-gazebo_ros_pkgs-devel = 3.7.0-1
Obsoletes: ros2-iron-gazebo_ros_pkgs-devel < 3.7.0-1
...
colcon \
  ...
  --packages-select gazebo_ros_pkgs
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/gazebo_ros_pkgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/gazebo_ros_pkgs
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/include/* %{buildroot}/%{_libdir}/ros2-iron/include/gazebo_ros_pkgs
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/gazebo_ros_pkgs/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/gazebo_ros_pkgs/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/gazebo_ros_pkgs/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,gazebo_ros_pkgs/include/,share/gazebo_ros_pkgs/cmake} \
