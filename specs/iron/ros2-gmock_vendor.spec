...
Source0:        https://github.com/ros2-gbp/googletest-release/archive/release/iron/gmock_vendor/1.10.9005-2.tar.gz#/ros2-iron-gmock_vendor-1.10.9005-source0.tar.gz
...
Provides:  ros2-iron-gmock_vendor = 1.10.9005-1
Obsoletes: ros2-iron-gmock_vendor < 1.10.9005-1
...
Provides: ros2-iron-gmock_vendor-devel = 1.10.9005-1
Obsoletes: ros2-iron-gmock_vendor-devel < 1.10.9005-1
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,src/gmock_vendor/include/,share/gmock_vendor/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
rm -rf %{buildroot}/%{_libdir}/ros2-iron/src/gmock_vendor/src
rm -rf %{buildroot}/%{_libdir}/ros2-iron/src/gmock_vendor/CMakeLists.txt
