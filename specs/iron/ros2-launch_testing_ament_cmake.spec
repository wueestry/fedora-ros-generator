Name:           ros2-iron-launch_testing_ament_cmake
Version:        2.0.3
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/launch-release/archive/release/iron/launch_testing_ament_cmake/2.0.3-1.tar.gz#/ros2-iron-launch_testing_ament_cmake-2.0.3-source0.tar.gz
...
Provides:  ros2-iron-launch_testing_ament_cmake = 2.0.3-1
Obsoletes: ros2-iron-launch_testing_ament_cmake < 2.0.3-1
...
Provides: ros2-iron-launch_testing_ament_cmake-devel = 2.0.3-1
Obsoletes: ros2-iron-launch_testing_ament_cmake-devel < 2.0.3-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/launch_testing_ament_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/launch_testing_ament_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/include/* %{buildroot}/%{_libdir}/ros2-iron/include/launch_testing_ament_cmake
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/launch_testing_ament_cmake/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/launch_testing_ament_cmake/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/launch_testing_ament_cmake/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,launch_testing_ament_cmake/include/,share/launch_testing_ament_cmake/cmake} \
