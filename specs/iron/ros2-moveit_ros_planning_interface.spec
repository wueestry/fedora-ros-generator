Name:           ros2-iron-moveit_ros_planning_interface
Version:        2.8.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_ros_planning_interface/2.8.0-1.tar.gz#/ros2-iron-moveit_ros_planning_interface-2.8.0-source0.tar.gz
...
BuildRequires:  ros2-iron-moveit_planners_ompl-devel
...
BuildRequires:  ros2-iron-moveit_simple_controller_manager-devel
...
Provides:  ros2-iron-moveit_ros_planning_interface = 2.8.0-1
Obsoletes: ros2-iron-moveit_ros_planning_interface < 2.8.0-1
...
Provides: ros2-iron-moveit_ros_planning_interface-devel = 2.8.0-1
Obsoletes: ros2-iron-moveit_ros_planning_interface-devel < 2.8.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/moveit_ros_planning_interface ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/moveit_ros_planning_interface
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/include/* %{buildroot}/%{_libdir}/ros2-iron/include/moveit_ros_planning_interface
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/moveit_ros_planning_interface/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/moveit_ros_planning_interface/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/moveit_ros_planning_interface/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning_interface/include/,share/moveit_ros_planning_interface/cmake} \
