...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_regulated_pure_pursuit_controller/1.2.9-1.tar.gz#/ros2-iron-nav2_regulated_pure_pursuit_controller-1.2.9-source0.tar.gz
...
Provides:  ros2-iron-nav2_regulated_pure_pursuit_controller = 1.2.9-1
Obsoletes: ros2-iron-nav2_regulated_pure_pursuit_controller < 1.2.9-1
...
Provides: ros2-iron-nav2_regulated_pure_pursuit_controller-devel = 1.2.9-1
Obsoletes: ros2-iron-nav2_regulated_pure_pursuit_controller-devel < 1.2.9-1
