Name:           ros2-iron-pilz_industrial_motion_planner
Version:        2.8.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/iron/pilz_industrial_motion_planner/2.8.0-1.tar.gz#/ros2-iron-pilz_industrial_motion_planner-2.8.0-source0.tar.gz
...
BuildRequires:  ros2-iron-moveit_resources_prbt_moveit_config-devel
BuildRequires:  ros2-iron-moveit_resources_prbt_pg70_support-devel
BuildRequires:  ros2-iron-moveit_resources_prbt_support-devel
BuildRequires:  ros2-iron-moveit_ros_move_group-devel
BuildRequires:  ros2-iron-moveit_ros_planning-devel
BuildRequires:  ros2-iron-moveit_ros_planning_interface-devel
BuildRequires:  ros2-iron-orocos_kdl_vendor-devel
BuildRequires:  ros2-iron-pilz_industrial_motion_planner_testutils-devel
...
Provides:  ros2-iron-pilz_industrial_motion_planner = 2.8.0-1
Obsoletes: ros2-iron-pilz_industrial_motion_planner < 2.8.0-1
...
Provides: ros2-iron-pilz_industrial_motion_planner-devel = 2.8.0-1
Obsoletes: ros2-iron-pilz_industrial_motion_planner-devel < 2.8.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/pilz_industrial_motion_planner ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/pilz_industrial_motion_planner
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/include/* %{buildroot}/%{_libdir}/ros2-iron/include/pilz_industrial_motion_planner
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/pilz_industrial_motion_planner/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/pilz_industrial_motion_planner/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/pilz_industrial_motion_planner/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,share/pilz_industrial_motion_planner/cmake} \
