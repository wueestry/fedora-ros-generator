Name:           ros2-iron-plansys2_domain_expert
Version:        2.0.11
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/iron/plansys2_domain_expert/2.0.11-1.tar.gz#/ros2-iron-plansys2_domain_expert-2.0.11-source0.tar.gz
...
BuildRequires:  ros2-iron-plansys2_core-devel
BuildRequires:  ros2-iron-plansys2_msgs-devel
BuildRequires:  ros2-iron-plansys2_pddl_parser-devel
BuildRequires:  ros2-iron-plansys2_popf_plan_solver-devel
...
Requires:       ros2-iron-plansys2_core-devel
Requires:       ros2-iron-plansys2_msgs-devel
Requires:       ros2-iron-plansys2_pddl_parser-devel
Requires:       ros2-iron-plansys2_popf_plan_solver-devel
...
Provides: ros2-iron-plansys2_domain_expert-devel = 2.0.11-1
Obsoletes: ros2-iron-plansys2_domain_expert-devel < 2.0.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/plansys2_domain_expert ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/plansys2_domain_expert
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/include/* %{buildroot}/%{_libdir}/ros2-iron/include/plansys2_domain_expert
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/plansys2_domain_expert/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/plansys2_domain_expert/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/plansys2_domain_expert/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,plansys2_domain_expert/include/,share/plansys2_domain_expert/cmake} \
