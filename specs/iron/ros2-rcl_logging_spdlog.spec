Name:           ros2-iron-rcl_logging_spdlog
Version:        2.5.1
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rcl_logging-release/archive/release/iron/rcl_logging_spdlog/2.5.1-2.tar.gz#/ros2-iron-rcl_logging_spdlog-2.5.1-source0.tar.gz
...
BuildRequires:  ros2-iron-spdlog_vendor-devel
...
Provides:  ros2-iron-rcl_logging_spdlog = 2.5.1-1
Obsoletes: ros2-iron-rcl_logging_spdlog < 2.5.1-1
...
Provides: ros2-iron-rcl_logging_spdlog-devel = 2.5.1-1
Obsoletes: ros2-iron-rcl_logging_spdlog-devel < 2.5.1-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/rcl_logging_spdlog ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/rcl_logging_spdlog
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/include/* %{buildroot}/%{_libdir}/ros2-iron/include/rcl_logging_spdlog
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/rcl_logging_spdlog/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/rcl_logging_spdlog/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/rcl_logging_spdlog/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,rcl_logging_spdlog/include/,share/rcl_logging_spdlog/cmake} \
