Name:           ros2-iron-turtlebot3_gazebo
Version:        2.2.5
Release:        1%{?dist}
Summary:        ROS package turtlebot3_gazebo

License:        Apache 2.0
URL:            http://turtlebot3.robotis.com

Source0:        https://github.com/ros2-gbp/turtlebot3_simulations-release/archive/release/iron/turtlebot3_gazebo/2.2.5-4.tar.gz#/ros2-iron-turtlebot3_gazebo-2.2.5-source0.tar.gz
...
BuildRequires:  ros2-iron-gazebo_ros_pkgs-devel
...
Provides:  ros2-iron-turtlebot3_gazebo = 2.2.5-1
Obsoletes: ros2-iron-turtlebot3_gazebo < 2.2.5-1
...
Provides: ros2-iron-turtlebot3_gazebo-devel = 2.2.5-1
Obsoletes: ros2-iron-turtlebot3_gazebo-devel < 2.2.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/include/turtlebot3_gazebo ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/include/turtlebot3_gazebo
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/include/* %{buildroot}/%{_libdir}/ros2-iron/include/turtlebot3_gazebo
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/share %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/share -type f -exec sed -i "s:opt/turtlebot3_gazebo/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/bin %{buildroot}/%{_libdir}/ros2-iron/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/extra_cmake %{buildroot}/%{_libdir}/ros2-iron/
#     find %{buildroot}/%{_libdir}/ros2-iron/extra_cmake -type f -exec sed -i "s:opt/turtlebot3_gazebo/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/lib %{buildroot}/%{_libdir}/ros2-iron/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-iron/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-iron/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-iron/opt/turtlebot3_gazebo/lib64 %{buildroot}/%{_libdir}/ros2-iron/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-iron/{lib*/pkgconfig,include/,cmake/,turtlebot3_gazebo/include/,share/turtlebot3_gazebo/cmake} \
