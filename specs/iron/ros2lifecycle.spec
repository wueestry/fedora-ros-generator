# Meta Package
Name:           ros-iron-ros2lifecycle
Version:        0.25.6
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-ros2lifecycle and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-ros2lifecycle
Requires:       ros2-iron-ros2lifecycle-devel

Obsoletes: ros-iron-ros2lifecycle < 0.25.6-1
