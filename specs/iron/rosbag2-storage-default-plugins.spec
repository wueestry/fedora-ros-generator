# Meta Package
Name:           ros-iron-rosbag2-storage-default-plugins
Version:        0.22.6
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rosbag2_storage_default_plugins and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rosbag2_storage_default_plugins
Requires:       ros2-iron-rosbag2_storage_default_plugins-devel

Obsoletes: ros-iron-rosbag2-storage-default-plugins < 0.22.6-1
