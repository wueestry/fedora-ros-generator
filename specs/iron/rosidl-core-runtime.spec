# Meta Package
Name:           ros-iron-rosidl-core-runtime
Version:        0.1.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rosidl_core_runtime and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rosidl_core_runtime
Requires:       ros2-iron-rosidl_core_runtime-devel

Obsoletes: ros-iron-rosidl-core-runtime < 0.1.1-1
