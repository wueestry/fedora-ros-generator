# Meta Package
Name:           ros-iron-rosidl-pycommon
Version:        4.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rosidl_pycommon and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rosidl_pycommon
Requires:       ros2-iron-rosidl_pycommon-devel

Obsoletes: ros-iron-rosidl-pycommon < 4.0.1-1
