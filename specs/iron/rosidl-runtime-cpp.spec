# Meta Package
Name:           ros-iron-rosidl-runtime-cpp
Version:        4.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rosidl_runtime_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rosidl_runtime_cpp
Requires:       ros2-iron-rosidl_runtime_cpp-devel

Obsoletes: ros-iron-rosidl-runtime-cpp < 4.0.1-1
