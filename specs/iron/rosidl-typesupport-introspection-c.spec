# Meta Package
Name:           ros-iron-rosidl-typesupport-introspection-c
Version:        4.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-rosidl_typesupport_introspection_c and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-rosidl_typesupport_introspection_c
Requires:       ros2-iron-rosidl_typesupport_introspection_c-devel

Obsoletes: ros-iron-rosidl-typesupport-introspection-c < 4.0.1-1
