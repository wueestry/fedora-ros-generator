# Meta Package
Name:           ros-iron-std-msgs
Version:        5.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-std_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-std_msgs
Requires:       ros2-iron-std_msgs-devel

Obsoletes: ros-iron-std-msgs < 5.0.1-1
