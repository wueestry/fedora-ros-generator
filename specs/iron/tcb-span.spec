# Meta Package
Name:           ros-iron-tcb-span
Version:        1.0.2
Release:        1%{?dist}
License:        Boost Software License
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-tcb_span and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-tcb_span
Requires:       ros2-iron-tcb_span-devel

Obsoletes: ros-iron-tcb-span < 1.0.2-1
