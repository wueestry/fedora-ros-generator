...
Summary:        Meta package for ros2-iron-teleop_twist_keyboard and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-teleop_twist_keyboard
Requires:       ros2-iron-teleop_twist_keyboard-devel

Obsoletes: ros-iron-teleop-twist-keyboard < 2.4.0-1
