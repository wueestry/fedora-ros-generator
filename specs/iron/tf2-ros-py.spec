# Meta Package
Name:           ros-iron-tf2-ros-py
Version:        0.31.6
Release:        1%{?dist}
License:        BSD
URL:            http://www.ros.org/wiki/tf2_ros
Summary:        Meta package for ros2-iron-tf2_ros_py and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-tf2_ros_py
Requires:       ros2-iron-tf2_ros_py-devel

Obsoletes: ros-iron-tf2-ros-py < 0.31.6-1
