...
Summary:        Meta package for ros2-iron-velocity_controllers and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-velocity_controllers
Requires:       ros2-iron-velocity_controllers-devel

Obsoletes: ros-iron-velocity-controllers < 3.24.0-1
