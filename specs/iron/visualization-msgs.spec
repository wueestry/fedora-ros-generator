# Meta Package
Name:           ros-iron-visualization-msgs
Version:        5.0.1
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://www.ros.org/
Summary:        Meta package for ros2-iron-visualization_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-visualization_msgs
Requires:       ros2-iron-visualization_msgs-devel

Obsoletes: ros-iron-visualization-msgs < 5.0.1-1
