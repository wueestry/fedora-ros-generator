...
Summary:        Meta package for ros2-iron-webots_ros2_driver and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-webots_ros2_driver
Requires:       ros2-iron-webots_ros2_driver-devel

Obsoletes: ros-iron-webots-ros2-driver < 2023.1.2-1
