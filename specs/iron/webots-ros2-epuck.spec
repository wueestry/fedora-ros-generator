...
Summary:        Meta package for ros2-iron-webots_ros2_epuck and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-webots_ros2_epuck
Requires:       ros2-iron-webots_ros2_epuck-devel

Obsoletes: ros-iron-webots-ros2-epuck < 2023.1.2-1
