# Meta Package
Name:           ros-iron-webots-ros2-importer
Version:        2023.1.2
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://wiki.ros.org/webots_ros2
Summary:        Meta package for ros2-iron-webots_ros2_importer and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-iron-webots_ros2_importer
Requires:       ros2-iron-webots_ros2_importer-devel

Obsoletes: ros-iron-webots-ros2-importer < 2023.1.2-1
