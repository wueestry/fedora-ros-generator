...
Summary:        Meta package for ros2-jazzy-admittance_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-admittance_controller
Requires:       ros2-jazzy-admittance_controller-devel

Obsoletes: ros-jazzy-admittance-controller < 4.13.0-1
