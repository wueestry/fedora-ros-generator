...
Summary:        Meta package for ros2-jazzy-ament_cmake_export_link_flags and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_export_link_flags
Requires:       ros2-jazzy-ament_cmake_export_link_flags-devel

Obsoletes: ros-jazzy-ament-cmake-export-link-flags < 2.5.3-1
