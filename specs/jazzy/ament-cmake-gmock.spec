...
Summary:        Meta package for ros2-jazzy-ament_cmake_gmock and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_gmock
Requires:       ros2-jazzy-ament_cmake_gmock-devel

Obsoletes: ros-jazzy-ament-cmake-gmock < 2.5.2-1
