...
Summary:        Meta package for ros2-jazzy-ament_cmake_google_benchmark and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_google_benchmark
Requires:       ros2-jazzy-ament_cmake_google_benchmark-devel

Obsoletes: ros-jazzy-ament-cmake-google-benchmark < 2.5.0-1
