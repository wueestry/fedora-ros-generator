...
Summary:        Meta package for ros2-jazzy-ament_cmake_libraries and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_libraries
Requires:       ros2-jazzy-ament_cmake_libraries-devel

Obsoletes: ros-jazzy-ament-cmake-libraries < 2.5.3-1
