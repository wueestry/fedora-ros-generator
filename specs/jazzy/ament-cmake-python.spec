...
Summary:        Meta package for ros2-jazzy-ament_cmake_python and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_python
Requires:       ros2-jazzy-ament_cmake_python-devel

Obsoletes: ros-jazzy-ament-cmake-python < 2.5.0-1
