...
Summary:        Meta package for ros2-jazzy-ament_cmake_vendor_package and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_cmake_vendor_package
Requires:       ros2-jazzy-ament_cmake_vendor_package-devel

Obsoletes: ros-jazzy-ament-cmake-vendor-package < 2.5.2-1
