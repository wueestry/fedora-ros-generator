...
Summary:        Meta package for ros2-jazzy-ament_index_python and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_index_python
Requires:       ros2-jazzy-ament_index_python-devel

Obsoletes: ros-jazzy-ament-index-python < 1.8.1-1
