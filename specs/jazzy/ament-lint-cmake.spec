...
Summary:        Meta package for ros2-jazzy-ament_lint_cmake and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_lint_cmake
Requires:       ros2-jazzy-ament_lint_cmake-devel

Obsoletes: ros-jazzy-ament-lint-cmake < 0.17.2-1
