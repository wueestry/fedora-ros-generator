...
Summary:        Meta package for ros2-jazzy-ament_mypy and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-ament_mypy
Requires:       ros2-jazzy-ament_mypy-devel

Obsoletes: ros-jazzy-ament-mypy < 0.17.1-1
