...
Summary:        Meta package for ros2-jazzy-compressed_depth_image_transport and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-compressed_depth_image_transport
Requires:       ros2-jazzy-compressed_depth_image_transport-devel

Obsoletes: ros-jazzy-compressed-depth-image-transport < 4.0.4-1
