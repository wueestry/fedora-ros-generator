...
Summary:        Meta package for ros2-jazzy-effort_controllers and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-effort_controllers
Requires:       ros2-jazzy-effort_controllers-devel

Obsoletes: ros-jazzy-effort-controllers < 4.13.0-1
