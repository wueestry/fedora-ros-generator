...
Summary:        Meta package for ros2-jazzy-examples_rclcpp_minimal_action_server and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclcpp_minimal_action_server
Requires:       ros2-jazzy-examples_rclcpp_minimal_action_server-devel

Obsoletes: ros-jazzy-examples-rclcpp-minimal-action-server < 0.19.4-1
