...
Summary:        Meta package for ros2-jazzy-examples_rclcpp_minimal_client and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclcpp_minimal_client
Requires:       ros2-jazzy-examples_rclcpp_minimal_client-devel

Obsoletes: ros-jazzy-examples-rclcpp-minimal-client < 0.19.5-1
