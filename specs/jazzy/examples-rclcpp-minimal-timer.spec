...
Summary:        Meta package for ros2-jazzy-examples_rclcpp_minimal_timer and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclcpp_minimal_timer
Requires:       ros2-jazzy-examples_rclcpp_minimal_timer-devel

Obsoletes: ros-jazzy-examples-rclcpp-minimal-timer < 0.19.5-1
