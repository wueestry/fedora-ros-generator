...
Summary:        Meta package for ros2-jazzy-examples_rclpy_executors and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclpy_executors
Requires:       ros2-jazzy-examples_rclpy_executors-devel

Obsoletes: ros-jazzy-examples-rclpy-executors < 0.19.3-1
