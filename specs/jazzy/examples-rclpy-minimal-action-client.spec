...
Summary:        Meta package for ros2-jazzy-examples_rclpy_minimal_action_client and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclpy_minimal_action_client
Requires:       ros2-jazzy-examples_rclpy_minimal_action_client-devel

Obsoletes: ros-jazzy-examples-rclpy-minimal-action-client < 0.19.3-1
