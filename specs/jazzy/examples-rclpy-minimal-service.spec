...
Summary:        Meta package for ros2-jazzy-examples_rclpy_minimal_service and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-examples_rclpy_minimal_service
Requires:       ros2-jazzy-examples_rclpy_minimal_service-devel

Obsoletes: ros-jazzy-examples-rclpy-minimal-service < 0.19.4-1
