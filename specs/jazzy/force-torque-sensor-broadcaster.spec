...
Summary:        Meta package for ros2-jazzy-force_torque_sensor_broadcaster and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-force_torque_sensor_broadcaster
Requires:       ros2-jazzy-force_torque_sensor_broadcaster-devel

Obsoletes: ros-jazzy-force-torque-sensor-broadcaster < 4.13.0-1
