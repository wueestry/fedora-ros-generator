...
Summary:        Meta package for ros2-jazzy-forward_command_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-forward_command_controller
Requires:       ros2-jazzy-forward_command_controller-devel

Obsoletes: ros-jazzy-forward-command-controller < 4.23.0-1
