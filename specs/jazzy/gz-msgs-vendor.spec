...
Summary:        Meta package for ros2-jazzy-gz_msgs_vendor and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-gz_msgs_vendor
Requires:       ros2-jazzy-gz_msgs_vendor-devel

Obsoletes: ros-jazzy-gz-msgs-vendor < 0.0.6-1
