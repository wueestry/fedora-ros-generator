...
Summary:        Meta package for ros2-jazzy-gz_rendering_vendor and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-gz_rendering_vendor
Requires:       ros2-jazzy-gz_rendering_vendor-devel

Obsoletes: ros-jazzy-gz-rendering-vendor < 0.0.6-1
