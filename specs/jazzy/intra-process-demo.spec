...
Summary:        Meta package for ros2-jazzy-intra_process_demo and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-intra_process_demo
Requires:       ros2-jazzy-intra_process_demo-devel

Obsoletes: ros-jazzy-intra-process-demo < 0.33.5-1
