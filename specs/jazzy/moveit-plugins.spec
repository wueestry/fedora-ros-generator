...
Summary:        Meta package for ros2-jazzy-moveit_plugins and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-moveit_plugins
Requires:       ros2-jazzy-moveit_plugins-devel

Obsoletes: ros-jazzy-moveit-plugins < 2.12.2-1
