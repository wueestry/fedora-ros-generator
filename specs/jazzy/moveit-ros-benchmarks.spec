...
Summary:        Meta package for ros2-jazzy-moveit_ros_benchmarks and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-moveit_ros_benchmarks
Requires:       ros2-jazzy-moveit_ros_benchmarks-devel

Obsoletes: ros-jazzy-moveit-ros-benchmarks < 2.10.0-1
