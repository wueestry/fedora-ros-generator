...
Summary:        Meta package for ros2-jazzy-moveit_ros_warehouse and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-moveit_ros_warehouse
Requires:       ros2-jazzy-moveit_ros_warehouse-devel

Obsoletes: ros-jazzy-moveit-ros-warehouse < 2.10.0-1
