...
Summary:        Meta package for ros2-jazzy-nav2_behavior_tree and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-nav2_behavior_tree
Requires:       ros2-jazzy-nav2_behavior_tree-devel

Obsoletes: ros-jazzy-nav2-behavior-tree < 1.3.5-1
