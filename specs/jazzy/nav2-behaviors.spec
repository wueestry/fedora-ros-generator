...
Summary:        Meta package for ros2-jazzy-nav2_behaviors and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-nav2_behaviors
Requires:       ros2-jazzy-nav2_behaviors-devel

Obsoletes: ros-jazzy-nav2-behaviors < 1.3.5-1
