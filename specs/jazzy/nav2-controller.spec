...
Summary:        Meta package for ros2-jazzy-nav2_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-nav2_controller
Requires:       ros2-jazzy-nav2_controller-devel

Obsoletes: ros-jazzy-nav2-controller < 1.3.5-1
