...
Summary:        Meta package for ros2-jazzy-nav2_dwb_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-nav2_dwb_controller
Requires:       ros2-jazzy-nav2_dwb_controller-devel

Obsoletes: ros-jazzy-nav2-dwb-controller < 1.3.5-1
