...
Summary:        Meta package for ros2-jazzy-range_sensor_broadcaster and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-range_sensor_broadcaster
Requires:       ros2-jazzy-range_sensor_broadcaster-devel

Obsoletes: ros-jazzy-range-sensor-broadcaster < 4.23.0-1
