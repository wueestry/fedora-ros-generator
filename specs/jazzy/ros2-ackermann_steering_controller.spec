Name:           ros2-jazzy-ackermann_steering_controller
Version:        4.23.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ackermann_steering_controller/4.23.0-1.tar.gz#/ros2-jazzy-ackermann_steering_controller-4.23.0-source0.tar.gz
...
Provides:  ros2-jazzy-ackermann_steering_controller = 4.23.0-1
Obsoletes: ros2-jazzy-ackermann_steering_controller < 4.23.0-1
...
Provides: ros2-jazzy-ackermann_steering_controller-devel = 4.23.0-1
Obsoletes: ros2-jazzy-ackermann_steering_controller-devel < 4.23.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ackermann_steering_controller ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ackermann_steering_controller
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ackermann_steering_controller/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/ackermann_steering_controller ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/ackermann_steering_controller
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/ackermann_steering_controller/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ackermann_steering_controller/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ackermann_steering_controller \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,ackermann_steering_controller/include/,share/ackermann_steering_controller/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/ackermann_steering_controller/{lib*/pkgconfig,include/,cmake/,extra_cmake/,ackermann_steering_controller/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ackermann_steering_controller/{lib*/pkgconfig,include/,cmake/,ackermann_steering_controller/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ackermann_steering_controller/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
