...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ament_cmake_pytest ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ament_cmake_pytest
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ament_cmake_pytest/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/ament_cmake_pytest ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/ament_cmake_pytest
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/ament_cmake_pytest/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ament_cmake_pytest/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/ament_cmake_pytest/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ament_cmake_pytest \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ament_cmake_pytest/{lib*/pkgconfig,include/,cmake/,ament_cmake_pytest/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ament_cmake_pytest/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
