...
Source0:        https://github.com/ros2-gbp/vision_opencv-release/archive/release/jazzy/cv_bridge/4.1.0-1.tar.gz#/ros2-jazzy-cv_bridge-4.1.0-source0.tar.gz
...
Provides:  ros2-jazzy-cv_bridge = 4.1.0-1
Obsoletes: ros2-jazzy-cv_bridge < 4.1.0-1
...
Provides: ros2-jazzy-cv_bridge-devel = 4.1.0-1
Obsoletes: ros2-jazzy-cv_bridge-devel < 4.1.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/cv_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/cv_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/cv_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/cv_bridge ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/cv_bridge
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/cv_bridge/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/cv_bridge/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/cv_bridge \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,cv_bridge/include/,share/cv_bridge/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/cv_bridge/{lib*/pkgconfig,include/,cmake/,extra_cmake/,cv_bridge/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/cv_bridge/{lib*/pkgconfig,include/,cmake/,cv_bridge/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/cv_bridge/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
