...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/demo_nodes_cpp/0.33.4-1.tar.gz#/ros2-jazzy-demo_nodes_cpp-0.33.4-source0.tar.gz
...
Provides:  ros2-jazzy-demo_nodes_cpp = 0.33.4-1
Obsoletes: ros2-jazzy-demo_nodes_cpp < 0.33.4-1
...
Provides: ros2-jazzy-demo_nodes_cpp-devel = 0.33.4-1
Obsoletes: ros2-jazzy-demo_nodes_cpp-devel < 0.33.4-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/demo_nodes_cpp/{lib*/pkgconfig,include/,cmake/,demo_nodes_cpp/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
