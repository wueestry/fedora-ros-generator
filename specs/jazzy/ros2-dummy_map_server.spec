...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/dummy_map_server/0.33.2-2.tar.gz#/ros2-jazzy-dummy_map_server-0.33.2-source0.tar.gz
...
Provides:  ros2-jazzy-dummy_map_server = 0.33.2-1
Obsoletes: ros2-jazzy-dummy_map_server < 0.33.2-1
...
Provides: ros2-jazzy-dummy_map_server-devel = 0.33.2-1
Obsoletes: ros2-jazzy-dummy_map_server-devel < 0.33.2-1
