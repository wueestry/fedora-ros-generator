...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/dummy_sensors/0.33.3-1.tar.gz#/ros2-jazzy-dummy_sensors-0.33.3-source0.tar.gz
...
Provides:  ros2-jazzy-dummy_sensors = 0.33.3-1
Obsoletes: ros2-jazzy-dummy_sensors < 0.33.3-1
...
Provides: ros2-jazzy-dummy_sensors-devel = 0.33.3-1
Obsoletes: ros2-jazzy-dummy_sensors-devel < 0.33.3-1
