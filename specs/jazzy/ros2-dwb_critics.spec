...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_critics/1.3.5-1.tar.gz#/ros2-jazzy-dwb_critics-1.3.5-source0.tar.gz
...
Provides:  ros2-jazzy-dwb_critics = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_critics < 1.3.5-1
...
Provides: ros2-jazzy-dwb_critics-devel = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_critics-devel < 1.3.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_critics ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_critics
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_critics/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_critics ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_critics
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_critics/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_critics/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_critics \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,dwb_critics/include/,share/dwb_critics/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_critics/{lib*/pkgconfig,include/,cmake/,extra_cmake/,dwb_critics/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_critics/{lib*/pkgconfig,include/,cmake/,dwb_critics/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_critics/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
