Name:           ros2-jazzy-dwb_msgs
Version:        1.3.5
Release:        1%{?dist}
Summary:        ROS package dwb_msgs

License:        BSD-3-Clause
URL:            http://www.ros.org/

Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_msgs/1.3.5-1.tar.gz#/ros2-jazzy-dwb_msgs-1.3.5-source0.tar.gz
...
Provides:  ros2-jazzy-dwb_msgs = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_msgs < 1.3.5-1
...
Provides: ros2-jazzy-dwb_msgs-devel = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_msgs-devel < 1.3.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_msgs/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_msgs \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,dwb_msgs/include/,share/dwb_msgs/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_msgs/{lib*/pkgconfig,include/,cmake/,extra_cmake/,dwb_msgs/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_msgs/{lib*/pkgconfig,include/,cmake/,dwb_msgs/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_msgs/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
