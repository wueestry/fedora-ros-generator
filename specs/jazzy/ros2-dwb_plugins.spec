...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_plugins/1.3.5-1.tar.gz#/ros2-jazzy-dwb_plugins-1.3.5-source0.tar.gz
...
Provides:  ros2-jazzy-dwb_plugins = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_plugins < 1.3.5-1
...
Provides: ros2-jazzy-dwb_plugins-devel = 1.3.5-1
Obsoletes: ros2-jazzy-dwb_plugins-devel < 1.3.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_plugins ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_plugins
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/dwb_plugins/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_plugins ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_plugins
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/dwb_plugins/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_plugins/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_plugins \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,dwb_plugins/include/,share/dwb_plugins/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/dwb_plugins/{lib*/pkgconfig,include/,cmake/,extra_cmake/,dwb_plugins/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/dwb_plugins/{lib*/pkgconfig,include/,cmake/,dwb_plugins/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/dwb_plugins/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
