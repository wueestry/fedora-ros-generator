...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/fastrtps_cmake_module ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/fastrtps_cmake_module
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/fastrtps_cmake_module/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/fastrtps_cmake_module ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/fastrtps_cmake_module
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/fastrtps_cmake_module/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/fastrtps_cmake_module/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/fastrtps_cmake_module/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/fastrtps_cmake_module \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/fastrtps_cmake_module/{lib*/pkgconfig,include/,cmake/,fastrtps_cmake_module/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/fastrtps_cmake_module/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
