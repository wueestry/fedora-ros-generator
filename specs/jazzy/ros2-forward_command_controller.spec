...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.7.0-2.tar.gz#/ros2-jazzy-forward_command_controller-4.7.0-source0.tar.gz
...
Provides:  ros2-jazzy-forward_command_controller = 4.7.0-1
Obsoletes: ros2-jazzy-forward_command_controller < 4.7.0-1
...
Provides: ros2-jazzy-forward_command_controller-devel = 4.7.0-1
Obsoletes: ros2-jazzy-forward_command_controller-devel < 4.7.0-1
