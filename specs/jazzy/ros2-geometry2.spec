...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/geometry2/0.36.4-1.tar.gz#/ros2-jazzy-geometry2-0.36.4-source0.tar.gz
...
Provides:  ros2-jazzy-geometry2 = 0.36.4-1
Obsoletes: ros2-jazzy-geometry2 < 0.36.4-1
...
Provides: ros2-jazzy-geometry2-devel = 0.36.4-1
Obsoletes: ros2-jazzy-geometry2-devel < 0.36.4-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/geometry2/{lib*/pkgconfig,include/,cmake/,geometry2/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
