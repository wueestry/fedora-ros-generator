...
Source0:        https://github.com/ros2-gbp/googletest-release/archive/release/jazzy/gmock_vendor/1.14.9000-2.tar.gz#/ros2-jazzy-gmock_vendor-1.14.9000-source0.tar.gz
...
Provides:  ros2-jazzy-gmock_vendor = 1.14.9000-1
Obsoletes: ros2-jazzy-gmock_vendor < 1.14.9000-1
...
Provides: ros2-jazzy-gmock_vendor-devel = 1.14.9000-1
Obsoletes: ros2-jazzy-gmock_vendor-devel < 1.14.9000-1
...
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,src/gmock_vendor/include/,share/gmock_vendor/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/src/gmock_vendor/src
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/src/gmock_vendor/CMakeLists.txt
