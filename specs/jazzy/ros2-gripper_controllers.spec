...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gripper_controllers/4.13.0-1.tar.gz#/ros2-jazzy-gripper_controllers-4.13.0-source0.tar.gz
...
Provides:  ros2-jazzy-gripper_controllers = 4.13.0-1
Obsoletes: ros2-jazzy-gripper_controllers < 4.13.0-1
...
Provides: ros2-jazzy-gripper_controllers-devel = 4.13.0-1
Obsoletes: ros2-jazzy-gripper_controllers-devel < 4.13.0-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/gripper_controllers/{lib*/pkgconfig,include/,cmake/,gripper_controllers/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
