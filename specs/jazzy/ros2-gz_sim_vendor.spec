Name:           ros2-jazzy-gz_sim_vendor
Version:        0.0.8
Release:        1%{?dist}
Summary:        ROS package gz_sim_vendor

License:        Apache License 2.0
URL:            https://github.com/gazebosim/gz-sim

Source0:        https://github.com/ros2-gbp/gz_sim_vendor-release/archive/release/jazzy/gz_sim_vendor/0.0.8-1.tar.gz#/ros2-jazzy-gz_sim_vendor-0.0.8-source0.tar.gz
...
BuildRequires:  ros2-jazzy-gz_fuel_tools_vendor-devel
BuildRequires:  ros2-jazzy-gz_gui_vendor-devel
BuildRequires:  ros2-jazzy-gz_math_vendor-devel
BuildRequires:  ros2-jazzy-gz_msgs_vendor-devel
BuildRequires:  ros2-jazzy-gz_physics_vendor-devel
BuildRequires:  ros2-jazzy-gz_plugin_vendor-devel
BuildRequires:  ros2-jazzy-gz_rendering_vendor-devel
BuildRequires:  ros2-jazzy-gz_sensors_vendor-devel
...
Requires:       ros2-jazzy-gz_rendering_vendor
...
Provides:  ros2-jazzy-gz_sim_vendor = 0.0.8-1
Obsoletes: ros2-jazzy-gz_sim_vendor < 0.0.8-1


# This is required due to a stupid path in gz_cmake_vendor
...
Requires:       protobuf-devel protobuf-compiler
...
Requires:       ros2-jazzy-gz_rendering_vendor-devel
...
Provides: ros2-jazzy-gz_sim_vendor-devel = 0.0.8-1
Obsoletes: ros2-jazzy-gz_sim_vendor-devel < 0.0.8-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/gz_sim_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/gz_sim_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/gz_sim_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/gz_sim_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/gz_sim_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/gz_sim_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/gz_sim_vendor/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/gz_sim_vendor \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,gz_sim_vendor/include/,share/gz_sim_vendor/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/{lib*/pkgconfig,include/,cmake/,extra_cmake/,gz_sim_vendor/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/gz_sim_vendor/{lib*/pkgconfig,include/,cmake/,gz_sim_vendor/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/gz_sim_vendor/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
* Wed Nov 20 2024 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - jazzy.0.0.6-1
- Update to latest release
