...
Source0:        https://github.com/ros2-gbp/gz_sim_vendor-release/archive/release/jazzy/gz_sim_vendor/0.0.5-1.tar.gz#/ros2-jazzy-gz_sim_vendor-0.0.5-source0.tar.gz
...
Provides:  ros2-jazzy-gz_sim_vendor = 0.0.5-1
Obsoletes: ros2-jazzy-gz_sim_vendor < 0.0.5-1
...
Provides: ros2-jazzy-gz_sim_vendor-devel = 0.0.5-1
Obsoletes: ros2-jazzy-gz_sim_vendor-devel < 0.0.5-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/gz_sim_vendor/{lib*/pkgconfig,include/,cmake/,gz_sim_vendor/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
