...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/iceoryx_binding_c ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/iceoryx_binding_c
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/iceoryx_binding_c/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/iceoryx_binding_c ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/iceoryx_binding_c
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/iceoryx_binding_c/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/iceoryx_binding_c/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/iceoryx_binding_c/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/iceoryx_binding_c \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/iceoryx_binding_c/{lib*/pkgconfig,include/,cmake/,iceoryx_binding_c/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/iceoryx_binding_c/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
