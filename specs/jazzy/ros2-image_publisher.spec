Name:           ros2-jazzy-image_publisher
Version:        5.0.9
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_publisher/5.0.9-1.tar.gz#/ros2-jazzy-image_publisher-5.0.9-source0.tar.gz
...
BuildRequires:  ros2-jazzy-camera_info_manager-devel
...
Provides:  ros2-jazzy-image_publisher = 5.0.9-1
Obsoletes: ros2-jazzy-image_publisher < 5.0.9-1
...
Provides: ros2-jazzy-image_publisher-devel = 5.0.9-1
Obsoletes: ros2-jazzy-image_publisher-devel < 5.0.9-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/image_publisher ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/image_publisher
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/image_publisher/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/image_publisher ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/image_publisher
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/image_publisher/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_publisher/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_publisher \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,image_publisher/include/,share/image_publisher/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/image_publisher/{lib*/pkgconfig,include/,cmake/,extra_cmake/,image_publisher/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_publisher/{lib*/pkgconfig,include/,cmake/,image_publisher/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_publisher/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
