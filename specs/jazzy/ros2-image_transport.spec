...
Source0:        https://github.com/ros2-gbp/image_common-release/archive/release/jazzy/image_transport/5.1.6-1.tar.gz#/ros2-jazzy-image_transport-5.1.6-source0.tar.gz
...
Provides:  ros2-jazzy-image_transport = 5.1.6-1
Obsoletes: ros2-jazzy-image_transport < 5.1.6-1
...
Provides: ros2-jazzy-image_transport-devel = 5.1.6-1
Obsoletes: ros2-jazzy-image_transport-devel < 5.1.6-1
...
colcon \
  ...
  --packages-select image_transport
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/image_transport ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/image_transport
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/image_transport/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/image_transport ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/image_transport
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/image_transport/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_transport/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_transport \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,image_transport/include/,share/image_transport/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/image_transport/{lib*/pkgconfig,include/,cmake/,extra_cmake/,image_transport/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/image_transport/{lib*/pkgconfig,include/,cmake/,image_transport/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/image_transport/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
