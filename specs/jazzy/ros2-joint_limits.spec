...
Source0:        https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.28.0-1.tar.gz#/ros2-jazzy-joint_limits-4.28.0-source0.tar.gz
...
Provides:  ros2-jazzy-joint_limits = 4.28.0-1
Obsoletes: ros2-jazzy-joint_limits < 4.28.0-1
...
Provides: ros2-jazzy-joint_limits-devel = 4.28.0-1
Obsoletes: ros2-jazzy-joint_limits-devel < 4.28.0-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_limits ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_limits
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_limits/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_limits ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_limits
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_limits/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_limits/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_limits \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,joint_limits/include/,share/joint_limits/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_limits/{lib*/pkgconfig,include/,cmake/,extra_cmake/,joint_limits/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_limits/{lib*/pkgconfig,include/,cmake/,joint_limits/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_limits/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
