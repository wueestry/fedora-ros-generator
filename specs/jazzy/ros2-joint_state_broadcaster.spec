...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_state_broadcaster/4.13.0-1.tar.gz#/ros2-jazzy-joint_state_broadcaster-4.13.0-source0.tar.gz
...
Provides:  ros2-jazzy-joint_state_broadcaster = 4.13.0-1
Obsoletes: ros2-jazzy-joint_state_broadcaster < 4.13.0-1
...
Provides: ros2-jazzy-joint_state_broadcaster-devel = 4.13.0-1
Obsoletes: ros2-jazzy-joint_state_broadcaster-devel < 4.13.0-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/{lib*/pkgconfig,include/,cmake/,joint_state_broadcaster/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
