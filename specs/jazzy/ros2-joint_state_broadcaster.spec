Name:           ros2-jazzy-joint_state_broadcaster
Version:        4.23.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_state_broadcaster/4.23.0-1.tar.gz#/ros2-jazzy-joint_state_broadcaster-4.23.0-source0.tar.gz
...
Provides:  ros2-jazzy-joint_state_broadcaster = 4.23.0-1
Obsoletes: ros2-jazzy-joint_state_broadcaster < 4.23.0-1
...
Provides: ros2-jazzy-joint_state_broadcaster-devel = 4.23.0-1
Obsoletes: ros2-jazzy-joint_state_broadcaster-devel < 4.23.0-1
...
colcon \
  ...
  --packages-select joint_state_broadcaster
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_state_broadcaster ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_state_broadcaster
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/joint_state_broadcaster/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_state_broadcaster ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_state_broadcaster
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/joint_state_broadcaster/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_state_broadcaster/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_state_broadcaster \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,joint_state_broadcaster/include/,share/joint_state_broadcaster/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/joint_state_broadcaster/{lib*/pkgconfig,include/,cmake/,extra_cmake/,joint_state_broadcaster/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/joint_state_broadcaster/{lib*/pkgconfig,include/,cmake/,joint_state_broadcaster/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/joint_state_broadcaster/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
