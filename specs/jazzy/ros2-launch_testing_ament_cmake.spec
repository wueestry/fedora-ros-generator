...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/launch_testing_ament_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/launch_testing_ament_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/launch_testing_ament_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/launch_testing_ament_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/launch_testing_ament_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/launch_testing_ament_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/launch_testing_ament_cmake/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/launch_testing_ament_cmake/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/launch_testing_ament_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/launch_testing_ament_cmake/{lib*/pkgconfig,include/,cmake/,launch_testing_ament_cmake/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/launch_testing_ament_cmake/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
