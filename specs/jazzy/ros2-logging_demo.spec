...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/logging_demo/0.33.4-1.tar.gz#/ros2-jazzy-logging_demo-0.33.4-source0.tar.gz
...
Provides:  ros2-jazzy-logging_demo = 0.33.4-1
Obsoletes: ros2-jazzy-logging_demo < 0.33.4-1
...
Provides: ros2-jazzy-logging_demo-devel = 0.33.4-1
Obsoletes: ros2-jazzy-logging_demo-devel < 0.33.4-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/{lib*/pkgconfig,include/,cmake/,logging_demo/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
