...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/logging_demo/0.33.5-1.tar.gz#/ros2-jazzy-logging_demo-0.33.5-source0.tar.gz
...
Provides:  ros2-jazzy-logging_demo = 0.33.5-1
Obsoletes: ros2-jazzy-logging_demo < 0.33.5-1
...
Provides: ros2-jazzy-logging_demo-devel = 0.33.5-1
Obsoletes: ros2-jazzy-logging_demo-devel < 0.33.5-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/logging_demo ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/logging_demo
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/logging_demo/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/logging_demo ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/logging_demo
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/logging_demo/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/logging_demo/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/logging_demo \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,logging_demo/include/,share/logging_demo/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/logging_demo/{lib*/pkgconfig,include/,cmake/,extra_cmake/,logging_demo/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/logging_demo/{lib*/pkgconfig,include/,cmake/,logging_demo/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/logging_demo/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
