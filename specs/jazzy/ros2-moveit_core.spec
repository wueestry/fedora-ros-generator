...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_core/2.12.2-1.tar.gz#/ros2-jazzy-moveit_core-2.12.2-source0.tar.gz
...
BuildRequires:  ros2-jazzy-common_interfaces-devel
BuildRequires:  ros2-jazzy-eigen3_cmake_module-devel
BuildRequires:  ros2-jazzy-eigen_stl_containers-devel
...
BuildRequires:  ros2-jazzy-google_benchmark_vendor-devel
BuildRequires:  ros2-jazzy-kdl_parser-devel
BuildRequires:  ros2-jazzy-moveit_common-devel
BuildRequires:  ros2-jazzy-moveit_msgs-devel
BuildRequires:  ros2-jazzy-octomap_msgs-devel
BuildRequires:  ros2-jazzy-osqp_vendor-devel
BuildRequires:  ros2-jazzy-pluginlib-devel
BuildRequires:  ros2-jazzy-random_numbers-devel
BuildRequires:  ros2-jazzy-rclcpp-devel
BuildRequires:  ros2-jazzy-rsl-devel
BuildRequires:  ros2-jazzy-ruckig-devel
...
BuildRequires:  ros2-jazzy-urdfdom-devel
BuildRequires:  ros2-jazzy-urdfdom_headers-devel
...
Provides:  ros2-jazzy-moveit_core = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_core < 2.12.2-1
...
Provides: ros2-jazzy-moveit_core-devel = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_core-devel < 2.12.2-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_core ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_core
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_core/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_core ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_core
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_core/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_core/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_core \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,moveit_core/include/,share/moveit_core/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_core/{lib*/pkgconfig,include/,cmake/,extra_cmake/,moveit_core/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_core/{lib*/pkgconfig,include/,cmake/,moveit_core/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_core/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
