Name:           ros2-jazzy-moveit_hybrid_planning
Version:        2.12.2
Release:        1%{?dist}
Summary:        ROS package moveit_hybrid_planning

License:        BSD-3-Clause
URL:            http://moveit.ros.org

Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_hybrid_planning/2.12.2-1.tar.gz#/ros2-jazzy-moveit_hybrid_planning-2.12.2-source0.tar.gz
...
Provides:  ros2-jazzy-moveit_hybrid_planning = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_hybrid_planning < 2.12.2-1
...
Provides: ros2-jazzy-moveit_hybrid_planning-devel = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_hybrid_planning-devel < 2.12.2-1
...
colcon \
  ...
  --packages-select moveit_hybrid_planning
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_hybrid_planning ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_hybrid_planning
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_hybrid_planning/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_hybrid_planning ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_hybrid_planning
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_hybrid_planning/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_hybrid_planning/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_hybrid_planning \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,moveit_hybrid_planning/include/,share/moveit_hybrid_planning/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_hybrid_planning/{lib*/pkgconfig,include/,cmake/,extra_cmake/,moveit_hybrid_planning/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_hybrid_planning/{lib*/pkgconfig,include/,cmake/,moveit_hybrid_planning/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_hybrid_planning/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
