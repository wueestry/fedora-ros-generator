...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_ros_planning/2.10.0-1.tar.gz#/ros2-jazzy-moveit_ros_planning-2.10.0-source0.tar.gz
...
Provides:  ros2-jazzy-moveit_ros_planning = 2.10.0-1
Obsoletes: ros2-jazzy-moveit_ros_planning < 2.10.0-1
...
Provides: ros2-jazzy-moveit_ros_planning-devel = 2.10.0-1
Obsoletes: ros2-jazzy-moveit_ros_planning-devel < 2.10.0-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_ros_planning/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
