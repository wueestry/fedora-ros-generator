...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_ros_warehouse/2.12.2-1.tar.gz#/ros2-jazzy-moveit_ros_warehouse-2.12.2-source0.tar.gz
...
Provides:  ros2-jazzy-moveit_ros_warehouse = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_ros_warehouse < 2.12.2-1
...
Provides: ros2-jazzy-moveit_ros_warehouse-devel = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_ros_warehouse-devel < 2.12.2-1
...
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_ros_warehouse ]; then
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_ros_warehouse/{lib*/pkgconfig,include/,cmake/,extra_cmake/,moveit_ros_warehouse/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
