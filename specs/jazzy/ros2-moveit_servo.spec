...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_servo/2.12.2-1.tar.gz#/ros2-jazzy-moveit_servo-2.12.2-source0.tar.gz
...
Provides:  ros2-jazzy-moveit_servo = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_servo < 2.12.2-1
...
Provides: ros2-jazzy-moveit_servo-devel = 2.12.2-1
Obsoletes: ros2-jazzy-moveit_servo-devel < 2.12.2-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_servo ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_servo
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/moveit_servo/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_servo ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_servo
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/moveit_servo/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_servo/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_servo \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,moveit_servo/include/,share/moveit_servo/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_servo/{lib*/pkgconfig,include/,cmake/,extra_cmake/,moveit_servo/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/moveit_servo/{lib*/pkgconfig,include/,cmake/,moveit_servo/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/moveit_servo/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
