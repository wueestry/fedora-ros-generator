...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_setup_framework/2.10.0-1.tar.gz#/ros2-jazzy-moveit_setup_framework-2.10.0-source0.tar.gz
...
Provides:  ros2-jazzy-moveit_setup_framework = 2.10.0-1
Obsoletes: ros2-jazzy-moveit_setup_framework < 2.10.0-1
...
Provides: ros2-jazzy-moveit_setup_framework-devel = 2.10.0-1
Obsoletes: ros2-jazzy-moveit_setup_framework-devel < 2.10.0-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/moveit_setup_framework/{lib*/pkgconfig,include/,cmake/,moveit_setup_framework/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
