Name:           ros2-jazzy-nav2_graceful_controller
Version:        1.3.5
Release:        1%{?dist}
Summary:        ROS package nav2_graceful_controller

License:        Apache-2.0
URL:            http://www.ros.org/

Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_graceful_controller/1.3.5-1.tar.gz#/ros2-jazzy-nav2_graceful_controller-1.3.5-source0.tar.gz
...
Provides:  ros2-jazzy-nav2_graceful_controller = 1.3.5-1
Obsoletes: ros2-jazzy-nav2_graceful_controller < 1.3.5-1
...
Provides: ros2-jazzy-nav2_graceful_controller-devel = 1.3.5-1
Obsoletes: ros2-jazzy-nav2_graceful_controller-devel < 1.3.5-1
...
colcon \
  ...
  --packages-select nav2_graceful_controller
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/nav2_graceful_controller ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/nav2_graceful_controller
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/nav2_graceful_controller/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/nav2_graceful_controller ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/nav2_graceful_controller
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/nav2_graceful_controller/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/nav2_graceful_controller/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/nav2_graceful_controller \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,nav2_graceful_controller/include/,share/nav2_graceful_controller/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/nav2_graceful_controller/{lib*/pkgconfig,include/,cmake/,extra_cmake/,nav2_graceful_controller/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/nav2_graceful_controller/{lib*/pkgconfig,include/,cmake/,nav2_graceful_controller/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/nav2_graceful_controller/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
