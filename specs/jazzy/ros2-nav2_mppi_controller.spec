...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_mppi_controller/1.3.5-1.tar.gz#/ros2-jazzy-nav2_mppi_controller-1.3.5-source0.tar.gz
...
Provides:  ros2-jazzy-nav2_mppi_controller = 1.3.5-1
Obsoletes: ros2-jazzy-nav2_mppi_controller < 1.3.5-1
...
Provides: ros2-jazzy-nav2_mppi_controller-devel = 1.3.5-1
Obsoletes: ros2-jazzy-nav2_mppi_controller-devel < 1.3.5-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/nav2_mppi_controller/{lib*/pkgconfig,include/,cmake/,extra_cmake/,nav2_mppi_controller/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
