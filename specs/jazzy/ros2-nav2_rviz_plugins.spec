...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_rviz_plugins/1.3.2-1.tar.gz#/ros2-jazzy-nav2_rviz_plugins-1.3.2-source0.tar.gz
...
Provides:  ros2-jazzy-nav2_rviz_plugins = 1.3.2-1
Obsoletes: ros2-jazzy-nav2_rviz_plugins < 1.3.2-1
...
Provides: ros2-jazzy-nav2_rviz_plugins-devel = 1.3.2-1
Obsoletes: ros2-jazzy-nav2_rviz_plugins-devel < 1.3.2-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/nav2_rviz_plugins/{lib*/pkgconfig,include/,cmake/,nav2_rviz_plugins/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
