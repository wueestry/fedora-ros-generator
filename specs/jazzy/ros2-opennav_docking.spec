Name:           ros2-jazzy-opennav_docking
Version:        1.3.5
Release:        1%{?dist}
Summary:        ROS package opennav_docking

License:        Apache-2.0
URL:            http://www.ros.org/

Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/opennav_docking/1.3.5-1.tar.gz#/ros2-jazzy-opennav_docking-1.3.5-source0.tar.gz
...
Requires:       ros2-jazzy-nav2_graceful_controller
...
Provides:  ros2-jazzy-opennav_docking = 1.3.5-1
Obsoletes: ros2-jazzy-opennav_docking < 1.3.5-1
...
Requires:       ros2-jazzy-nav2_graceful_controller-devel
...
Provides: ros2-jazzy-opennav_docking-devel = 1.3.5-1
Obsoletes: ros2-jazzy-opennav_docking-devel < 1.3.5-1
...
colcon \
  ...
  --packages-select opennav_docking
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/opennav_docking ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/opennav_docking
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/opennav_docking/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/opennav_docking ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/opennav_docking
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/opennav_docking/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/opennav_docking/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/opennav_docking \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,opennav_docking/include/,share/opennav_docking/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/opennav_docking/{lib*/pkgconfig,include/,cmake/,extra_cmake/,opennav_docking/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/opennav_docking/{lib*/pkgconfig,include/,cmake/,opennav_docking/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/opennav_docking/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
