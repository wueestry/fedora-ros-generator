...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/orocos_kdl_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/orocos_kdl_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/orocos_kdl_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/orocos_kdl_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/orocos_kdl_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/orocos_kdl_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/orocos_kdl_vendor/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/orocos_kdl_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/orocos_kdl_vendor \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/orocos_kdl_vendor/{lib*/pkgconfig,include/,cmake/,orocos_kdl_vendor/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/orocos_kdl_vendor/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
