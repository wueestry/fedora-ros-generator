...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/parameter_traits ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/parameter_traits
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/parameter_traits/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/parameter_traits ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/parameter_traits
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/parameter_traits/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/parameter_traits/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/parameter_traits/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/parameter_traits \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/parameter_traits/{lib*/pkgconfig,include/,cmake/,parameter_traits/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/parameter_traits/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
