...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/pilz_industrial_motion_planner/2.9.0-1.tar.gz#/ros2-jazzy-pilz_industrial_motion_planner-2.9.0-source0.tar.gz
...
BuildRequires:  ros2-jazzy-launch_param_builder-devel
...
BuildRequires:  ros2-jazzy-moveit_resources_panda_moveit_config-devel
BuildRequires:  ros2-jazzy-moveit_resources_prbt_moveit_config-devel
BuildRequires:  ros2-jazzy-moveit_resources_prbt_pg70_support-devel
BuildRequires:  ros2-jazzy-moveit_resources_prbt_support-devel
...
BuildRequires:  ros2-jazzy-pilz_industrial_motion_planner_testutils-devel
BuildRequires:  ros2-jazzy-pluginlib-devel
BuildRequires:  ros2-jazzy-rclcpp-devel
BuildRequires:  ros2-jazzy-ros_testing-devel
...
Provides:  ros2-jazzy-pilz_industrial_motion_planner = 2.9.0-1
Obsoletes: ros2-jazzy-pilz_industrial_motion_planner < 2.9.0-1
...
Provides: ros2-jazzy-pilz_industrial_motion_planner-devel = 2.9.0-1
Obsoletes: ros2-jazzy-pilz_industrial_motion_planner-devel < 2.9.0-1
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/pilz_industrial_motion_planner
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/share %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/share -type f -exec sed -i "s:opt/pilz_industrial_motion_planner/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/bin %{buildroot}/%{_libdir}/ros2-jazzy/
# fi
# 
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/extra_cmake %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake -type f -exec sed -i "s:opt/pilz_industrial_motion_planner/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/lib %{buildroot}/%{_libdir}/ros2-jazzy/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/lib64 %{buildroot}/%{_libdir}/ros2-jazzy/lib64
# fi
