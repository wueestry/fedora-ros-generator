Name:           ros2-jazzy-pilz_industrial_motion_planner
Version:        2.12.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/pilz_industrial_motion_planner/2.12.2-1.tar.gz#/ros2-jazzy-pilz_industrial_motion_planner-2.12.2-source0.tar.gz
...
BuildRequires:  ros2-jazzy-moveit_msgs-devel
BuildRequires:  ros2-jazzy-moveit_ros_move_group-devel
BuildRequires:  ros2-jazzy-moveit_ros_planning-devel
BuildRequires:  ros2-jazzy-orocos_kdl_vendor-devel
...
Provides:  ros2-jazzy-pilz_industrial_motion_planner = 2.12.2-1
Obsoletes: ros2-jazzy-pilz_industrial_motion_planner < 2.12.2-1
...
Provides: ros2-jazzy-pilz_industrial_motion_planner-devel = 2.12.2-1
Obsoletes: ros2-jazzy-pilz_industrial_motion_planner-devel < 2.12.2-1
...
colcon \
  ...
  --packages-select pilz_industrial_motion_planner
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/pilz_industrial_motion_planner ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/pilz_industrial_motion_planner
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/pilz_industrial_motion_planner/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/pilz_industrial_motion_planner ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/pilz_industrial_motion_planner
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/pilz_industrial_motion_planner/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/pilz_industrial_motion_planner/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/pilz_industrial_motion_planner \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,share/pilz_industrial_motion_planner/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/pilz_industrial_motion_planner/{lib*/pkgconfig,include/,cmake/,extra_cmake/,pilz_industrial_motion_planner/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/pilz_industrial_motion_planner/{lib*/pkgconfig,include/,cmake/,pilz_industrial_motion_planner/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/pilz_industrial_motion_planner/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
