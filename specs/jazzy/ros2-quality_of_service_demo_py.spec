...
Source0:        https://github.com/ros2-gbp/demos-release/archive/release/jazzy/quality_of_service_demo_py/0.33.5-1.tar.gz#/ros2-jazzy-quality_of_service_demo_py-0.33.5-source0.tar.gz
...
Provides:  ros2-jazzy-quality_of_service_demo_py = 0.33.5-1
Obsoletes: ros2-jazzy-quality_of_service_demo_py < 0.33.5-1
...
Provides: ros2-jazzy-quality_of_service_demo_py-devel = 0.33.5-1
Obsoletes: ros2-jazzy-quality_of_service_demo_py-devel < 0.33.5-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/quality_of_service_demo_py/{lib*/pkgconfig,include/,cmake/,extra_cmake/,quality_of_service_demo_py/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
