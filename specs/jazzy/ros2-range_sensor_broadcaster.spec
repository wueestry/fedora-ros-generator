...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.7.0-2.tar.gz#/ros2-jazzy-range_sensor_broadcaster-4.7.0-source0.tar.gz
...
Provides:  ros2-jazzy-range_sensor_broadcaster = 4.7.0-1
Obsoletes: ros2-jazzy-range_sensor_broadcaster < 4.7.0-1
...
Provides: ros2-jazzy-range_sensor_broadcaster-devel = 4.7.0-1
Obsoletes: ros2-jazzy-range_sensor_broadcaster-devel < 4.7.0-1
