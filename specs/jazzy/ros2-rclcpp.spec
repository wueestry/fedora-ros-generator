...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.1-1.tar.gz#/ros2-jazzy-rclcpp-28.1.1-source0.tar.gz
...
Provides:  ros2-jazzy-rclcpp = 28.1.1-1
Obsoletes: ros2-jazzy-rclcpp < 28.1.1-1
...
Provides: ros2-jazzy-rclcpp-devel = 28.1.1-1
Obsoletes: ros2-jazzy-rclcpp-devel < 28.1.1-1
