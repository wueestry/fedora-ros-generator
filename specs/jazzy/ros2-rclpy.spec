...
Source0:        https://github.com/ros2-gbp/rclpy-release/archive/release/jazzy/rclpy/7.1.1-2.tar.gz#/ros2-jazzy-rclpy-7.1.1-source0.tar.gz
...
Provides:  ros2-jazzy-rclpy = 7.1.1-1
Obsoletes: ros2-jazzy-rclpy < 7.1.1-1
...
Provides: ros2-jazzy-rclpy-devel = 7.1.1-1
Obsoletes: ros2-jazzy-rclpy-devel < 7.1.1-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rclpy/{lib*/pkgconfig,include/,cmake/,rclpy/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
