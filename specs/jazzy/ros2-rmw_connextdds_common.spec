Name:           ros2-jazzy-rmw_connextdds_common
Version:        0.22.1
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/jazzy/rmw_connextdds_common/0.22.1-1.tar.gz#/ros2-jazzy-rmw_connextdds_common-0.22.1-source0.tar.gz
...
BuildRequires:  ros2-jazzy-rti_connext_dds_cmake_module-devel
...
Provides:  ros2-jazzy-rmw_connextdds_common = 0.22.1-1
Obsoletes: ros2-jazzy-rmw_connextdds_common < 0.22.1-1
...
Provides: ros2-jazzy-rmw_connextdds_common-devel = 0.22.1-1
Obsoletes: ros2-jazzy-rmw_connextdds_common-devel < 0.22.1-1
...
colcon \
  ...
  --packages-select rmw_connextdds_common
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_connextdds_common ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_connextdds_common
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_connextdds_common/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_connextdds_common ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_connextdds_common
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_connextdds_common/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_connextdds_common/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_connextdds_common \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,rmw_connextdds_common/include/,share/rmw_connextdds_common/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_connextdds_common/{lib*/pkgconfig,include/,cmake/,extra_cmake/,rmw_connextdds_common/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_connextdds_common/{lib*/pkgconfig,include/,cmake/,rmw_connextdds_common/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_connextdds_common/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
