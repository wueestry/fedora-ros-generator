Name:           ros2-jazzy-rmw_dds_common
Version:        3.1.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rmw_dds_common-release/archive/release/jazzy/rmw_dds_common/3.1.0-2.tar.gz#/ros2-jazzy-rmw_dds_common-3.1.0-source0.tar.gz
...
Provides:  ros2-jazzy-rmw_dds_common = 3.1.0-1
Obsoletes: ros2-jazzy-rmw_dds_common < 3.1.0-1
...
Provides: ros2-jazzy-rmw_dds_common-devel = 3.1.0-1
Obsoletes: ros2-jazzy-rmw_dds_common-devel < 3.1.0-1
...
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_dds_common ]; then
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_dds_common/{lib*/pkgconfig,include/,cmake/,extra_cmake/,rmw_dds_common/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
