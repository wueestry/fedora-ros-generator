Name:           ros2-jazzy-rmw_fastrtps_cpp
Version:        8.4.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/jazzy/rmw_fastrtps_cpp/8.4.2-1.tar.gz#/ros2-jazzy-rmw_fastrtps_cpp-8.4.2-source0.tar.gz
...
BuildRequires:  ros2-jazzy-rmw_fastrtps_shared_cpp-devel
BuildRequires:  ros2-jazzy-rosidl_dynamic_typesupport-devel
BuildRequires:  ros2-jazzy-rosidl_dynamic_typesupport_fastrtps-devel
...
Provides:  ros2-jazzy-rmw_fastrtps_cpp = 8.4.2-1
Obsoletes: ros2-jazzy-rmw_fastrtps_cpp < 8.4.2-1
...
Provides: ros2-jazzy-rmw_fastrtps_cpp-devel = 8.4.2-1
Obsoletes: ros2-jazzy-rmw_fastrtps_cpp-devel < 8.4.2-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_fastrtps_cpp ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_fastrtps_cpp
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_fastrtps_cpp/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_fastrtps_cpp ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_fastrtps_cpp
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/rmw_fastrtps_cpp/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_fastrtps_cpp/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_fastrtps_cpp \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,rmw_fastrtps_cpp/include/,share/rmw_fastrtps_cpp/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/{lib*/pkgconfig,include/,cmake/,extra_cmake/,rmw_fastrtps_cpp/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_cpp/{lib*/pkgconfig,include/,cmake/,rmw_fastrtps_cpp/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/rmw_fastrtps_cpp/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
