...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/jazzy/rmw_fastrtps_cpp/8.4.1-1.tar.gz#/ros2-jazzy-rmw_fastrtps_cpp-8.4.1-source0.tar.gz
...
Provides:  ros2-jazzy-rmw_fastrtps_cpp = 8.4.1-1
Obsoletes: ros2-jazzy-rmw_fastrtps_cpp < 8.4.1-1
...
Provides: ros2-jazzy-rmw_fastrtps_cpp-devel = 8.4.1-1
Obsoletes: ros2-jazzy-rmw_fastrtps_cpp-devel < 8.4.1-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rmw_fastrtps_cpp/{lib*/pkgconfig,include/,cmake/,rmw_fastrtps_cpp/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
