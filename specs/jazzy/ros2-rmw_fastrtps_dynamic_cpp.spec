...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/jazzy/rmw_fastrtps_dynamic_cpp/8.4.0-2.tar.gz#/ros2-jazzy-rmw_fastrtps_dynamic_cpp-8.4.0-source0.tar.gz
...
Provides:  ros2-jazzy-rmw_fastrtps_dynamic_cpp = 8.4.0-1
Obsoletes: ros2-jazzy-rmw_fastrtps_dynamic_cpp < 8.4.0-1
...
Provides: ros2-jazzy-rmw_fastrtps_dynamic_cpp-devel = 8.4.0-1
Obsoletes: ros2-jazzy-rmw_fastrtps_dynamic_cpp-devel < 8.4.0-1
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/rmw_fastrtps_dynamic_cpp
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/share %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/share -type f -exec sed -i "s:opt/rmw_fastrtps_dynamic_cpp/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/bin %{buildroot}/%{_libdir}/ros2-jazzy/
# fi
# 
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/extra_cmake %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake -type f -exec sed -i "s:opt/rmw_fastrtps_dynamic_cpp/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/lib %{buildroot}/%{_libdir}/ros2-jazzy/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rmw_fastrtps_dynamic_cpp/lib64 %{buildroot}/%{_libdir}/ros2-jazzy/lib64
# fi
