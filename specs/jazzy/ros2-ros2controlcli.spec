Name:           ros2-jazzy-ros2controlcli
Version:        4.28.0
Release:        1%{?dist}
Summary:        ROS package ros2controlcli

License:        Apache License 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/ros2controlcli/4.28.0-1.tar.gz#/ros2-jazzy-ros2controlcli-4.28.0-source0.tar.gz
...
BuildRequires:  ros2-jazzy-ros2node-devel
...
Provides:  ros2-jazzy-ros2controlcli = 4.28.0-1
Obsoletes: ros2-jazzy-ros2controlcli < 4.28.0-1
...
Provides: ros2-jazzy-ros2controlcli-devel = 4.28.0-1
Obsoletes: ros2-jazzy-ros2controlcli-devel < 4.28.0-1
...
colcon \
  ...
  --packages-select ros2controlcli
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2controlcli ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2controlcli
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2controlcli/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/ros2controlcli ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/ros2controlcli
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/ros2controlcli/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros2controlcli/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros2controlcli \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,ros2controlcli/include/,share/ros2controlcli/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/ros2controlcli/{lib*/pkgconfig,include/,cmake/,extra_cmake/,ros2controlcli/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2controlcli/{lib*/pkgconfig,include/,cmake/,ros2controlcli/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros2controlcli/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
