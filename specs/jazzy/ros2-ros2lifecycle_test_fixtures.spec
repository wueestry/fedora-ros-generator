Name:           ros2-jazzy-ros2lifecycle_test_fixtures
Version:        0.32.1
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2lifecycle_test_fixtures/0.32.1-1.tar.gz#/ros2-jazzy-ros2lifecycle_test_fixtures-0.32.1-source0.tar.gz
...
Provides:  ros2-jazzy-ros2lifecycle_test_fixtures = 0.32.1-1
Obsoletes: ros2-jazzy-ros2lifecycle_test_fixtures < 0.32.1-1
...
Provides: ros2-jazzy-ros2lifecycle_test_fixtures-devel = 0.32.1-1
Obsoletes: ros2-jazzy-ros2lifecycle_test_fixtures-devel < 0.32.1-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2lifecycle_test_fixtures ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2lifecycle_test_fixtures
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ros2lifecycle_test_fixtures
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/share %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/share -type f -exec sed -i "s:opt/ros2lifecycle_test_fixtures/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/bin %{buildroot}/%{_libdir}/ros2-jazzy/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/extra_cmake %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake -type f -exec sed -i "s:opt/ros2lifecycle_test_fixtures/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/lib %{buildroot}/%{_libdir}/ros2-jazzy/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros2lifecycle_test_fixtures/lib64 %{buildroot}/%{_libdir}/ros2-jazzy/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,ros2lifecycle_test_fixtures/include/,share/ros2lifecycle_test_fixtures/cmake} \
