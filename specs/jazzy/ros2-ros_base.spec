...
Source0:        https://github.com/ros2-gbp/variants-release/archive/release/jazzy/ros_base/0.10.0-4.tar.gz#/ros2-jazzy-ros_base-0.10.0-source0.tar.gz
...
Provides:  ros2-jazzy-ros_base = 0.10.0-1
Obsoletes: ros2-jazzy-ros_base < 0.10.0-1
...
Provides: ros2-jazzy-ros_base-devel = 0.10.0-1
Obsoletes: ros2-jazzy-ros_base-devel < 0.10.0-1
