...
Source0:        https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_image/1.0.11-1.tar.gz#/ros2-jazzy-ros_gz_image-1.0.11-source0.tar.gz
...
Provides:  ros2-jazzy-ros_gz_image = 1.0.11-1
Obsoletes: ros2-jazzy-ros_gz_image < 1.0.11-1
...
Provides: ros2-jazzy-ros_gz_image-devel = 1.0.11-1
Obsoletes: ros2-jazzy-ros_gz_image-devel < 1.0.11-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ros_gz_image ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ros_gz_image
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ros_gz_image/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/ros_gz_image ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/ros_gz_image
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/ros_gz_image/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros_gz_image/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros_gz_image \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,ros_gz_image/include/,share/ros_gz_image/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/ros_gz_image/{lib*/pkgconfig,include/,cmake/,extra_cmake/,ros_gz_image/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ros_gz_image/{lib*/pkgconfig,include/,cmake/,ros_gz_image/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ros_gz_image/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
