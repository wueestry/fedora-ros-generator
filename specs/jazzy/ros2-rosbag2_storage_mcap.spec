...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage_mcap/0.26.6-1.tar.gz#/ros2-jazzy-rosbag2_storage_mcap-0.26.6-source0.tar.gz
...
Provides:  ros2-jazzy-rosbag2_storage_mcap = 0.26.6-1
Obsoletes: ros2-jazzy-rosbag2_storage_mcap < 0.26.6-1
...
Provides: ros2-jazzy-rosbag2_storage_mcap-devel = 0.26.6-1
Obsoletes: ros2-jazzy-rosbag2_storage_mcap-devel < 0.26.6-1
...
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/rosbag2_storage_mcap ]; then
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rosbag2_storage_mcap/{lib*/pkgconfig,include/,cmake/,extra_cmake/,rosbag2_storage_mcap/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
