...
Source0:        https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_adapter/4.6.2-1.tar.gz#/ros2-jazzy-rosidl_adapter-4.6.2-source0.tar.gz
...
Provides:  ros2-jazzy-rosidl_adapter = 4.6.2-1
Obsoletes: ros2-jazzy-rosidl_adapter < 4.6.2-1
...
Provides: ros2-jazzy-rosidl_adapter-devel = 4.6.2-1
Obsoletes: ros2-jazzy-rosidl_adapter-devel < 4.6.2-1
