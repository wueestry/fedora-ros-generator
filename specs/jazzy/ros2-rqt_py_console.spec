Name:           ros2-jazzy-rqt_py_console
Version:        1.2.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rqt_py_console-release/archive/release/jazzy/rqt_py_console/1.2.2-3.tar.gz#/ros2-jazzy-rqt_py_console-1.2.2-source0.tar.gz
...
Provides:  ros2-jazzy-rqt_py_console = 1.2.2-1
Obsoletes: ros2-jazzy-rqt_py_console < 1.2.2-1
...
Provides: ros2-jazzy-rqt_py_console-devel = 1.2.2-1
Obsoletes: ros2-jazzy-rqt_py_console-devel < 1.2.2-1
...
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/rqt_py_console ]; then
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rqt_py_console/{lib*/pkgconfig,include/,cmake/,extra_cmake/,rqt_py_console/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
