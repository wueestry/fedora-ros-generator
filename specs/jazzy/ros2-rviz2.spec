...
Source0:        https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz2/14.1.4-1.tar.gz#/ros2-jazzy-rviz2-14.1.4-source0.tar.gz
...
Provides:  ros2-jazzy-rviz2 = 14.1.4-1
Obsoletes: ros2-jazzy-rviz2 < 14.1.4-1
...
Provides: ros2-jazzy-rviz2-devel = 14.1.4-1
Obsoletes: ros2-jazzy-rviz2-devel < 14.1.4-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/rviz2/{lib*/pkgconfig,include/,cmake/,rviz2/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
