...
Source0:        https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.1-1.tar.gz#/ros2-jazzy-rviz_default_plugins-14.1.1-source0.tar.gz
...
BuildRequires:  ros2-jazzy-ament_cmake_cppcheck-devel
BuildRequires:  ros2-jazzy-ament_cmake_cpplint-devel
BuildRequires:  ros2-jazzy-ament_cmake_gmock-devel
BuildRequires:  ros2-jazzy-ament_cmake_gtest-devel
BuildRequires:  ros2-jazzy-ament_cmake_lint_cmake-devel
BuildRequires:  ros2-jazzy-ament_cmake_ros-devel
BuildRequires:  ros2-jazzy-ament_cmake_uncrustify-devel
...
BuildRequires:  ros2-jazzy-rviz_rendering_tests-devel
BuildRequires:  ros2-jazzy-rviz_visual_testing_framework-devel
...
Provides:  ros2-jazzy-rviz_default_plugins = 14.1.1-1
Obsoletes: ros2-jazzy-rviz_default_plugins < 14.1.1-1
...
Provides: ros2-jazzy-rviz_default_plugins-devel = 14.1.1-1
Obsoletes: ros2-jazzy-rviz_default_plugins-devel < 14.1.1-1
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/rviz_default_plugins
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/share %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/share -type f -exec sed -i "s:opt/rviz_default_plugins/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/bin %{buildroot}/%{_libdir}/ros2-jazzy/
# fi
# 
...
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/extra_cmake %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake -type f -exec sed -i "s:opt/rviz_default_plugins/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/lib %{buildroot}/%{_libdir}/ros2-jazzy/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/rviz_default_plugins/lib64 %{buildroot}/%{_libdir}/ros2-jazzy/lib64
# fi
