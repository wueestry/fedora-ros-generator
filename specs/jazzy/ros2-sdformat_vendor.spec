Name:           ros2-jazzy-sdformat_vendor
Version:        0.0.9
Release:        1%{?dist}
Summary:        ROS package sdformat_vendor

License:        Apache License 2.0
URL:            https://github.com/gazebosim/sdformat

Source0:        https://github.com/ros2-gbp/sdformat_vendor-release/archive/release/jazzy/sdformat_vendor/0.0.9-1.tar.gz#/ros2-jazzy-sdformat_vendor-0.0.9-source0.tar.gz
...
Provides:  ros2-jazzy-sdformat_vendor = 0.0.9-1
Obsoletes: ros2-jazzy-sdformat_vendor < 0.0.9-1
...
Provides: ros2-jazzy-sdformat_vendor-devel = 0.0.9-1
Obsoletes: ros2-jazzy-sdformat_vendor-devel < 0.0.9-1
...
colcon \
  ...
  --packages-select sdformat_vendor
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/sdformat_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/sdformat_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/sdformat_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/sdformat_vendor ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/sdformat_vendor
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/sdformat_vendor/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/sdformat_vendor/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/sdformat_vendor \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,sdformat_vendor/include/,share/sdformat_vendor/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/sdformat_vendor/{lib*/pkgconfig,include/,cmake/,extra_cmake/,sdformat_vendor/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/sdformat_vendor/{lib*/pkgconfig,include/,cmake/,sdformat_vendor/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/sdformat_vendor/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
