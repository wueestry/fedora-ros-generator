...
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/release/jazzy/sensor_msgs/5.3.6-1.tar.gz#/ros2-jazzy-sensor_msgs-5.3.6-source0.tar.gz
...
Provides:  ros2-jazzy-sensor_msgs = 5.3.6-1
Obsoletes: ros2-jazzy-sensor_msgs < 5.3.6-1
...
Provides: ros2-jazzy-sensor_msgs-devel = 5.3.6-1
Obsoletes: ros2-jazzy-sensor_msgs-devel < 5.3.6-1
...
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/sensor_msgs/{lib*/pkgconfig,include/,cmake/,extra_cmake/,sensor_msgs/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
