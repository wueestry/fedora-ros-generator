...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2/0.36.2-2.tar.gz#/ros2-jazzy-tf2-0.36.2-source0.tar.gz
...
Provides:  ros2-jazzy-tf2 = 0.36.2-1
Obsoletes: ros2-jazzy-tf2 < 0.36.2-1
...
Provides: ros2-jazzy-tf2-devel = 0.36.2-1
Obsoletes: ros2-jazzy-tf2-devel < 0.36.2-1
