...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_msgs/0.36.9-1.tar.gz#/ros2-jazzy-tf2_msgs-0.36.9-source0.tar.gz
...
Provides:  ros2-jazzy-tf2_msgs = 0.36.9-1
Obsoletes: ros2-jazzy-tf2_msgs < 0.36.9-1
...
Provides: ros2-jazzy-tf2_msgs-devel = 0.36.9-1
Obsoletes: ros2-jazzy-tf2_msgs-devel < 0.36.9-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/tf2_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/tf2_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/tf2_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/tf2_msgs ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/tf2_msgs
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/tf2_msgs/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/tf2_msgs/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/tf2_msgs \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,tf2_msgs/include/,share/tf2_msgs/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/tf2_msgs/{lib*/pkgconfig,include/,cmake/,extra_cmake/,tf2_msgs/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/tf2_msgs/{lib*/pkgconfig,include/,cmake/,tf2_msgs/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/tf2_msgs/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
