...
Source0:        https://github.com/ros2-gbp/ros_tutorials-release/archive/release/jazzy/turtlesim/1.8.2-2.tar.gz#/ros2-jazzy-turtlesim-1.8.2-source0.tar.gz
...
Provides:  ros2-jazzy-turtlesim = 1.8.2-1
Obsoletes: ros2-jazzy-turtlesim < 1.8.2-1
...
Provides: ros2-jazzy-turtlesim-devel = 1.8.2-1
Obsoletes: ros2-jazzy-turtlesim-devel < 1.8.2-1
