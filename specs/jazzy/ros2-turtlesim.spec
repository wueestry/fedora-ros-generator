...
Source0:        https://github.com/ros2-gbp/ros_tutorials-release/archive/release/jazzy/turtlesim/1.8.3-1.tar.gz#/ros2-jazzy-turtlesim-1.8.3-source0.tar.gz
...
Provides:  ros2-jazzy-turtlesim = 1.8.3-1
Obsoletes: ros2-jazzy-turtlesim < 1.8.3-1
...
Provides: ros2-jazzy-turtlesim-devel = 1.8.3-1
Obsoletes: ros2-jazzy-turtlesim-devel < 1.8.3-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/turtlesim ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/turtlesim
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/turtlesim/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/turtlesim ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/turtlesim
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/turtlesim/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/turtlesim/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/turtlesim \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,turtlesim/include/,share/turtlesim/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/turtlesim/{lib*/pkgconfig,include/,cmake/,extra_cmake/,turtlesim/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/turtlesim/{lib*/pkgconfig,include/,cmake/,turtlesim/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/turtlesim/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
