Name:           ros2-jazzy-ur_controllers
Version:        3.2.0
Release:        1%{?dist}
Summary:        ROS package ur_controllers

License:        BSD-3-Clause
URL:            http://www.ros.org/

Source0:        https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_controllers/3.2.0-1.tar.gz#/ros2-jazzy-ur_controllers-3.2.0-source0.tar.gz
...
Provides:  ros2-jazzy-ur_controllers = 3.2.0-1
Obsoletes: ros2-jazzy-ur_controllers < 3.2.0-1
...
Provides: ros2-jazzy-ur_controllers-devel = 3.2.0-1
Obsoletes: ros2-jazzy-ur_controllers-devel < 3.2.0-1
...
colcon \
  ...
  --packages-select ur_controllers
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/ur_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/ur_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/ur_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/ur_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/ur_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/ur_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ur_controllers/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ur_controllers \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,ur_controllers/include/,share/ur_controllers/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/ur_controllers/{lib*/pkgconfig,include/,cmake/,extra_cmake/,ur_controllers/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/ur_controllers/{lib*/pkgconfig,include/,cmake/,ur_controllers/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/ur_controllers/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
