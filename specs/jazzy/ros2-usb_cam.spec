Name:           ros2-jazzy-usb_cam
Version:        0.8.1
Release:        1%{?dist}
Summary:        ROS package usb_cam

License:        BSD
URL:            http://wiki.ros.org/usb_cam

Source0:        https://github.com/ros2-gbp/usb_cam-release/archive/release/jazzy/usb_cam/0.8.1-1.tar.gz#/ros2-jazzy-usb_cam-0.8.1-source0.tar.gz

Patch0: ros.usb_cam.avcodec_include.patch
Patch1: ros.usb_cam.rm_xvmc.patch
...
BuildRequires:  ros2-jazzy-image_transport_plugins-devel
...
Provides:  ros2-jazzy-usb_cam = 0.8.1-1
Obsoletes: ros2-jazzy-usb_cam < 0.8.1-1
...
Provides: ros2-jazzy-usb_cam-devel = 0.8.1-1
Obsoletes: ros2-jazzy-usb_cam-devel < 0.8.1-1
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/usb_cam ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/usb_cam
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/usb_cam/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/usb_cam ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/usb_cam
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/usb_cam/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/usb_cam/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/usb_cam \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,usb_cam/include/,share/usb_cam/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/usb_cam/{lib*/pkgconfig,include/,cmake/,extra_cmake/,usb_cam/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/usb_cam/{lib*/pkgconfig,include/,cmake/,usb_cam/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/usb_cam/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
