Name:           ros2-jazzy-velocity_controllers
Version:        4.23.0
Release:        1%{?dist}
Summary:        ROS package velocity_controllers

License:        Apache License 2.0
URL:            https://control.ros.org

Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.23.0-1.tar.gz#/ros2-jazzy-velocity_controllers-4.23.0-source0.tar.gz
...
BuildRequires:  ros2-jazzy-forward_command_controller-devel
...
Provides:  ros2-jazzy-velocity_controllers = 4.23.0-1
Obsoletes: ros2-jazzy-velocity_controllers < 4.23.0-1
...
Provides: ros2-jazzy-velocity_controllers-devel = 4.23.0-1
Obsoletes: ros2-jazzy-velocity_controllers-devel < 4.23.0-1
...
colcon \
  ...
  --packages-select velocity_controllers
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/velocity_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/velocity_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/velocity_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/velocity_controllers ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/velocity_controllers
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/velocity_controllers/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/velocity_controllers/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/velocity_controllers \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list

touch files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,velocity_controllers/include/,share/velocity_controllers/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
# paths for vendor packages
find %{buildroot}/%{_libdir}/ros2-jazzy/velocity_controllers/{lib*/pkgconfig,include/,cmake/,extra_cmake/,velocity_controllers/include/,share/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/velocity_controllers/{lib*/pkgconfig,include/,cmake/,velocity_controllers/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/velocity_controllers/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
