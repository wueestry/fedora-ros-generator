Name:           ros2-jazzy-webots_ros2_tests
Version:        2023.1.2
Release:        1%{?dist}
Summary:        ROS package webots_ros2_tests

License:        Apache License 2.0
URL:            http://wiki.ros.org/webots_ros2

Source0:        https://github.com/ros2-gbp/webots_ros2-release/archive/release/jazzy/webots_ros2_tests/2023.1.2-4.tar.gz#/ros2-jazzy-webots_ros2_tests-2023.1.2-source0.tar.gz
...
BuildRequires:  ros2-jazzy-launch_testing_ament_cmake-devel
BuildRequires:  ros2-jazzy-launch_testing_ros-devel
BuildRequires:  ros2-jazzy-rclpy-devel
BuildRequires:  ros2-jazzy-ros2bag-devel
BuildRequires:  ros2-jazzy-rosbag2_storage_default_plugins-devel
...
BuildRequires:  ros2-jazzy-webots_ros2_epuck-devel
BuildRequires:  ros2-jazzy-webots_ros2_mavic-devel
BuildRequires:  ros2-jazzy-webots_ros2_tesla-devel
BuildRequires:  ros2-jazzy-webots_ros2_tiago-devel
BuildRequires:  ros2-jazzy-webots_ros2_turtlebot-devel
BuildRequires:  ros2-jazzy-webots_ros2_universal_robot-devel


Provides:  ros2-jazzy-webots_ros2_tests = 2023.1.2-1
Obsoletes: ros2-jazzy-webots_ros2_tests < 2023.1.2-1
...
Requires:       ros2-jazzy-webots_ros2_tiago-devel
Requires:       ros2-jazzy-webots_ros2_turtlebot-devel
Requires:       ros2-jazzy-webots_ros2_universal_robot-devel

Provides: ros2-jazzy-webots_ros2_tests-devel = 2023.1.2-1
Obsoletes: ros2-jazzy-webots_ros2_tests-devel < 2023.1.2-1
...
colcon \
  ...
  --packages-select webots_ros2_tests
...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tests ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tests
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tests
# fi
# 
# # Move share directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/share %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/share -type f -exec sed -i "s:opt/webots_ros2_tests/::g" {} \;
# fi
# 
# # Move bin directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/bin ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/bin ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/bin
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/bin %{buildroot}/%{_libdir}/ros2-jazzy/
# fi
# 
# # Move extra_cmake directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/extra_cmake %{buildroot}/%{_libdir}/ros2-jazzy/
#     find %{buildroot}/%{_libdir}/ros2-jazzy/extra_cmake -type f -exec sed -i "s:opt/webots_ros2_tests/::g" {} \;
# fi
# 
# # Move lib directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/lib ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/lib %{buildroot}/%{_libdir}/ros2-jazzy/lib
# fi
# 
# # Move lib64 directory if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/lib64 ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/lib64 ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/lib64
#     fi
#     # Move the directory
#     mv -f %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tests/lib64 %{buildroot}/%{_libdir}/ros2-jazzy/lib64
# fi
...
find %{buildroot}/%{_libdir}/ros2-jazzy/{lib*/pkgconfig,include/,cmake/,webots_ros2_tests/include/,share/webots_ros2_tests/cmake} \
