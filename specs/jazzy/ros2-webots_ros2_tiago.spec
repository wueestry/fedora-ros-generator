...
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/include ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tiago ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tiago
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/include/* %{buildroot}/%{_libdir}/ros2-jazzy/include/webots_ros2_tiago/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/include
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/extra_cmake ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/extra_cmake ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/extra_cmake
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/extra_cmake/* %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/extra_cmake/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/extra_cmake
# fi

# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/share ]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy/share/webots_ros2_tiago ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy/share/webots_ros2_tiago
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/share/* %{buildroot}/%{_libdir}/ros2-jazzy/share/webots_ros2_tiago/
#     rm -rd %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/share
# fi

# # Move other opt path if source path exists
# if [ -d %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago]; then
#     # If destination path does not exist, create it
#     if [ ! -d %{buildroot}/%{_libdir}/ros2-jazzy ]; then
#         mkdir -p %{buildroot}/%{_libdir}/ros2-jazzy
#     fi
#     # Move the directory
#     cp -r %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/* %{buildroot}/%{_libdir}/ros2-jazzy/
#     rm  -rd %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago
# fi
...
# vendor pkg removal
rm -rf %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/webots_ros2_tiago/{.catkin,.rosinstall,_setup*,local_setup*,setup*,env.sh,.colcon_install_layout,COLCON_IGNORE,_local_setup*,_local_setup*}
...
find %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/{bin,etc,tools,lib64/python*,lib/python*/site-packages,share} \
  ! -name cmake ! -name include \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/webots_ros2_tiago/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/lib*/ -mindepth 1 -maxdepth 1 \
  ! -name pkgconfig ! -name "python*" \
  | sed "s:%{buildroot}/::" >> files.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/webots_ros2_tiago \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/extra_cmake \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/webots_ros2_tiago/{lib*/pkgconfig,include/,cmake/,webots_ros2_tiago/include/,/share/cmake,/extra_cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
...
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/colcon-core/packages/ \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
find %{buildroot}/%{_libdir}/ros2-jazzy/opt/share/webots_ros2_tiago/{hook,environment,cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" >> files_devel.list
