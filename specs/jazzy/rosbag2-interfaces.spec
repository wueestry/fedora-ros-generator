...
Summary:        Meta package for ros2-jazzy-rosbag2_interfaces and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-rosbag2_interfaces
Requires:       ros2-jazzy-rosbag2_interfaces-devel

Obsoletes: ros-jazzy-rosbag2-interfaces < 0.26.4-1
