...
Summary:        Meta package for ros2-jazzy-rosidl_typesupport_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-rosidl_typesupport_cpp
Requires:       ros2-jazzy-rosidl_typesupport_cpp-devel

Obsoletes: ros-jazzy-rosidl-typesupport-cpp < 3.2.2-1
