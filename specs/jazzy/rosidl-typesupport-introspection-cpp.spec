...
Summary:        Meta package for ros2-jazzy-rosidl_typesupport_introspection_cpp and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-rosidl_typesupport_introspection_cpp
Requires:       ros2-jazzy-rosidl_typesupport_introspection_cpp-devel

Obsoletes: ros-jazzy-rosidl-typesupport-introspection-cpp < 4.6.1-1
