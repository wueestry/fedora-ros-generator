...
Summary:        Meta package for ros2-jazzy-tricycle_steering_controller and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-tricycle_steering_controller
Requires:       ros2-jazzy-tricycle_steering_controller-devel

Obsoletes: ros-jazzy-tricycle-steering-controller < 4.23.0-1
