...
Summary:        Meta package for ros2-jazzy-velocity_controllers and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-velocity_controllers
Requires:       ros2-jazzy-velocity_controllers-devel

Obsoletes: ros-jazzy-velocity-controllers < 4.23.0-1
