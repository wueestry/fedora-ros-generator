...
Summary:        Meta package for ros2-jazzy-visualization_msgs and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-visualization_msgs
Requires:       ros2-jazzy-visualization_msgs-devel

Obsoletes: ros-jazzy-visualization-msgs < 5.3.6-1
