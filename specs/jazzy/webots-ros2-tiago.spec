# Meta Package
Name:           ros-jazzy-webots-ros2-tiago
Version:        2025.0.0
Release:        1%{?dist}
License:        Apache License 2.0
URL:            http://wiki.ros.org/webots_ros2
Summary:        Meta package for ros2-jazzy-webots_ros2_tiago and its development package to adhere to ubuntu pkg names
BuildArch: noarch

Requires:       ros2-jazzy-webots_ros2_tiago
Requires:       ros2-jazzy-webots_ros2_tiago-devel

Obsoletes: ros-jazzy-webots-ros2-tiago < 2025.0.0-1
