Name:           ros-humble-ament_cmake_flake8
...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_flake8/0.12.6-1.tar.gz#/ros2-humble-ament_cmake_flake8-0.12.6-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_flake8 = 0.12.6-1
Obsoletes: ros2-humble-ament_cmake_flake8 < 0.12.6-1
...
Provides: ros2-humble-ament_cmake_flake8-devel = 0.12.6-1
Obsoletes: ros2-humble-ament_cmake_flake8-devel < 0.12.6-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ament_cmake_flake8/include/,share/ament_cmake_flake8/cmake} \
