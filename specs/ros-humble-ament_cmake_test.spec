Name:           ros-humble-ament_cmake_test
...
Source0:        https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_test/1.3.4-2.tar.gz#/ros2-humble-ament_cmake_test-1.3.4-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_test = 1.3.4-1
Obsoletes: ros2-humble-ament_cmake_test < 1.3.4-1
...
Provides: ros2-humble-ament_cmake_test-devel = 1.3.4-1
Obsoletes: ros2-humble-ament_cmake_test-devel < 1.3.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ament_cmake_test/include/,share/ament_cmake_test/cmake} \
