Name:           ros-humble-ament_cmake_uncrustify
Version:        humble.0.12.6
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_uncrustify/0.12.6-1.tar.gz#/ros2-humble-ament_cmake_uncrustify-0.12.6-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_uncrustify = 0.12.6-1
Obsoletes: ros2-humble-ament_cmake_uncrustify < 0.12.6-1
...
Provides: ros2-humble-ament_cmake_uncrustify-devel = 0.12.6-1
Obsoletes: ros2-humble-ament_cmake_uncrustify-devel < 0.12.6-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ament_cmake_uncrustify/include/,share/ament_cmake_uncrustify/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.12.6-1
