Name:           ros-humble-ament_lint_cmake
...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_lint_cmake/0.12.6-1.tar.gz#/ros2-humble-ament_lint_cmake-0.12.6-source0.tar.gz
...
Provides:  ros2-humble-ament_lint_cmake = 0.12.6-1
Obsoletes: ros2-humble-ament_lint_cmake < 0.12.6-1
...
Provides: ros2-humble-ament_lint_cmake-devel = 0.12.6-1
Obsoletes: ros2-humble-ament_lint_cmake-devel < 0.12.6-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ament_lint_cmake/include/,share/ament_lint_cmake/cmake} \
