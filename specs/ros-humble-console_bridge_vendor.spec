Name:           ros-humble-console_bridge_vendor
Version:        humble.1.4.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,console_bridge_vendor/include/,share/console_bridge_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.4.1-1
