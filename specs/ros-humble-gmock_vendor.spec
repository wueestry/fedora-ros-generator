Name:           ros-humble-gmock_vendor
Version:        humble.1.10.9004
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,src/gmock_vendor/include/,share/gmock_vendor/cmake} \
  -mindepth 1 -maxdepth 1 | sed "s:%{buildroot}/::" > files_devel.list
rm -rf %{buildroot}/%{_libdir}/ros2/src/gmock_vendor/src
rm -rf %{buildroot}/%{_libdir}/ros2/src/gmock_vendor/CMakeLists.txt
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.10.9004-1
