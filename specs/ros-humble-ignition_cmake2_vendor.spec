Name:           ros-humble-ignition_cmake2_vendor
Version:        humble.0.0.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ignition_cmake2_vendor/include/,share/ignition_cmake2_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.0.2-1
