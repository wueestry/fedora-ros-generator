Name:           ros-humble-image_geometry
Version:        humble.3.2.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,image_geometry/include/,share/image_geometry/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.3.2.1-1
