Name:           ros-humble-keyboard_handler
Version:        humble.0.0.5
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,keyboard_handler/include/,share/keyboard_handler/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.0.5-1
