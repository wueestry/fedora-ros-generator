Name:           ros-humble-launch_testing
...
Source0:        https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_testing/1.0.4-1.tar.gz#/ros2-humble-launch_testing-1.0.4-source0.tar.gz
...
Provides:  ros2-humble-launch_testing = 1.0.4-1
Obsoletes: ros2-humble-launch_testing < 1.0.4-1
...
Provides: ros2-humble-launch_testing-devel = 1.0.4-1
Obsoletes: ros2-humble-launch_testing-devel < 1.0.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,launch_testing/include/,share/launch_testing/cmake} \
