...
Source0:        https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_xml/1.0.4-1.tar.gz#/ros2-humble-launch_xml-1.0.4-source0.tar.gz
...
Provides:  ros2-humble-launch_xml = 1.0.4-1
Obsoletes: ros2-humble-launch_xml < 1.0.4-1
...
Provides: ros2-humble-launch_xml-devel = 1.0.4-1
Obsoletes: ros2-humble-launch_xml-devel < 1.0.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,launch_xml/include/,share/launch_xml/cmake} \
