Name:           ros-humble-libstatistics_collector
Version:        humble.1.3.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,libstatistics_collector/include/,share/libstatistics_collector/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.3.1-1
