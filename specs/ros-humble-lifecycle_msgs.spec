Name:           ros-humble-lifecycle_msgs
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,lifecycle_msgs/include/,share/lifecycle_msgs/cmake} \
...
# fix broken runpath
find %{buildroot}/%{_libdir}/ros2/ -name *__rosidl_generator_py.so -type f -exec patchelf --shrink-rpath --allowed-rpath-prefixes "%{_libdir}/ros2/lib" {} \;
