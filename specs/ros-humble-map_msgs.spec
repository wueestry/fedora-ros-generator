Name:           ros-humble-map_msgs
Version:        humble.2.1.0
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,map_msgs/include/,share/map_msgs/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.1.0-1
