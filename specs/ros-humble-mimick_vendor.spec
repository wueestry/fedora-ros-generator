Name:           ros-humble-mimick_vendor
Version:        humble.0.2.8
Release:        1%{?dist}
...
Patch0: ros-mimick_vendor-optimization.patch
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,mimick_vendor/include/,share/mimick_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.2.8-1
