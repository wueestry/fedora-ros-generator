Name:           ros-humble-orocos_kdl_vendor
Version:        humble.0.2.5
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,orocos_kdl_vendor/include/,share/orocos_kdl_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.2.5-1
