Name:           ros-humble-osrf_testing_tools_cpp
Version:        humble.1.5.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,osrf_testing_tools_cpp/include/,share/osrf_testing_tools_cpp/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.5.2-1
