Name:           ros-humble-performance_test_fixture
Version:        humble.0.0.9
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,performance_test_fixture/include/,share/performance_test_fixture/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.0.9-1
