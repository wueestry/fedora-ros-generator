Name:           ros-humble-pybind11_vendor
Version:        humble.2.4.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,pybind11_vendor/include/,share/pybind11_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.4.2-1
