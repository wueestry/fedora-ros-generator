Name:           ros-humble-python_qt_binding
Version:        humble.1.1.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,python_qt_binding/include/,share/python_qt_binding/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.1.1-1
