Name:           ros-humble-qt_gui_py_common
Version:        humble.2.2.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,qt_gui_py_common/include/,share/qt_gui_py_common/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.2.2-1
