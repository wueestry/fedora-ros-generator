...
Source0:        https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl/5.3.3-1.tar.gz#/ros2-humble-rcl-5.3.3-source0.tar.gz
...
Provides:  ros2-humble-rcl = 5.3.3-1
Obsoletes: ros2-humble-rcl < 5.3.3-1
...
Provides: ros2-humble-rcl-devel = 5.3.3-1
Obsoletes: ros2-humble-rcl-devel < 5.3.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rcl/include/,share/rcl/cmake} \
