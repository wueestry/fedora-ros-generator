Name:           ros-humble-rcl_logging_interface
Version:        humble.2.3.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rcl_logging_interface/include/,share/rcl_logging_interface/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.3.1-1
