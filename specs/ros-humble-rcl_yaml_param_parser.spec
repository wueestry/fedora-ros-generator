Name:           ros-humble-rcl_yaml_param_parser
Version:        humble.5.3.3
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl_yaml_param_parser/5.3.3-1.tar.gz#/ros2-humble-rcl_yaml_param_parser-5.3.3-source0.tar.gz
...
Provides:  ros2-humble-rcl_yaml_param_parser = 5.3.3-1
Obsoletes: ros2-humble-rcl_yaml_param_parser < 5.3.3-1
...
Provides: ros2-humble-rcl_yaml_param_parser-devel = 5.3.3-1
Obsoletes: ros2-humble-rcl_yaml_param_parser-devel < 5.3.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rcl_yaml_param_parser/include/,share/rcl_yaml_param_parser/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.5.3.3-1
