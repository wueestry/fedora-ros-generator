Name:           ros-humble-rclcpp_lifecycle
Version:        humble.16.0.4
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_lifecycle/16.0.4-2.tar.gz#/ros2-humble-rclcpp_lifecycle-16.0.4-source0.tar.gz
...
Provides:  ros2-humble-rclcpp_lifecycle = 16.0.4-1
Obsoletes: ros2-humble-rclcpp_lifecycle < 16.0.4-1
...
Provides: ros2-humble-rclcpp_lifecycle-devel = 16.0.4-1
Obsoletes: ros2-humble-rclcpp_lifecycle-devel < 16.0.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rclcpp_lifecycle/include/,share/rclcpp_lifecycle/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.16.0.4-1
