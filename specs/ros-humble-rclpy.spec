...
Source0:        https://github.com/ros2-gbp/rclpy-release/archive/release/humble/rclpy/3.3.8-2.tar.gz#/ros2-humble-rclpy-3.3.8-source0.tar.gz
...
Provides:  ros2-humble-rclpy = 3.3.8-1
Obsoletes: ros2-humble-rclpy < 3.3.8-1
...
Provides: ros2-humble-rclpy-devel = 3.3.8-1
Obsoletes: ros2-humble-rclpy-devel < 3.3.8-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rclpy/include/,share/rclpy/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.3.3.8-1
