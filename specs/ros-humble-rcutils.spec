...
Source0:        https://github.com/ros2-gbp/rcutils-release/archive/release/humble/rcutils/5.1.3-1.tar.gz#/ros2-humble-rcutils-5.1.3-source0.tar.gz
...
Provides:  ros2-humble-rcutils = 5.1.3-1
Obsoletes: ros2-humble-rcutils < 5.1.3-1
...
Provides: ros2-humble-rcutils-devel = 5.1.3-1
Obsoletes: ros2-humble-rcutils-devel < 5.1.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rcutils/include/,share/rcutils/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.5.1.3-1
