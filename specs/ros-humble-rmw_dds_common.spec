Name:           ros-humble-rmw_dds_common
Version:        humble.1.6.0
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rmw_dds_common/include/,share/rmw_dds_common/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.6.0-1
