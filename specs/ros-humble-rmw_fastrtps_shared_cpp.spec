Name:           ros-humble-rmw_fastrtps_shared_cpp
...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/humble/rmw_fastrtps_shared_cpp/6.2.2-1.tar.gz#/ros2-humble-rmw_fastrtps_shared_cpp-6.2.2-source0.tar.gz
...
Provides:  ros2-humble-rmw_fastrtps_shared_cpp = 6.2.2-1
Obsoletes: ros2-humble-rmw_fastrtps_shared_cpp < 6.2.2-1
...
Provides: ros2-humble-rmw_fastrtps_shared_cpp-devel = 6.2.2-1
Obsoletes: ros2-humble-rmw_fastrtps_shared_cpp-devel < 6.2.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rmw_fastrtps_shared_cpp/include/,share/rmw_fastrtps_shared_cpp/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.6.2.2-1
