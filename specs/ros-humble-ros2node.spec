...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.6-1.tar.gz#/ros2-humble-ros2node-0.18.6-source0.tar.gz
...
Provides:  ros2-humble-ros2node = 0.18.6-1
Obsoletes: ros2-humble-ros2node < 0.18.6-1
...
Provides: ros2-humble-ros2node-devel = 0.18.6-1
Obsoletes: ros2-humble-ros2node-devel < 0.18.6-1
