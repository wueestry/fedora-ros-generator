Name:           ros-humble-ros_environment
Version:        humble.3.2.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ros_environment/include/,share/ros_environment/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.3.2.2-1
