Name:           ros-humble-ros_testing
Version:        humble.0.4.0
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ros_testing/include/,share/ros_testing/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.4.0-1
