Name:           ros-humble-rosbag2_compression
...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_compression/0.15.5-1.tar.gz#/ros2-humble-rosbag2_compression-0.15.5-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_compression = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_compression < 0.15.5-1
...
Provides: ros2-humble-rosbag2_compression-devel = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_compression-devel < 0.15.5-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag2_compression/include/,share/rosbag2_compression/cmake} \
