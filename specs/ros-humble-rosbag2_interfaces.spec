Name:           ros-humble-rosbag2_interfaces
Version:        humble.0.15.5
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_interfaces/0.15.5-1.tar.gz#/ros2-humble-rosbag2_interfaces-0.15.5-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_interfaces = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_interfaces < 0.15.5-1
...
Provides: ros2-humble-rosbag2_interfaces-devel = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_interfaces-devel < 0.15.5-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag2_interfaces/include/,share/rosbag2_interfaces/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.15.5-1
