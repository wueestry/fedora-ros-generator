...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_tests/0.15.5-1.tar.gz#/ros2-humble-rosbag2_tests-0.15.5-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_tests = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_tests < 0.15.5-1
...
Provides: ros2-humble-rosbag2_tests-devel = 0.15.5-1
Obsoletes: ros2-humble-rosbag2_tests-devel < 0.15.5-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag2_tests/include/,share/rosbag2_tests/cmake} \
