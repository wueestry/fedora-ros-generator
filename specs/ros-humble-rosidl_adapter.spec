Name:           ros-humble-rosidl_adapter
...
Provides:  ros2-humble-rosidl_adapter = 3.1.4-1
Obsoletes: ros2-humble-rosidl_adapter < 3.1.4-1
...
Provides: ros2-humble-rosidl_adapter-devel = 3.1.4-1
Obsoletes: ros2-humble-rosidl_adapter-devel < 3.1.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosidl_adapter/include/,share/rosidl_adapter/cmake} \
