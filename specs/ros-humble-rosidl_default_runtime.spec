Name:           ros-humble-rosidl_default_runtime
Version:        humble.1.2.0
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosidl_default_runtime/include/,share/rosidl_default_runtime/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.2.0-1
