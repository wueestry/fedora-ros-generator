Name:           ros-humble-rosidl_generator_py
Version:        humble.0.14.4
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosidl_generator_py/include/,share/rosidl_generator_py/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.14.4-1
