Name:           ros-humble-rosidl_runtime_py
Version:        humble.0.9.3
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosidl_runtime_py/include/,share/rosidl_runtime_py/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.9.3-1
