Name:           ros-humble-rqt_service_caller
Version:        humble.1.0.5
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_service_caller/include/,share/rqt_service_caller/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.0.5-1
