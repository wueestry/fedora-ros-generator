Name:           ros-humble-sdl2_vendor
Version:        humble.3.1.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/joystick_drivers-release/archive/release/humble/sdl2_vendor/3.1.0-3.tar.gz#/ros2-humble-sdl2_vendor-3.1.0-source0.tar.gz
...
Provides:  ros2-humble-sdl2_vendor = 3.1.0-1
Obsoletes: ros2-humble-sdl2_vendor < 3.1.0-1
...
Provides: ros2-humble-sdl2_vendor-devel = 3.1.0-1
Obsoletes: ros2-humble-sdl2_vendor-devel < 3.1.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,sdl2_vendor/include/,share/sdl2_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.3.1.0-1
