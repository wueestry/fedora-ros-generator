Name:           ros-humble-teleop_twist_keyboard
Version:        humble.2.3.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,teleop_twist_keyboard/include/,share/teleop_twist_keyboard/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.3.2-1
