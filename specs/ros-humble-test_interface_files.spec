Name:           ros-humble-test_interface_files
Version:        humble.0.9.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,test_interface_files/include/,share/test_interface_files/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.9.1-1
