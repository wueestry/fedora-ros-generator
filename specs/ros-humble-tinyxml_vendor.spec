Name:           ros-humble-tinyxml_vendor
Version:        humble.0.8.3
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,tinyxml_vendor/include/,share/tinyxml_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.0.8.3-1
