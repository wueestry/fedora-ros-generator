Name:           ros-humble-urdf_parser_plugin
Version:        humble.2.6.0
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,urdf_parser_plugin/include/,share/urdf_parser_plugin/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.2.6.0-1
