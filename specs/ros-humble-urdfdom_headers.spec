Name:           ros-humble-urdfdom_headers
Version:        humble.1.0.6
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,urdfdom_headers/include/,share/urdfdom_headers/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.1.0.6-1
