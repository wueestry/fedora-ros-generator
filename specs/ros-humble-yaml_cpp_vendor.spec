Name:           ros-humble-yaml_cpp_vendor
Version:        humble.8.0.2
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,yaml_cpp_vendor/include/,share/yaml_cpp_vendor/cmake} \
...
%changelog
* 2023-05-01 Ryan Wüest <ryan.wueest@protonmail.com> - humble.8.0.2-1
