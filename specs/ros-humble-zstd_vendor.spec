...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/zstd_vendor/0.15.5-1.tar.gz#/ros2-humble-zstd_vendor-0.15.5-source0.tar.gz
...
Provides:  ros2-humble-zstd_vendor = 0.15.5-1
Obsoletes: ros2-humble-zstd_vendor < 0.15.5-1
...
Provides: ros2-humble-zstd_vendor-devel = 0.15.5-1
Obsoletes: ros2-humble-zstd_vendor-devel < 0.15.5-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,zstd_vendor/include/,share/zstd_vendor/cmake} \
