...
%description
MAVLink communication library. This library provide unified connection
handling classes and URL to connection object mapper. This library can
be used in standalone programs.
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/libmavconn/cmake} \
