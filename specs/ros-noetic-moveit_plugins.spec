...
Requires:       ros-noetic-moveit_fake_controller_manager
...
Requires:       ros-noetic-moveit_fake_controller_manager-devel
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/moveit_plugins/cmake} \
