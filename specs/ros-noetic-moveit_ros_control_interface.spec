...
BuildRequires:  ros-noetic-moveit_simple_controller_manager-devel
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/moveit_ros_control_interface/cmake} \
