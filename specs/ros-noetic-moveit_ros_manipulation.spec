...
Source0:        https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_manipulation/1.1.13-2.tar.gz#/ros-noetic-moveit_ros_manipulation-1.1.13-source0.tar.gz
...
Provides:  ros-noetic-moveit_ros_manipulation = 1.1.13-1
Obsoletes: ros-noetic-moveit_ros_manipulation < 1.1.13-1
Obsoletes: ros-kinetic-moveit_ros_manipulation < 1.1.13-1
...
Provides: ros-noetic-moveit_ros_manipulation-devel = 1.1.13-1
Obsoletes: ros-noetic-moveit_ros_manipulation-devel < 1.1.13-1
Obsoletes: ros-kinetic-moveit_ros_manipulation-devel < 1.1.13-1
