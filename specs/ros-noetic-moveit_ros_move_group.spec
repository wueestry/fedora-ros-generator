Name:           ros-noetic-moveit_ros_move_group
...
Source0:        https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_move_group/1.1.11-1.tar.gz#/ros-noetic-moveit_ros_move_group-1.1.11-source0.tar.gz
...
Requires:       ros-noetic-moveit_kinematics
...
Provides:  ros-noetic-moveit_ros_move_group = 1.1.11-1
Obsoletes: ros-noetic-moveit_ros_move_group < 1.1.11-1
Obsoletes: ros-kinetic-moveit_ros_move_group < 1.1.11-1
...
Requires:       ros-noetic-moveit_kinematics-devel

Provides: ros-noetic-moveit_ros_move_group-devel = 1.1.11-1
Obsoletes: ros-noetic-moveit_ros_move_group-devel < 1.1.11-1
Obsoletes: ros-kinetic-moveit_ros_move_group-devel < 1.1.11-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/moveit_ros_move_group/cmake} \
