Name:           ros-noetic-moveit_ros_planning_interface
...
Source0:        https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_planning_interface/1.1.11-1.tar.gz#/ros-noetic-moveit_ros_planning_interface-1.1.11-source0.tar.gz
...
BuildRequires:  ros-noetic-eigenpy-devel
BuildRequires:  ros-noetic-geometry_msgs-devel
BuildRequires:  ros-noetic-moveit_msgs-devel
BuildRequires:  ros-noetic-moveit_resources_fanuc_moveit_config-devel
BuildRequires:  ros-noetic-moveit_resources_panda_moveit_config-devel
BuildRequires:  ros-noetic-moveit_ros_manipulation-devel
...
Requires:       ros-noetic-moveit_ros_manipulation
...
Provides:  ros-noetic-moveit_ros_planning_interface = 1.1.11-1
Obsoletes: ros-noetic-moveit_ros_planning_interface < 1.1.11-1
Obsoletes: ros-kinetic-moveit_ros_planning_interface < 1.1.11-1
...
Requires:       ros-noetic-eigenpy-devel
Requires:       ros-noetic-geometry_msgs-devel
Requires:       ros-noetic-moveit_msgs-devel
Requires:       ros-noetic-moveit_resources_fanuc_moveit_config-devel
Requires:       ros-noetic-moveit_resources_panda_moveit_config-devel
Requires:       ros-noetic-moveit_ros_manipulation-devel
...
Provides: ros-noetic-moveit_ros_planning_interface-devel = 1.1.11-1
Obsoletes: ros-noetic-moveit_ros_planning_interface-devel < 1.1.11-1
Obsoletes: ros-kinetic-moveit_ros_planning_interface-devel < 1.1.11-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/moveit_ros_planning_interface/cmake} \
