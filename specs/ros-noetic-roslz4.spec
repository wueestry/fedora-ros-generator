...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslz4/1.16.0-1.tar.gz#/ros-noetic-roslz4-1.16.0-source0.tar.gz
...
Provides:  ros-noetic-roslz4 = 1.16.0-1
Obsoletes: ros-noetic-roslz4 < 1.16.0-1
Obsoletes: ros-kinetic-roslz4 < 1.16.0-1
...
Provides: ros-noetic-roslz4-devel = 1.16.0-1
Obsoletes: ros-noetic-roslz4-devel < 1.16.0-1
Obsoletes: ros-kinetic-roslz4-devel < 1.16.0-1
