...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rospy/1.16.0-1.tar.gz#/ros-noetic-rospy-1.16.0-source0.tar.gz
...
Provides:  ros-noetic-rospy = 1.16.0-1
Obsoletes: ros-noetic-rospy < 1.16.0-1
Obsoletes: ros-kinetic-rospy < 1.16.0-1
...
Provides: ros-noetic-rospy-devel = 1.16.0-1
Obsoletes: ros-noetic-rospy-devel < 1.16.0-1
Obsoletes: ros-kinetic-rospy-devel < 1.16.0-1
