...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rostest/1.16.0-1.tar.gz#/ros-noetic-rostest-1.16.0-source0.tar.gz
...
Provides:  ros-noetic-rostest = 1.16.0-1
Obsoletes: ros-noetic-rostest < 1.16.0-1
Obsoletes: ros-kinetic-rostest < 1.16.0-1
...
Provides: ros-noetic-rostest-devel = 1.16.0-1
Obsoletes: ros-noetic-rostest-devel < 1.16.0-1
Obsoletes: ros-kinetic-rostest-devel < 1.16.0-1
