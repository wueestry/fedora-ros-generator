...
Source0:        https://github.com/ros-gbp/ros_control-release/archive/release/noetic/transmission_interface/0.20.0-1.tar.gz#/ros-noetic-transmission_interface-0.20.0-source0.tar.gz
...
Provides:  ros-noetic-transmission_interface = 0.20.0-1
Obsoletes: ros-noetic-transmission_interface < 0.20.0-1
Obsoletes: ros-kinetic-transmission_interface < 0.20.0-1
...
Provides: ros-noetic-transmission_interface-devel = 0.20.0-1
Obsoletes: ros-noetic-transmission_interface-devel < 0.20.0-1
Obsoletes: ros-kinetic-transmission_interface-devel < 0.20.0-1
