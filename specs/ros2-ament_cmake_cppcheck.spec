...
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_cppcheck/0.12.9-1.tar.gz#/ros2-humble-ament_cmake_cppcheck-0.12.9-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_cppcheck = 0.12.9-1
Obsoletes: ros2-humble-ament_cmake_cppcheck < 0.12.9-1
...
Provides: ros2-humble-ament_cmake_cppcheck-devel = 0.12.9-1
Obsoletes: ros2-humble-ament_cmake_cppcheck-devel < 0.12.9-1
