...
Source0:        https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_export_include_directories/1.3.3-1.tar.gz#/ros2-humble-ament_cmake_export_include_directories-1.3.3-source0.tar.gz
...
Provides:  ros2-humble-ament_cmake_export_include_directories = 1.3.3-1
Obsoletes: ros2-humble-ament_cmake_export_include_directories < 1.3.3-1
...
Provides: ros2-humble-ament_cmake_export_include_directories-devel = 1.3.3-1
Obsoletes: ros2-humble-ament_cmake_export_include_directories-devel < 1.3.3-1
