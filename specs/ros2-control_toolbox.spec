Name:           ros2-control_toolbox
Version:        humble.3.0.0
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/control_toolbox-release/archive/release/humble/control_toolbox/3.0.0-1.tar.gz#/ros2-humble-control_toolbox-3.0.0-source0.tar.gz
...
Provides:  ros2-humble-control_toolbox = 3.0.0-1
Obsoletes: ros2-humble-control_toolbox < 3.0.0-1
...
Provides: ros2-humble-control_toolbox-devel = 3.0.0-1
Obsoletes: ros2-humble-control_toolbox-devel < 3.0.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,control_toolbox/include/,share/control_toolbox/cmake} \
