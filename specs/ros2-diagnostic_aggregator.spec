Name:           ros2-diagnostic_aggregator
...
Source0:        https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/diagnostic_aggregator/1.11.0-1.tar.gz#/ros2-noetic-diagnostic_aggregator-1.11.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-bondcpp-devel
BuildRequires:  ros2-noetic-bondpy-devel
...
Requires:       ros2-noetic-bondcpp
Requires:       ros2-noetic-bondpy
...
Provides:  ros2-noetic-diagnostic_aggregator = 1.11.0-1
Obsoletes: ros2-noetic-diagnostic_aggregator < 1.11.0-1
...
Requires:       ros2-noetic-bondcpp-devel
Requires:       ros2-noetic-bondpy-devel
...
Provides: ros2-noetic-diagnostic_aggregator-devel = 1.11.0-1
Obsoletes: ros2-noetic-diagnostic_aggregator-devel < 1.11.0-1
...
colcon \
  ...
  --packages-select diagnostic_aggregator
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,diagnostic_aggregator/include/,share/diagnostic_aggregator/cmake} \
