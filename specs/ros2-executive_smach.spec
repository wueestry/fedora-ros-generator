...
Source0:        https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/executive_smach/2.5.1-1.tar.gz#/ros2-noetic-executive_smach-2.5.1-source0.tar.gz
...
Requires:       ros2-noetic-smach
Requires:       ros2-noetic-smach_msgs
Requires:       ros2-noetic-smach_ros

Provides:  ros2-noetic-executive_smach = 2.5.1-1
Obsoletes: ros2-noetic-executive_smach < 2.5.1-1
...
Requires:       ros2-noetic-smach-devel
Requires:       ros2-noetic-smach_msgs-devel
Requires:       ros2-noetic-smach_ros-devel

Provides: ros2-noetic-executive_smach-devel = 2.5.1-1
Obsoletes: ros2-noetic-executive_smach-devel < 2.5.1-1
...
colcon \
  ...
  --packages-select executive_smach
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,executive_smach/include/,share/executive_smach/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.2.5.1-1
