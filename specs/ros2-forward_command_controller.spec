...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/forward_command_controller/2.26.0-1.tar.gz#/ros2-humble-forward_command_controller-2.26.0-source0.tar.gz
...
Provides:  ros2-humble-forward_command_controller = 2.26.0-1
Obsoletes: ros2-humble-forward_command_controller < 2.26.0-1
...
Provides: ros2-humble-forward_command_controller-devel = 2.26.0-1
Obsoletes: ros2-humble-forward_command_controller-devel < 2.26.0-1
