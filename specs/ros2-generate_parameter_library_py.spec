Name:           ros2-generate_parameter_library_py
...
Source0:        https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/humble/generate_parameter_library_py/0.3.3-1.tar.gz#/ros2-humble-generate_parameter_library_py-0.3.3-source0.tar.gz
...
Provides:  ros2-humble-generate_parameter_library_py = 0.3.3-1
Obsoletes: ros2-humble-generate_parameter_library_py < 0.3.3-1
...
Provides: ros2-humble-generate_parameter_library_py-devel = 0.3.3-1
Obsoletes: ros2-humble-generate_parameter_library_py-devel < 0.3.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,generate_parameter_library_py/include/,share/generate_parameter_library_py/cmake} \
