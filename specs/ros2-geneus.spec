...
Source0:        https://github.com/tork-a/geneus-release/archive/release/noetic/geneus/3.0.0-1.tar.gz#/ros2-noetic-geneus-3.0.0-source0.tar.gz
...
Provides:  ros2-noetic-geneus = 3.0.0-1
Obsoletes: ros2-noetic-geneus < 3.0.0-1
...
Provides: ros2-noetic-geneus-devel = 3.0.0-1
Obsoletes: ros2-noetic-geneus-devel < 3.0.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,geneus/include/,share/geneus/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.3.0.0-1
