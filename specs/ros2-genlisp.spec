...
Source0:        https://github.com/ros-gbp/genlisp-release/archive/release/noetic/genlisp/0.4.18-1.tar.gz#/ros2-noetic-genlisp-0.4.18-source0.tar.gz
...
Provides:  ros2-noetic-genlisp = 0.4.18-1
Obsoletes: ros2-noetic-genlisp < 0.4.18-1
...
Provides: ros2-noetic-genlisp-devel = 0.4.18-1
Obsoletes: ros2-noetic-genlisp-devel < 0.4.18-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,genlisp/include/,share/genlisp/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.4.18-1
