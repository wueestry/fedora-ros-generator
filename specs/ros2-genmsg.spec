...
Source0:        https://github.com/ros-gbp/genmsg-release/archive/release/noetic/genmsg/0.6.0-1.tar.gz#/ros2-noetic-genmsg-0.6.0-source0.tar.gz
...
Provides:  ros2-noetic-genmsg = 0.6.0-1
Obsoletes: ros2-noetic-genmsg < 0.6.0-1
...
Provides: ros2-noetic-genmsg-devel = 0.6.0-1
Obsoletes: ros2-noetic-genmsg-devel < 0.6.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,genmsg/include/,share/genmsg/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.6.0-1
