Name:           ros2-geometric_shapes
Version:        humble.2.1.3
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,geometric_shapes/include/,share/geometric_shapes/cmake} \
