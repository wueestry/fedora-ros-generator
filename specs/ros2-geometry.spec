...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/noetic/geometry/1.13.2-1.tar.gz#/ros2-noetic-geometry-1.13.2-source0.tar.gz
...
Requires:       ros2-noetic-eigen_conversions
Requires:       ros2-noetic-kdl_conversions
Requires:       ros2-noetic-tf
Requires:       ros2-noetic-tf_conversions

Provides:  ros2-noetic-geometry = 1.13.2-1
Obsoletes: ros2-noetic-geometry < 1.13.2-1
...
Requires:       ros2-noetic-eigen_conversions-devel
Requires:       ros2-noetic-kdl_conversions-devel
Requires:       ros2-noetic-tf-devel
Requires:       ros2-noetic-tf_conversions-devel

Provides: ros2-noetic-geometry-devel = 1.13.2-1
Obsoletes: ros2-noetic-geometry-devel < 1.13.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,geometry/include/,share/geometry/cmake} \
