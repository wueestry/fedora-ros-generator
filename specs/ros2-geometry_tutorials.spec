...
Source0:        https://github.com/ros-gbp/geometry_tutorials-release/archive/release/noetic/geometry_tutorials/0.2.3-1.tar.gz#/ros2-noetic-geometry_tutorials-0.2.3-source0.tar.gz
...
Requires:       ros2-noetic-turtle_tf
Requires:       ros2-noetic-turtle_tf2

Provides:  ros2-noetic-geometry_tutorials = 0.2.3-1
Obsoletes: ros2-noetic-geometry_tutorials < 0.2.3-1
...
Requires:       ros2-noetic-turtle_tf-devel
Requires:       ros2-noetic-turtle_tf2-devel

Provides: ros2-noetic-geometry_tutorials-devel = 0.2.3-1
Obsoletes: ros2-noetic-geometry_tutorials-devel < 0.2.3-1
...
colcon \
  ...
  --packages-select geometry_tutorials
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,geometry_tutorials/include/,share/geometry_tutorials/cmake} \
