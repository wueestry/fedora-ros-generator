...
Source0:        https://github.com/ros-gbp/gl_dependency-release/archive/release/noetic/gl_dependency/1.1.2-1.tar.gz#/ros2-noetic-gl_dependency-1.1.2-source0.tar.gz
...
Provides:  ros2-noetic-gl_dependency = 1.1.2-1
Obsoletes: ros2-noetic-gl_dependency < 1.1.2-1
...
Provides: ros2-noetic-gl_dependency-devel = 1.1.2-1
Obsoletes: ros2-noetic-gl_dependency-devel < 1.1.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,gl_dependency/include/,share/gl_dependency/cmake} \
