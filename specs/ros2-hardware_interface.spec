...
Source0:        https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/hardware_interface/2.25.1-1.tar.gz#/ros2-humble-hardware_interface-2.25.1-source0.tar.gz
...
Provides:  ros2-humble-hardware_interface = 2.25.1-1
Obsoletes: ros2-humble-hardware_interface < 2.25.1-1
...
Provides: ros2-humble-hardware_interface-devel = 2.25.1-1
Obsoletes: ros2-humble-hardware_interface-devel < 2.25.1-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,hardware_interface/include/,share/hardware_interface/cmake} \
