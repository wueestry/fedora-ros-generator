Name:           ros2-joint_trajectory_controller
...
Source0:        https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.17.3-1.tar.gz#/ros2-humble-joint_trajectory_controller-2.17.3-source0.tar.gz
...
Provides:  ros2-humble-joint_trajectory_controller = 2.17.3-1
Obsoletes: ros2-humble-joint_trajectory_controller < 2.17.3-1
...
Provides: ros2-humble-joint_trajectory_controller-devel = 2.17.3-1
Obsoletes: ros2-humble-joint_trajectory_controller-devel < 2.17.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,joint_trajectory_controller/include/,share/joint_trajectory_controller/cmake} \
