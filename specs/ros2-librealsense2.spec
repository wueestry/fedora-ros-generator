Name:           ros2-librealsense2
Version:        humble.2.51.1
Release:        1%{?dist}
...
Source0:        https://github.com/IntelRealSense/librealsense2-release/archive/release/humble/librealsense2/2.51.1-2.tar.gz#/ros2-humble-librealsense2-2.51.1-source0.tar.gz
...
Provides:  ros2-humble-librealsense2 = 2.51.1-1
Obsoletes: ros2-humble-librealsense2 < 2.51.1-1
...
Provides: ros2-humble-librealsense2-devel = 2.51.1-1
Obsoletes: ros2-humble-librealsense2-devel < 2.51.1-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,librealsense2/include/,share/librealsense2/cmake} \
