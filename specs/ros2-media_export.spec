...
Source0:        https://github.com/ros-gbp/media_export-release/archive/release/noetic/media_export/0.3.0-1.tar.gz#/ros2-noetic-media_export-0.3.0-source0.tar.gz
...
Provides:  ros2-noetic-media_export = 0.3.0-1
Obsoletes: ros2-noetic-media_export < 0.3.0-1
...
Provides: ros2-noetic-media_export-devel = 0.3.0-1
Obsoletes: ros2-noetic-media_export-devel < 0.3.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,media_export/include/,share/media_export/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.3.0-1
