...
Source0:        https://github.com/ros-gbp/message_generation-release/archive/release/noetic/message_generation/0.4.1-1.tar.gz#/ros2-noetic-message_generation-0.4.1-source0.tar.gz
...
Requires:       ros2-noetic-gencpp
Requires:       ros2-noetic-geneus
Requires:       ros2-noetic-genlisp
Requires:       ros2-noetic-genmsg
Requires:       ros2-noetic-gennodejs
Requires:       ros2-noetic-genpy

Provides:  ros2-noetic-message_generation = 0.4.1-1
Obsoletes: ros2-noetic-message_generation < 0.4.1-1
...
Requires:       ros2-noetic-gencpp-devel
Requires:       ros2-noetic-geneus-devel
Requires:       ros2-noetic-genlisp-devel
Requires:       ros2-noetic-genmsg-devel
Requires:       ros2-noetic-gennodejs-devel
Requires:       ros2-noetic-genpy-devel

Provides: ros2-noetic-message_generation-devel = 0.4.1-1
Obsoletes: ros2-noetic-message_generation-devel < 0.4.1-1
...
colcon \
  ...
  --packages-select message_generation
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,message_generation/include/,share/message_generation/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.4.1-1
