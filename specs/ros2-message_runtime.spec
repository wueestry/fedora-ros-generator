...
Source0:        https://github.com/ros-gbp/message_runtime-release/archive/release/noetic/message_runtime/0.4.13-1.tar.gz#/ros2-noetic-message_runtime-0.4.13-source0.tar.gz
...
Provides:  ros2-noetic-message_runtime = 0.4.13-1
Obsoletes: ros2-noetic-message_runtime < 0.4.13-1
...
Provides: ros2-noetic-message_runtime-devel = 0.4.13-1
Obsoletes: ros2-noetic-message_runtime-devel < 0.4.13-1
...
colcon \
  ...
  --packages-select message_runtime
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,message_runtime/include/,share/message_runtime/cmake} \
