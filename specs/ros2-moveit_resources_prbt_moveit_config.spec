...
Source0:        https://github.com/moveit/moveit2-release/archive/release/humble/moveit_resources_prbt_moveit_config/2.5.4-1.tar.gz#/ros2-humble-moveit_resources_prbt_moveit_config-2.5.4-source0.tar.gz
