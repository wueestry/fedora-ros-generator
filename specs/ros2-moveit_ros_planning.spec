...
Source0:        https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_planning/2.5.4-1.tar.gz#/ros2-humble-moveit_ros_planning-2.5.4-source0.tar.gz
...
Provides:  ros2-humble-moveit_ros_planning = 2.5.4-1
Obsoletes: ros2-humble-moveit_ros_planning < 2.5.4-1
...
Provides: ros2-humble-moveit_ros_planning-devel = 2.5.4-1
Obsoletes: ros2-humble-moveit_ros_planning-devel < 2.5.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,moveit_ros_planning/include/,share/moveit_ros_planning/cmake} \
