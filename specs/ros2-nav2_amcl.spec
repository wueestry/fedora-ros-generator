...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_amcl/1.1.9-1.tar.gz#/ros2-humble-nav2_amcl-1.1.9-source0.tar.gz
...
Provides:  ros2-humble-nav2_amcl = 1.1.9-1
Obsoletes: ros2-humble-nav2_amcl < 1.1.9-1
...
Provides: ros2-humble-nav2_amcl-devel = 1.1.9-1
Obsoletes: ros2-humble-nav2_amcl-devel < 1.1.9-1
