Name:           ros2-nav2_lifecycle_manager
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nav2_lifecycle_manager/include/,share/nav2_lifecycle_manager/cmake} \
