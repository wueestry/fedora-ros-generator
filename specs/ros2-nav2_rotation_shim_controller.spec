Name:           ros2-nav2_rotation_shim_controller
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nav2_rotation_shim_controller/include/,share/nav2_rotation_shim_controller/cmake} \
