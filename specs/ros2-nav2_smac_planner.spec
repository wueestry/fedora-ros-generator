...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_smac_planner/1.1.6-1.tar.gz#/ros2-humble-nav2_smac_planner-1.1.6-source0.tar.gz
...
Provides:  ros2-humble-nav2_smac_planner = 1.1.6-1
Obsoletes: ros2-humble-nav2_smac_planner < 1.1.6-1
...
Provides: ros2-humble-nav2_smac_planner-devel = 1.1.6-1
Obsoletes: ros2-humble-nav2_smac_planner-devel < 1.1.6-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nav2_smac_planner/include/,share/nav2_smac_planner/cmake} \
