...
Source0:        https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_util/1.1.6-1.tar.gz#/ros2-humble-nav2_util-1.1.6-source0.tar.gz
...
Provides:  ros2-humble-nav2_util = 1.1.6-1
Obsoletes: ros2-humble-nav2_util < 1.1.6-1
...
Provides: ros2-humble-nav2_util-devel = 1.1.6-1
Obsoletes: ros2-humble-nav2_util-devel < 1.1.6-1
