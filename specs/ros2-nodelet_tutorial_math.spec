Name:           ros2-nodelet_tutorial_math
...
Source0:        https://github.com/ros-gbp/common_tutorials-release/archive/release/noetic/nodelet_tutorial_math/0.2.0-1.tar.gz#/ros2-noetic-nodelet_tutorial_math-0.2.0-source0.tar.gz
...
Requires:       ros2-noetic-nodelet
Requires:       ros2-noetic-roscpp
Requires:       ros2-noetic-std_msgs

Provides:  ros2-noetic-nodelet_tutorial_math = 0.2.0-1
Obsoletes: ros2-noetic-nodelet_tutorial_math < 0.2.0-1
...
Provides: ros2-noetic-nodelet_tutorial_math-devel = 0.2.0-1
Obsoletes: ros2-noetic-nodelet_tutorial_math-devel < 0.2.0-1
...
colcon \
  ...
  --packages-select nodelet_tutorial_math
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,nodelet_tutorial_math/include/,share/nodelet_tutorial_math/cmake} \
