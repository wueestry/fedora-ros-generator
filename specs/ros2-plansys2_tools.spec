Name:           ros2-plansys2_tools
Version:        humble.2.0.9
Release:        1%{?dist}
Summary:        ROS package plansys2_tools

License:        Apache License, Version 2.0
URL:            http://www.ros.org/

Source0:        https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/humble/plansys2_tools/2.0.9-1.tar.gz#/ros2-humble-plansys2_tools-2.0.9-source0.tar.gz
...
Provides:  ros2-humble-plansys2_tools = 2.0.9-1
Obsoletes: ros2-humble-plansys2_tools < 2.0.9-1
...
Provides: ros2-humble-plansys2_tools-devel = 2.0.9-1
Obsoletes: ros2-humble-plansys2_tools-devel < 2.0.9-1
...
colcon \
  ...
  --packages-select plansys2_tools
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,plansys2_tools/include/,share/plansys2_tools/cmake} \
