...
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.7-1.tar.gz#/ros2-humble-rclcpp-16.0.7-source0.tar.gz
...
Provides:  ros2-humble-rclcpp = 16.0.7-1
Obsoletes: ros2-humble-rclcpp < 16.0.7-1
...
Provides: ros2-humble-rclcpp-devel = 16.0.7-1
Obsoletes: ros2-humble-rclcpp-devel < 16.0.7-1
