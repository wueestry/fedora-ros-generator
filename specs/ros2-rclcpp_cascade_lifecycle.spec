Name:           ros2-rclcpp_cascade_lifecycle
Version:        humble.1.0.2
Release:        1%{?dist}
...
Source0:        https://github.com/ros2-gbp/cascade_lifecycle-release/archive/release/humble/rclcpp_cascade_lifecycle/1.0.2-2.tar.gz#/ros2-humble-rclcpp_cascade_lifecycle-1.0.2-source0.tar.gz
...
Provides:  ros2-humble-rclcpp_cascade_lifecycle = 1.0.2-1
Obsoletes: ros2-humble-rclcpp_cascade_lifecycle < 1.0.2-1
...
Provides: ros2-humble-rclcpp_cascade_lifecycle-devel = 1.0.2-1
Obsoletes: ros2-humble-rclcpp_cascade_lifecycle-devel < 1.0.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rclcpp_cascade_lifecycle/include/,share/rclcpp_cascade_lifecycle/cmake} \
