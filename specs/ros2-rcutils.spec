...
Source0:        https://github.com/ros2-gbp/rcutils-release/archive/release/humble/rcutils/5.1.2-1.tar.gz#/ros2-humble-rcutils-5.1.2-source0.tar.gz
...
Provides:  ros2-humble-rcutils = 5.1.2-1
Obsoletes: ros2-humble-rcutils < 5.1.2-1
...
Provides: ros2-humble-rcutils-devel = 5.1.2-1
Obsoletes: ros2-humble-rcutils-devel < 5.1.2-1
