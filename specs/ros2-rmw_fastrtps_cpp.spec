...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/humble/rmw_fastrtps_cpp/6.2.5-1.tar.gz#/ros2-humble-rmw_fastrtps_cpp-6.2.5-source0.tar.gz
...
Provides:  ros2-humble-rmw_fastrtps_cpp = 6.2.5-1
Obsoletes: ros2-humble-rmw_fastrtps_cpp < 6.2.5-1
...
Provides: ros2-humble-rmw_fastrtps_cpp-devel = 6.2.5-1
Obsoletes: ros2-humble-rmw_fastrtps_cpp-devel < 6.2.5-1
