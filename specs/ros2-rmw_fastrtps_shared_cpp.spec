...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/humble/rmw_fastrtps_shared_cpp/6.2.5-1.tar.gz#/ros2-humble-rmw_fastrtps_shared_cpp-6.2.5-source0.tar.gz
...
Obsoletes: ros2-humble-rmw_fastrtps_shared_cpp < 6.2.5-1
