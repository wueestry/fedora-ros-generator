...
Source0:        https://github.com/ros-gbp/ros_tutorials-release/archive/release/noetic/ros_tutorials/0.10.2-1.tar.gz#/ros2-noetic-ros_tutorials-0.10.2-source0.tar.gz
...
Requires:       ros2-noetic-roscpp_tutorials
Requires:       ros2-noetic-rospy_tutorials
Requires:       ros2-noetic-turtlesim

Provides:  ros2-noetic-ros_tutorials = 0.10.2-1
Obsoletes: ros2-noetic-ros_tutorials < 0.10.2-1
...
Requires:       ros2-noetic-roscpp_tutorials-devel
Requires:       ros2-noetic-rospy_tutorials-devel
Requires:       ros2-noetic-turtlesim-devel

Provides: ros2-noetic-ros_tutorials-devel = 0.10.2-1
Obsoletes: ros2-noetic-ros_tutorials-devel < 0.10.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,ros_tutorials/include/,share/ros_tutorials/cmake} \
