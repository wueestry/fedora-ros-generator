Name:           ros2-rosbag2_compression_zstd
...
Source0:        https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_compression_zstd/0.15.4-2.tar.gz#/ros2-humble-rosbag2_compression_zstd-0.15.4-source0.tar.gz
...
Provides:  ros2-humble-rosbag2_compression_zstd = 0.15.4-1
Obsoletes: ros2-humble-rosbag2_compression_zstd < 0.15.4-1
...
Provides: ros2-humble-rosbag2_compression_zstd-devel = 0.15.4-1
Obsoletes: ros2-humble-rosbag2_compression_zstd-devel < 0.15.4-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag2_compression_zstd/include/,share/rosbag2_compression_zstd/cmake} \
