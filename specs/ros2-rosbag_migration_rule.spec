Name:           ros2-rosbag_migration_rule
...
Source0:        https://github.com/ros-gbp/rosbag_migration_rule-release/archive/release/noetic/rosbag_migration_rule/1.0.1-1.tar.gz#/ros2-noetic-rosbag_migration_rule-1.0.1-source0.tar.gz
...
Provides:  ros2-noetic-rosbag_migration_rule = 1.0.1-1
Obsoletes: ros2-noetic-rosbag_migration_rule < 1.0.1-1
...
Provides: ros2-noetic-rosbag_migration_rule-devel = 1.0.1-1
Obsoletes: ros2-noetic-rosbag_migration_rule-devel < 1.0.1-1
...
colcon \
  ...
  --packages-select rosbag_migration_rule
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbag_migration_rule/include/,share/rosbag_migration_rule/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.0.1-1
