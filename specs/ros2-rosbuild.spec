...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/rosbuild/1.15.8-1.tar.gz#/ros2-noetic-rosbuild-1.15.8-source0.tar.gz
...
Requires:       ros2-noetic-message_generation
Requires:       ros2-noetic-message_runtime

Provides:  ros2-noetic-rosbuild = 1.15.8-1
Obsoletes: ros2-noetic-rosbuild < 1.15.8-1
...
Provides: ros2-noetic-rosbuild-devel = 1.15.8-1
Obsoletes: ros2-noetic-rosbuild-devel < 1.15.8-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosbuild/include/,share/rosbuild/cmake} \
