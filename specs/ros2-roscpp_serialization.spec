Name:           ros2-roscpp_serialization
...
Source0:        https://github.com/ros-gbp/roscpp_core-release/archive/release/noetic/roscpp_serialization/0.7.2-1.tar.gz#/ros2-noetic-roscpp_serialization-0.7.2-source0.tar.gz
...
Provides:  ros2-noetic-roscpp_serialization = 0.7.2-1
Obsoletes: ros2-noetic-roscpp_serialization < 0.7.2-1
...
Provides: ros2-noetic-roscpp_serialization-devel = 0.7.2-1
Obsoletes: ros2-noetic-roscpp_serialization-devel < 0.7.2-1
...
colcon \
  ...
  --packages-select roscpp_serialization
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roscpp_serialization/include/,share/roscpp_serialization/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.7.2-1
