...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/roslang/1.15.8-1.tar.gz#/ros2-noetic-roslang-1.15.8-source0.tar.gz
...
Provides:  ros2-noetic-roslang = 1.15.8-1
Obsoletes: ros2-noetic-roslang < 1.15.8-1
...
Provides: ros2-noetic-roslang-devel = 1.15.8-1
Obsoletes: ros2-noetic-roslang-devel < 1.15.8-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,roslang/include/,share/roslang/cmake} \
