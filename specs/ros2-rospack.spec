...
Source0:        https://github.com/ros-gbp/rospack-release/archive/release/noetic/rospack/2.6.2-1.tar.gz#/ros2-noetic-rospack-2.6.2-source0.tar.gz
...
Provides:  ros2-noetic-rospack = 2.6.2-1
Obsoletes: ros2-noetic-rospack < 2.6.2-1
...
Provides: ros2-noetic-rospack-devel = 2.6.2-1
Obsoletes: ros2-noetic-rospack-devel < 2.6.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rospack/include/,share/rospack/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.2.6.2-1
