...
Source0:        https://github.com/ros-gbp/ros_tutorials-release/archive/release/noetic/rospy_tutorials/0.10.2-1.tar.gz#/ros2-noetic-rospy_tutorials-0.10.2-source0.tar.gz
...
BuildRequires:  ros2-noetic-roscpp_tutorials-devel
...
Provides:  ros2-noetic-rospy_tutorials = 0.10.2-1
Obsoletes: ros2-noetic-rospy_tutorials < 0.10.2-1
...
Provides: ros2-noetic-rospy_tutorials-devel = 0.10.2-1
Obsoletes: ros2-noetic-rospy_tutorials-devel < 0.10.2-1
...
colcon \
  ...
  --packages-select rospy_tutorials
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rospy_tutorials/include/,share/rospy_tutorials/cmake} \
