...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rostopic/1.16.0-1.tar.gz#/ros2-noetic-rostopic-1.16.0-source0.tar.gz
...
Provides:  ros2-noetic-rostopic = 1.16.0-1
Obsoletes: ros2-noetic-rostopic < 1.16.0-1
...
Provides: ros2-noetic-rostopic-devel = 1.16.0-1
Obsoletes: ros2-noetic-rostopic-devel < 1.16.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rostopic/include/,share/rostopic/cmake} \
