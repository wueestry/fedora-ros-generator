...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/rosunit/1.15.8-1.tar.gz#/ros2-noetic-rosunit-1.15.8-source0.tar.gz
...
Provides:  ros2-noetic-rosunit = 1.15.8-1
Obsoletes: ros2-noetic-rosunit < 1.15.8-1
...
Provides: ros2-noetic-rosunit-devel = 1.15.8-1
Obsoletes: ros2-noetic-rosunit-devel < 1.15.8-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rosunit/include/,share/rosunit/cmake} \
