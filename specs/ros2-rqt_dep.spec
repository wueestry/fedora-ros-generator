...
Source0:        https://github.com/ros-gbp/rqt_dep-release/archive/release/noetic/rqt_dep/0.4.12-1.tar.gz#/ros2-noetic-rqt_dep-0.4.12-source0.tar.gz
...
Provides:  ros2-noetic-rqt_dep = 0.4.12-1
Obsoletes: ros2-noetic-rqt_dep < 0.4.12-1
...
Provides: ros2-noetic-rqt_dep-devel = 0.4.12-1
Obsoletes: ros2-noetic-rqt_dep-devel < 0.4.12-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_dep/include/,share/rqt_dep/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.4.12-1
