...
Source0:        https://github.com/ros-gbp/rqt_logger_level-release/archive/release/noetic/rqt_logger_level/0.4.11-1.tar.gz#/ros2-noetic-rqt_logger_level-0.4.11-source0.tar.gz
...
Provides:  ros2-noetic-rqt_logger_level = 0.4.11-1
Obsoletes: ros2-noetic-rqt_logger_level < 0.4.11-1
...
Provides: ros2-noetic-rqt_logger_level-devel = 0.4.11-1
Obsoletes: ros2-noetic-rqt_logger_level-devel < 0.4.11-1
...
colcon \
  ...
  --packages-select rqt_logger_level
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_logger_level/include/,share/rqt_logger_level/cmake} \
