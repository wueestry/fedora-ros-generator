...
Source0:        https://github.com/ros-gbp/rqt_pose_view-release/archive/release/noetic/rqt_pose_view/0.5.11-1.tar.gz#/ros2-noetic-rqt_pose_view-0.5.11-source0.tar.gz
...
Requires:       ros2-noetic-gl_dependency
...
Provides:  ros2-noetic-rqt_pose_view = 0.5.11-1
Obsoletes: ros2-noetic-rqt_pose_view < 0.5.11-1
...
Requires:       ros2-noetic-gl_dependency-devel
...
Provides: ros2-noetic-rqt_pose_view-devel = 0.5.11-1
Obsoletes: ros2-noetic-rqt_pose_view-devel < 0.5.11-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_pose_view/include/,share/rqt_pose_view/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.5.11-1
