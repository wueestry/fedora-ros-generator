...
Source0:        https://github.com/ros-gbp/rqt_robot_steering-release/archive/release/noetic/rqt_robot_steering/0.5.12-1.tar.gz#/ros2-noetic-rqt_robot_steering-0.5.12-source0.tar.gz
...
Provides:  ros2-noetic-rqt_robot_steering = 0.5.12-1
Obsoletes: ros2-noetic-rqt_robot_steering < 0.5.12-1
...
Provides: ros2-noetic-rqt_robot_steering-devel = 0.5.12-1
Obsoletes: ros2-noetic-rqt_robot_steering-devel < 0.5.12-1
...
colcon \
  ...
  --packages-select rqt_robot_steering
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_robot_steering/include/,share/rqt_robot_steering/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.5.12-1
