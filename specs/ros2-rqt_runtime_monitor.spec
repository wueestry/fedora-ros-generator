...
Source0:        https://github.com/ros-gbp/rqt_runtime_monitor-release/archive/release/noetic/rqt_runtime_monitor/0.5.9-1.tar.gz#/ros2-noetic-rqt_runtime_monitor-0.5.9-source0.tar.gz
...
Provides:  ros2-noetic-rqt_runtime_monitor = 0.5.9-1
Obsoletes: ros2-noetic-rqt_runtime_monitor < 0.5.9-1
...
Provides: ros2-noetic-rqt_runtime_monitor-devel = 0.5.9-1
Obsoletes: ros2-noetic-rqt_runtime_monitor-devel < 0.5.9-1
...
colcon \
  ...
  --packages-select rqt_runtime_monitor
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_runtime_monitor/include/,share/rqt_runtime_monitor/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.5.9-1
