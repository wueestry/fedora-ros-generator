...
Source0:        https://github.com/ros-gbp/rqt_rviz-release/archive/release/noetic/rqt_rviz/0.7.0-1.tar.gz#/ros2-noetic-rqt_rviz-0.7.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-class_loader-devel
BuildRequires:  ros2-noetic-rqt_gui-devel
BuildRequires:  ros2-noetic-rqt_gui_cpp-devel
BuildRequires:  ros2-noetic-rviz-devel

Requires:       ros2-noetic-pluginlib
Requires:       ros2-noetic-rqt_gui
Requires:       ros2-noetic-rqt_gui_cpp
Requires:       ros2-noetic-rviz

Provides:  ros2-noetic-rqt_rviz = 0.7.0-1
Obsoletes: ros2-noetic-rqt_rviz < 0.7.0-1
...
Requires:       ros2-noetic-class_loader-devel
Requires:       ros2-noetic-rqt_gui-devel
Requires:       ros2-noetic-rqt_gui_cpp-devel
Requires:       ros2-noetic-rviz-devel
Requires:       ros2-noetic-pluginlib-devel

Provides: ros2-noetic-rqt_rviz-devel = 0.7.0-1
Obsoletes: ros2-noetic-rqt_rviz-devel < 0.7.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_rviz/include/,share/rqt_rviz/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.7.0-1
