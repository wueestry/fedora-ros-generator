...
Source0:        https://github.com/ros-gbp/rqt_web-release/archive/release/noetic/rqt_web/0.4.10-1.tar.gz#/ros2-noetic-rqt_web-0.4.10-source0.tar.gz
...
Requires:       ros2-noetic-webkit_dependency

Provides:  ros2-noetic-rqt_web = 0.4.10-1
Obsoletes: ros2-noetic-rqt_web < 0.4.10-1
...
Requires:       ros2-noetic-webkit_dependency-devel

Provides: ros2-noetic-rqt_web-devel = 0.4.10-1
Obsoletes: ros2-noetic-rqt_web-devel < 0.4.10-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,rqt_web/include/,share/rqt_web/cmake} \
