...
Source0:        https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering_tests/11.2.8-1.tar.gz#/ros2-humble-rviz_rendering_tests-11.2.8-source0.tar.gz
...
Provides:  ros2-humble-rviz_rendering_tests = 11.2.8-1
Obsoletes: ros2-humble-rviz_rendering_tests < 11.2.8-1
...
Provides: ros2-humble-rviz_rendering_tests-devel = 11.2.8-1
Obsoletes: ros2-humble-rviz_rendering_tests-devel < 11.2.8-1
