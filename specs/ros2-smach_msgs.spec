...
Source0:        https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/smach_msgs/2.5.1-1.tar.gz#/ros2-noetic-smach_msgs-2.5.1-source0.tar.gz
...
BuildRequires:  ros2-noetic-message_runtime-devel
BuildRequires:  ros2-noetic-std_msgs-devel

Requires:       ros2-noetic-message_runtime
Requires:       ros2-noetic-std_msgs

Provides:  ros2-noetic-smach_msgs = 2.5.1-1
Obsoletes: ros2-noetic-smach_msgs < 2.5.1-1
...
Provides: ros2-noetic-smach_msgs-devel = 2.5.1-1
Obsoletes: ros2-noetic-smach_msgs-devel < 2.5.1-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,smach_msgs/include/,share/smach_msgs/cmake} \
