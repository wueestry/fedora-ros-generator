...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/noetic/tf/1.13.2-1.tar.gz#/ros2-noetic-tf-1.13.2-source0.tar.gz
...
Provides:  ros2-noetic-tf = 1.13.2-1
Obsoletes: ros2-noetic-tf < 1.13.2-1
...
Provides: ros2-noetic-tf-devel = 1.13.2-1
Obsoletes: ros2-noetic-tf-devel < 1.13.2-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,tf/include/,share/tf/cmake} \
