...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/noetic/tf_conversions/1.13.2-1.tar.gz#/ros2-noetic-tf_conversions-1.13.2-source0.tar.gz
...
BuildRequires:  ros2-noetic-kdl_conversions-devel
...
Provides:  ros2-noetic-tf_conversions = 1.13.2-1
Obsoletes: ros2-noetic-tf_conversions < 1.13.2-1
...
Provides: ros2-noetic-tf_conversions-devel = 1.13.2-1
Obsoletes: ros2-noetic-tf_conversions-devel < 1.13.2-1
...
colcon \
  ...
  --packages-select tf_conversions
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,tf_conversions/include/,share/tf_conversions/cmake} \
