Name:           ros2-tf_transformations
Version:        humble.1.0.1
Release:        1%{?dist}
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,tf_transformations/include/,share/tf_transformations/cmake} \
