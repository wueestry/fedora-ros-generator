...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/topic_tools/1.16.0-1.tar.gz#/ros2-noetic-topic_tools-1.16.0-source0.tar.gz
...
BuildRequires:  ros2-noetic-rosbash-devel
...
Provides:  ros2-noetic-topic_tools = 1.16.0-1
Obsoletes: ros2-noetic-topic_tools < 1.16.0-1
...
Provides: ros2-noetic-topic_tools-devel = 1.16.0-1
Obsoletes: ros2-noetic-topic_tools-devel < 1.16.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,topic_tools/include/,share/topic_tools/cmake} \
