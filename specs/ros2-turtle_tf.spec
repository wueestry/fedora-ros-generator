...
Source0:        https://github.com/ros-gbp/geometry_tutorials-release/archive/release/noetic/turtle_tf/0.2.3-1.tar.gz#/ros2-noetic-turtle_tf-0.2.3-source0.tar.gz
...
Provides:  ros2-noetic-turtle_tf = 0.2.3-1
Obsoletes: ros2-noetic-turtle_tf < 0.2.3-1
...
Provides: ros2-noetic-turtle_tf-devel = 0.2.3-1
Obsoletes: ros2-noetic-turtle_tf-devel < 0.2.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,turtle_tf/include/,share/turtle_tf/cmake} \
