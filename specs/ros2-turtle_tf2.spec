...
Source0:        https://github.com/ros-gbp/geometry_tutorials-release/archive/release/noetic/turtle_tf2/0.2.3-1.tar.gz#/ros2-noetic-turtle_tf2-0.2.3-source0.tar.gz
...
BuildRequires:  ros2-noetic-tf2-devel
...
Requires:       ros2-noetic-tf2
Requires:       ros2-noetic-tf2_geometry_msgs
Requires:       ros2-noetic-tf2_ros
Requires:       ros2-noetic-turtlesim

Provides:  ros2-noetic-turtle_tf2 = 0.2.3-1
Obsoletes: ros2-noetic-turtle_tf2 < 0.2.3-1
...
Requires:       ros2-noetic-tf2-devel
Requires:       ros2-noetic-tf2_geometry_msgs-devel
Requires:       ros2-noetic-tf2_ros-devel
Requires:       ros2-noetic-turtlesim-devel

Provides: ros2-noetic-turtle_tf2-devel = 0.2.3-1
Obsoletes: ros2-noetic-turtle_tf2-devel < 0.2.3-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,turtle_tf2/include/,share/turtle_tf2/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.2.3-1
