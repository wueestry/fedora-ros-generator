...
Source0:        https://github.com/ros-gbp/metapackages-release/archive/release/noetic/viz/1.5.0-1.tar.gz#/ros2-noetic-viz-1.5.0-source0.tar.gz
...
Requires:       ros2-noetic-rqt_common_plugins
Requires:       ros2-noetic-rqt_robot_plugins
Requires:       ros2-noetic-rviz

Provides:  ros2-noetic-viz = 1.5.0-1
Obsoletes: ros2-noetic-viz < 1.5.0-1
...
Requires:       ros2-noetic-rqt_common_plugins-devel
Requires:       ros2-noetic-rqt_robot_plugins-devel
Requires:       ros2-noetic-rviz-devel

Provides: ros2-noetic-viz-devel = 1.5.0-1
Obsoletes: ros2-noetic-viz-devel < 1.5.0-1
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,viz/include/,share/viz/cmake} \
