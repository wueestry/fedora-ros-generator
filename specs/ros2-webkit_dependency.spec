...
Source0:        https://github.com/ros-gbp/webkit_dependency-release/archive/release/noetic/webkit_dependency/1.1.2-1.tar.gz#/ros2-noetic-webkit_dependency-1.1.2-source0.tar.gz
...
Provides:  ros2-noetic-webkit_dependency = 1.1.2-1
Obsoletes: ros2-noetic-webkit_dependency < 1.1.2-1
...
Provides: ros2-noetic-webkit_dependency-devel = 1.1.2-1
Obsoletes: ros2-noetic-webkit_dependency-devel < 1.1.2-1
...
colcon \
  ...
  --packages-select webkit_dependency
...
find %{buildroot}/%{_libdir}/ros2/{lib*/pkgconfig,include/,cmake/,webkit_dependency/include/,share/webkit_dependency/cmake} \
...
%changelog
* Mon Mar 20 2023 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.1.1.2-1
